...
export default function BookingFlow({ 
  ...
  // Phone prefixes now imported from @/utils/phone-prefixes (shared with BookingFormWidget)
  ...
  // Filter functions for search (using shared helper for phone prefixes)
  ...
  const durations = useMemo(() => {
    ...
    try {
      ...
      // Prefer seasonal pricing JSON over pricePerHour multipliers
      if (boat.pricing) {
