          ...
          <div className="bg-white rounded-lg p-2 sm:p-3 shadow-sm border border-gray-100">
            ...
            <div className="space-y-1">
              ...
              <select
                ...
                className="w-full p-2 sm:p-2.5 border-0 bg-gray-50 rounded-md focus:ring-2 focus:ring-primary focus:bg-white transition-all text-gray-900 font-medium text-xs [@media(min-width:400px)]:text-sm disabled:opacity-60"
