...
export default function FAQPreview() {
  ...
  return (
    <section ref={revealRef} className={`py-16 sm:py-20 lg:py-24 bg-background transition-[opacity,transform,filter] duration-500 ${isVisible ? "opacity-100 translate-y-0 blur-none" : "opacity-0 translate-y-8 blur-[2px]"}`} aria-labelledby="faq-preview-title">
