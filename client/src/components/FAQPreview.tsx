...
export default function FAQPreview() {
  ...
  return (
    <section ref={revealRef} className={`py-16 sm:py-20 lg:py-24 bg-background transition-[opacity,transform] duration-500 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`} aria-labelledby="faq-preview-title">
