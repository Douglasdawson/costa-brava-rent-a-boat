        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12">
          ...
          <div>
            ...
            <div className="flex items-center space-x-2 text-sm mb-6">
              <div
                className={`w-2 h-2 rounded-full ${isOperatingSeason() ? "bg-green-400" : "bg-red-400"}`}
                aria-hidden="true"
              ></div>
            ...
            {/* Newsletter */}
            <div className="mt-8">
              <h3 className="font-bold text-primary-foreground mb-2 text-sm flex items-center gap-1.5">
                <Map className="w-4 h-4 text-cta" />
                {t.locationPages.newsletter.title}
              </h3>
              <p className="text-sm text-primary-foreground/60 mb-3">
                {t.locationPages.newsletter.subtitle}
              </p>
          ...
          <div className="lg:pl-[20%]">
            <h3 className="font-bold text-primary-foreground mb-4 text-sm">
            ...
            <h3 className="font-bold text-primary-foreground mb-4 text-sm mt-8">
          ...
          {/* Column 3: Contact */}
          <div>
            <h3 className="font-bold text-primary-foreground mb-4 text-sm">{t.footer.contact}</h3>
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                <Phone className="w-4 h-4 text-primary-foreground/50 flex-shrink-0 mt-1" strokeWidth={2.5} />
                <div>
                  <a
                    href="tel:+34611500372"
                    className="text-sm hover:text-primary-foreground transition-colors flex items-center py-0.5"
                  ...
                  <p className="text-xs text-primary-foreground/60 mt-0.5">
                    {t.footer.callsAndWhatsapp}
                  </p>
                </div>
              </div>

              <div className="flex items-start space-x-3">
                <Mail className="w-4 h-4 text-primary-foreground/50 flex-shrink-0 mt-1" strokeWidth={2.5} />
                <div>
                  <a
                    href="mailto:info@costabravarentaboat.com"
                    className="text-sm hover:text-primary-foreground transition-colors flex items-center py-0.5 break-all"
              ...
              <div className="flex items-start space-x-3">
                <MapPin className="w-4 h-4 text-primary-foreground/50 flex-shrink-0 mt-1" strokeWidth={2.5} />
                <div>
                  <a
        ...
        <div className="border-t border-white/10 mt-12 pt-8">
          <div className="flex flex-col items-center gap-3">
            <div className="text-primary-foreground/70 text-sm flex flex-wrap items-center gap-x-1 gap-y-2 sm:gap-x-2 justify-center">
              ...
              <a
                href={localizedPath("accessibility")}
                className="hover:text-primary-foreground transition-colors min-h-11 inline-flex items-center rounded focus-visible:ring-2 focus-visible:ring-cta focus-visible:outline-none"
            ...
            <p
              className="text-primary-foreground/60 text-xs text-center text-balance max-w-md px-2 mt-1"
              data-testid="footer-brand-differentiator"
            >
            ...
            <div className="flex items-center justify-center gap-3 text-primary-foreground/50 text-xs">
              ...
              <a
                ...
                className="inline-flex items-center justify-center min-h-11 min-w-11 -m-2 hover:text-primary-foreground/60 transition-colors"
                aria-label={t.a11y.adminAccess ?? "Acceso administración"}
              >
