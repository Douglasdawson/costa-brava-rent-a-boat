      ...
      <div className="container mx-auto px-4 py-16 sm:py-20 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12">
          ...
          <div className="lg:pl-[20%]">
            <h3 className="font-medium text-primary-foreground mb-4 text-sm">
            ...
            <ul className="space-y-1 text-sm">
              <li>
                <a
                  href="#fleet"
                  className="hover:text-primary-foreground transition-colors py-1.5 block rounded focus-visible:ring-2 focus-visible:ring-cta focus-visible:outline-none"
                >
                  {t.nav.fleet}
                </a>
              </li>
          ...
          <div className="flex flex-col items-center gap-3">
            <div className="text-primary-foreground/70 text-sm flex flex-wrap items-center gap-x-1 gap-y-2 sm:gap-x-2 justify-center">
              <a
                ...
                className="hover:text-primary-foreground transition-colors rounded focus-visible:ring-2 focus-visible:ring-cta focus-visible:outline-none"
