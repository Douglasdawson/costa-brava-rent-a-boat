      ...
      <div className="container mx-auto px-4">
        <div className="rounded-2xl bg-foreground px-6 py-10 sm:px-10 sm:py-12 lg:px-16 lg:py-14">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 text-center md:text-left">
            {/* Text */}
            <div>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-heading font-semibold text-primary-foreground tracking-tight">
                {banner.title}
              </h2>
              <p className="text-primary-foreground/60 font-light mt-2 max-w-lg">
                {banner.subtitle}
              </p>
            </div>
