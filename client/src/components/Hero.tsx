...
* 💰 Price: ${price}€`;
  ...
  return (
    <div className="relative min-h-screen md:h-screen bg-cover bg-center bg-no-repeat" 
      ...
      <div className="relative z-10 container mx-auto px-3 sm:px-4 pt-32 sm:pt-36 pb-8 sm:pb-12 min-h-screen md:h-screen flex flex-col justify-center items-center text-center">
        <div className="max-w-5xl mx-auto mb-4 sm:mb-8 w-full px-2 sm:px-4">
          <h1 className="font-heading text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 sm:mb-6 leading-tight px-2">
            Alquiler de Barcos en Blanes,<br className="lg:hidden" /> Costa Brava.
          </h1>
          <p className="text-sm sm:text-base md:text-lg lg:text-xl text-white/90 mb-3 sm:mb-4 px-2 text-center">
        ...
        <Card id="booking-form" className="bg-white/75 backdrop-blur-md p-3 sm:p-4 w-full shadow-2xl border-0">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
              ...
              <div className="bg-white rounded-lg p-2 shadow-sm border border-gray-100 col-span-2 md:col-span-1">
                ...
                {filteredBoats.length === 0 && !isLoadingBoats && (
                  <p className="text-xs [@media(min-width:400px)]:text-sm text-gray-500 mt-1">No hay barcos disponibles</p>
                )}
              </div>
          ...
          <div>
            <Button 
              ...
              className="w-full bg-primary hover:bg-primary/90 disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold py-2 sm:py-2.5 px-4 rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 text-xs [@media(min-width:400px)]:text-sm sm:text-sm"
            ...
            <p className="text-xs [@media(min-width:400px)]:text-sm text-gray-500 mt-2 text-center">
              {t.hero.trustText}
            </p>
          </div>
        </Card>
        ...
        {/* Trust Indicators */}
        <div className="mt-6 sm:mt-4 w-full max-w-6xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 justify-items-center items-center gap-3 sm:gap-x-6 lg:gap-x-8 sm:gap-y-3 text-white/90 text-xs sm:text-sm bg-white/10 backdrop-blur-sm rounded-lg p-3 sm:p-4">
