    ...
    >
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-card rounded-2xl border border-card-border p-4 xs:p-6 sm:p-8 relative overflow-hidden">
          ...
          <div className="bg-card rounded-2xl border border-card-border p-4 xs:p-6 sm:p-8 relative overflow-hidden">
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={i} className="flex items-center gap-2 text-sm">
                  <Check
                    className={`w-4 h-4 flex-shrink-0 ${i === 3 ? "text-amber-500" : "text-green-500"}`}
                  />
                  {feature}
                </li>
              ))}
