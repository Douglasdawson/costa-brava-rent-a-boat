...
export default function NeverSailedSection() {
  ...
  return (
    <section ref={revealRef} className={`below-fold py-16 md:py-24 bg-background transition-[opacity,transform] duration-500 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
