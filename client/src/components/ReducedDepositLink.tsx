...
export function ReducedDepositLink({ requiresLicense }: { requiresLicense: boolean }) {
  ...
  return (
    <a
      ...
      className="inline-flex items-center gap-1.5 rounded text-sm font-medium text-cta transition-colors hover:text-cta/80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cta focus-visible:ring-offset-2"
    >
