...
export function ScrollToTop() {
  ...
  return (
    <button
      ...
      className={`fixed bottom-24 right-4 md:bottom-8 md:right-6 z-40 mb-safe w-11 h-11 rounded-full bg-foreground/10 hover:bg-foreground/20 backdrop-blur-sm text-foreground/60 hover:text-foreground transition-all duration-300 flex items-center justify-center ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4 pointer-events-none"}`}
