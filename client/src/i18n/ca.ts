...
export const ca: Translations = {
  ...
  boatDetail: {
    ...
    checkAvailability: "Comprova disponibilitat",
    selectDateTitle: "Tria una data",
    selectDateBody: "Toca un dia verd al calendari per veure els preus reals i disponibilitat.",
    calendarHint: "Toca un dia disponible per veure els preus",
