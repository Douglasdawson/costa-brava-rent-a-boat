...
export const ca: Translations = {
  ...
  hero: {
    ...
    subtitle: 'Cales d\'aigua cristal·lina, només accessibles en vaixell. Sense experiència necessària. Sortides des de Blanes.',
    subtitleLine1: 'Cales d\'aigua cristal·lina, només accessibles en vaixell.',
    subtitleLine2: 'Sense experiència necessària. Sortides des de Blanes.',
    bookNow: 'Veure Disponibilitat',
