...
export const ca: Translations = {
  ...
  contact: {
    ...
    navLicensedDesc: 'Embarcacions potents per arribar més lluny. Llicència obligatòria.',
  ...
  comparison: {
    ...
    withLicenseDesc: 'M\u00e9s pot\u00e8ncia, m\u00e9s velocitat, m\u00e9s lluny. Llic\u00e8ncia obligat\u00f2ria.',
  ...
  locationPages: {
    ...
    costaBrava: {
      ...
      sections: {
        ...
        licensedDesc: 'Per explorar més enllà de la costa immediata. Més potència, autonomia i capacitat. El combustible es paga per separat.',
