...
export const de: Translations = {
  ...
  contact: {
    ...
    navLicensedTag1: "80-115 PS",
    navLicensedTag2: "Höhere Geschwindigkeit",
    navLicensedTag3: "Bis Tossa de Mar",
  ...
  footer: {
    ...
    descriptionPostEra: "Bootsverleih mit Bootsführerschein in Blanes, Costa Brava. Schein an 1 Tag oder Ausfahrt mit Skipper.",
  ...
  booking: {
    ...
    coverages: {
      ...
      weatherDesc: "Wenn schlechtes Wetter die Ausfahrt verhindert, bekommst du in bar zurück, was du im Voraus gezahlt hast.",
      depositName: "Reduzierte Kaution",
      depositDesc: "Du hinterlegst {amount}€ Kaution{standard} am Tag der Ausfahrt.",
      ...
      triggerWind: "Anhaltender Wind oder Böen darüber, oder Entscheidung des Unternehmens aus Sicherheitsgründen.",
  ...
  codeValidation: {
    ...
    serverError: "Wir konnten den Code gerade nicht prüfen: bitte versuche es erneut",
    validReferral: "Gültiger Freundescode",
    referralPerk: "Du bekommst das Premium-Paket gratis (30€). Wir bestätigen es per WhatsApp.",
  },
  giftCards: {
  ...
  categoryLicenseFree: {
    ...
    howToCostValue: "85 €/Std. mit inkludiertem Benzin",
    ...
    vsMarketplacesConclusion:
      "Der Endpreis über einen Marktplatz ist nach Addition von Benzin, Gebühr und Extras meist 20–35 % höher als angekündigt. Unsere 85 €/Std. sind bereits alles inklusive: Benzin, Ausrüstung, Einweisung, Haftpflichtversicherung und Unterstützung im Hafen.",
  },
  categoryLicensed: {
    heroTitle: "Motorboot ohne Skipper mieten in Blanes: selbst ans Steuer bis Tossa de Mar",
    heroDescription:
      "Drei führerscheinpflichtige Motorboote mit 80 bis 115 PS im Hafen von Blanes. Du stehst am Steuer, mit deiner Licencia de Navegación oder einem gleichwertigen ausländischen Schein, den wir vor deiner Ausfahrt online prüfen. Ab 175 EUR für 2 Stunden.",
    badgeLicense: "Licencia de Navegación genügt",
    badgePower: "80-115 PS",
    ...
    professionalEquipment: "Komplette Ausstattung",
    professionalEquipmentDesc:
      "Zugelassene Sicherheitsausrüstung, Sonnendach für Schatten, Dusche und Badeleiter. Jedes Motorboot wird zwischen zwei Ausfahrten geprüft, und vor dem Ablegen gehen wir die Bedienung in der technischen Einweisung mit dir durch.",
    superiorPerformance: "Gemacht für den ganzen Tag",
    superiorPerformanceDesc:
      "Mit 6 und 7 Plätzen und Reichweite für den ganzen Tag sind sie die Wahl für Gruppen und Familien, die eine echte Route wollen: stundenweise, halbtags oder ganztags.",
    synonymsTitle: "Motorboot, Sportboot oder Boot mit Führerschein? Dasselbe",
    synonymsBody:
      "An der Costa Brava heißt es mal Motorboot, mal Sportboot, mal Boot mit Führerschein. Gemeint sind Motorboote mit mehr als 15 PS, für die ein Bootsführerschein Pflicht ist. Und ohne Skipper mieten heißt genau das: Du hast keinen bezahlten Skipper an Bord, weil du selbst der Skipper bist.",
    routeTitle: "Von Blanes nach Tossa, selbst am Steuer: die Route",
    routeIntro:
      "Du legst im Hafen von Blanes ab und stehst nach einer Viertelstunde vor Lloret de Mar. Von dort öffnet sich die Küste in Buchten bis zur Bucht von Tossa de Mar mit ihrer Burg über dem Meer: 30-45 Minuten Fahrt mit jedem unserer Motorboote.",
    routeStopLloret: "Lloret de Mar und der Strand von Fenals: 15 Minuten vom Hafen",
    routeStopSantaCristina: "Cala Santa Cristina und Cala Treumal: ruhiges Ankern zwischen Blanes und Lloret",
    routeStopCanyelles: "Cala Canyelles: der letzte Halt vor dem Steilküstenabschnitt nach Tossa",
    routeStopTossa: "Tossa de Mar: Bucht mit mittelalterlicher Burg, 30-45 Minuten am Steuer",
    ...
    yachtCaptain: "Capitán de Yate (Yachtkapitän)",
    icc: "ICC (Internationaler Befähigungsnachweis)",
    euEquivalent: "Gleichwertige EU-Führerscheine",
    verifierLead: "Schein aus einem anderen Land? Prüfe ihn hier in 30 Sekunden:",
    additionalRequirements: "Zusätzliche Anforderungen",
    minAge: "Mindestalter: 18 Jahre",
    validId: "Gültiger Personalausweis",
    validLicense: "Gültiger Bootsführerschein (bring das Original mit)",
    ...
    comparisonTitle: "Welches Motorboot nehme ich? Schneller Vergleich",
    comparisonIntro:
      "Alle drei legen im Hafen von Blanes ab und lassen sich mit der Licencia de Navegación fahren. Unterschiedlich sind Leistung, Plätze und Charakter: Diese Tabelle fasst es zusammen, mit dem Preis für 2 Stunden je Saison.",
    comparisonBoatName: "Motorboot",
    comparisonCapacity: "Plätze",
    comparisonEngine: "Motor",
    comparisonBestFor: "Ideal für",
    comparisonPriceLow: "2 Std. Nebensaison",
    comparisonPriceHigh: "2 Std. August",
    comparisonMingolla: "Einstieg ins Motorboot: wendig, einfach und das günstigste",
    comparisonTrimarchi: "Italienischer Sportcharakter für Routen mit Tempo",
    comparisonPacific: "Gruppen bis 7: das größte und stabilste der drei",
    regulationTitle: "Was die Vorschriften sagen",
    regulationIntro:
      "Seit dem RD 875/2014 verlangt das Führen eines Sportboots mit mehr als 15 PS eine offizielle nautische Qualifikation. Unsere drei Motorboote liegen über dieser Grenze, für die Miete ohne Skipper brauchst du also deinen gültigen Schein: Mit der Licencia de Navegación darfst du bereits unsere gesamte Flotte fahren.",
    regulationForeign:
    ...
    howToStep1Title: "Motorboot und Zeitfenster wählen",
    howToStep1Text:
      "Vergleiche die drei Motorboote in der Tabelle und entscheide, wie viele Stunden du willst: 2 Stunden, einen halben oder einen ganzen Tag. Schreib uns per WhatsApp oder buche über die Website.",
    howToStep2Title: "Deinen Schein prüfen",
    howToStep2Text:
      "Nutze den Online-Prüfer auf dieser Seite: Du wählst Land und Schein und weißt sofort, ob er gilt. Die spanische Licencia de Navegación deckt bereits die gesamte Flotte ab.",
    howToStep3Title: "Komm in den Hafen von Blanes",
    howToStep3Text:
      "Bring am Tag der Ausfahrt den Originalschein, deinen Ausweis und die Kaution von 500 EUR mit. Die Miete wird im Hafen bezahlt, ohne Onlinezahlung.",
    howToStep4Title: "Einweisung und Kurs auf Tossa",
    howToStep4Text:
      "Wir gehen Boot und Fahrgebiet in ein paar Minuten mit dir durch, und schon fährst du los: Lloret liegt 15 Minuten entfernt, Tossa de Mar 30-45.",
    howToStep5Title: "Zurückgeben und Kaution zurückbekommen",
    howToStep5Text:
      "Komm zur vereinbarten Zeit zurück, wir rechnen den Kraftstoff nach tatsächlichem Verbrauch ab und geben dir die Kaution sofort zurück, wenn alles in Ordnung ist.",
    vsMarketplacesTitle: "Direkt buchen oder über eine Plattform",
    vsMarketplacesIntro:
      "Unsere Motorboote stehen auch auf Vermietportalen. Boot und Hafen sind dieselben; was sich ändert, ist, mit wem du vor und während deiner Ausfahrt zu tun hast.",
    vsMarketplacesCol1: "Direkt bei uns",
    vsMarketplacesCol2: "Über eine Plattform",
    vsMarketplacesRow1Label: "Mit wem du sprichst",
    vsMarketplacesRow1Direct: "Mit den Eignern per WhatsApp, von der ersten Nachricht bis zur Übergabe",
    vsMarketplacesRow1Market: "Mit dem Nachrichtensystem des Portals und dessen Antwortzeiten",
    vsMarketplacesRow2Label: "Dein ausländischer Schein",
    vsMarketplacesRow2Direct: "Wir prüfen ihn online vor der Buchung",
    vsMarketplacesRow2Market: "Wird am Tag der Ausfahrt im Hafen geprüft",
    vsMarketplacesRow3Label: "Schlechtwetter-Garantie",
    vsMarketplacesRow3Direct: "Optional bei der Buchung: neuer Termin oder Rückerstattung in Geld",
    vsMarketplacesRow3Market: "Je nach den Bedingungen des jeweiligen Portals",
    vsMarketplacesRow4Label: "Terminänderungen",
    vsMarketplacesRow4Direct: "Kostenlos bis 7 Tage vorher, direkt mit uns",
    vsMarketplacesRow4Market: "Über den Vermittler abgewickelt",
    vsMarketplacesConclusion:
      "Gleiches Boot, gleicher Hafen: Wer direkt bucht, spricht mit denen, die das Motorboot übergeben, hat seinen Schein schon vor der Anreise geprüft und kann die Schlechtwetter-Garantie hinzubuchen.",
    faqSinPatronQuestion: "Kann ich an der Costa Brava ein Boot ohne Skipper mieten?",
    faqSinPatronAnswer:
    ...
    faqTitulacionQuestion: "Welchen Schein brauche ich mindestens? Genügt die Licencia de Navegación?",
    faqTitulacionAnswer:
      "Ja, die Licencia de Navegación (der spanische Basisschein) genügt für unsere gesamte Flotte mit Führerschein. Ebenso gelten PNB, PER und jeder höhere Schein sowie die gleichwertigen Scheine aus der EU.",
    faqForeignLicenseQuestion: "Gilt mein ausländischer Schein (SBF See, Permis Cotier, ICC)?",
    faqForeignLicenseAnswer:
      "Ja, wir akzeptieren gleichwertige ausländische Scheine: den deutschen SBF See (Sportbootführerschein See), den französischen Permis Cotier, den internationalen ICC und die Entsprechungen aus Ländern des EWR. Prüfe es im Online-Prüfer auf dieser Seite und bring den Schein am Tag der Ausfahrt im Original mit.",
    faqPriceQuestion: "Was kostet die stundenweise Miete eines Motorboots in Blanes?",
    faqPriceAnswer:
      "Ab 175 EUR für 2 Stunden in der Nebensaison und ab 210 EUR im August, je nach Motorboot. Halber und ganzer Tag haben eigene Tarife je Saison: Die Vergleichstabelle auf dieser Seite und die Preisseite zeigen die Details. Der Kraftstoff wird separat bezahlt.",
    faqFuelQuestion: "Ist der Kraftstoff bei den Booten mit Führerschein inbegriffen?",
    faqFuelAnswer:
      "Nein. Bei den Motorbooten mit Führerschein wird der Kraftstoff nach dem tatsächlichen Verbrauch der Ausfahrt separat bezahlt. Versicherung und Sicherheitsausrüstung sind dagegen immer inbegriffen.",
    faqDepositQuestion: "Wie funktioniert die Kaution von 500 Euro?",
    faqDepositAnswer:
      "Sie wird am Tag der Ausfahrt hinterlegt und vollständig erstattet, wenn das Motorboot in demselben Zustand zurückkommt, in dem es losgefahren ist. Es gibt außerdem eine optionale Deckung für eine reduzierte Kaution, wenn du lieber weniger Geld blockierst.",
    faqWeatherQuestion: "Was passiert, wenn am Miettag schlechtes Wetter ist?",
    faqWeatherAnswer:
      "Du kannst den Termin bis 7 Tage vor der Ausfahrt kostenlos ändern. Verhindert schlechtes Wetter die Ausfahrt, verschieben wir den Termin kostenlos oder stellen einen Gutschein über den gezahlten Betrag mit 12 Monaten Gültigkeit aus. Mit gebuchter Schlechtwetter-Garantie wählst du zwischen einem neuen Termin und der vollständigen Rückerstattung in Geld.",
    faqCrossLinkLabel: "Die Motorboote mit Führerschein ansehen",
    crossLinkFromFree: "Hast du einen Schein? Motorboote mit 80 bis 115 PS bis Tossa",
    linksTitle: "Weiter stöbern",
    linksBlanes: "Hafen von Blanes: der Startpunkt",
    ...
    ctaDescription:
      "Sag uns Tag, Stunden und wie viele ihr seid, und wir bestätigen die Verfügbarkeit sofort. Ohne Onlinezahlung: Du buchst per WhatsApp und zahlst im Hafen.",
    ctaButton: "Mein Motorboot buchen",
  },
  blogPage: {
  ...
  faqPreview: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Der Titul\u00EDn ist die Licencia de Navegaci\u00F3n: der schnellste Bootsschein Spaniens. Man erh\u00E4lt ihn an einem Tag mit 2 Stunden Theorie und 4 Stunden Praxis an Bord, ohne Pr\u00FCfung, und er l\u00E4uft nie ab. Er erlaubt Boote bis 6 Meter, tags\u00FCber und bis 2 Seemeilen von einem Schutzhafen: in unserer Flotte die Mingolla Brava 19, die Trimarchi 57S und die Pacific Craft 625. Wir organisieren den Kurs und kombinieren ihn mit Ihrer ersten Miete; schreiben Sie uns und wir erkl\u00E4ren es Ihnen.",
      },
      {
        id: "precios",
  ...
  boatDescriptions: {
    ...
    "pacific-craft-625":
      "Das beste Mietboot in Blanes. 5,90 m eingetragene Länge (die «625» ist der Handelsname, nicht das Maß), Yamaha 115 PS und luxuriöser Platz für 7. Doppeltes Solarium, Tisch für Mahlzeiten vor Anker, Süßwasserdusche und elektronische Steuerung. Für alle, die keine Kompromisse eingehen und das kompletteste Bootserlebnis an der Costa Brava suchen. Licencia de Navegación (LN) oder höher erforderlich.",
    "excursion-privada":
  ...
  faqPage: {
    ...
    items: {
      ...
      titulin: {
        question: "Was ist der Titulín und wie bekomme ich ihn?",
        answer:
          "Der Titulín ist die Licencia de Navegación: Spaniens schnellster Bootsführerschein. Sie erhalten ihn an einem Tag mit 2 Stunden Theorie und 4 Stunden Praxis in einer zugelassenen Wassersportschule, ohne Prüfung, und er läuft nie ab. Er erlaubt Boote bis 6 Meter, bei Tag und bis zu 2 Meilen von einem Schutzort: In unserer Flotte deckt er die Mingolla Brava 19, die Trimarchi 57S und die Pacific Craft 625 ab. Schreiben Sie uns und wir sagen Ihnen, wo Sie ihn in der Nähe von Blanes machen können.",
      },
      licenciasAceptadas: {
        question: "Welche Lizenzen akzeptieren Sie für größere Boote?",
        answer:
          "Für Boote mit Führerschein genügt die Licencia de Navegación (LN), die Mindestqualifikation: Sie deckt unsere gesamte Flotte ab. Wir akzeptieren außerdem PNB (Patrón de Navegación Básica), PER (Patrón de Embarcaciones de Recreo), Capitán de Yate, gleichwertige europäische Scheine (der deutsche SBF See, Sportbootführerschein See, ist ausdrücklich akzeptiert) und anerkannte internationale Scheine wie den ICC. Sie müssen den Originalschein am Miettag vorlegen.",
      },
      edadMinima: {
    ...
    terms: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: "Die Abschnitte 13 bis 16 regeln ausschließlich den Kauf der physischen Produkte im Shop-Bereich dieser Website (Geschenkgutscheine und Jetski-Aktivitäten richten sich nach den Abschnitten 17 und 18) (Kollektion Costa Brava Culture, in Zusammenarbeit mit Laura Cabanas). Verkäufer dieser Produkte ist DAMAR COSTA BRAVA S.L., Steuernummer (CIF) B22566327, mit Zustellanschrift in Carrer Esplanada del Port, 17300 Blanes, Girona, Spanien, Telefon +34 611 500 372 und E-Mail info@costabravarentaboat.com (im Folgenden der Verkäufer). Die Abschnitte 1 bis 12 betreffen den Bootsverleih und gelten nicht für Käufe im Shop.",
        },
        {
          title: "14. Online-Shop: Preise, Zahlung und Lieferung",
          body: "Alle Preise im Shop sind in Euro und inklusive Mehrwertsteuer angegeben. Die Zahlung erfolgt im Voraus über das sichere Zahlungsportal Stripe; der Verkäufer hat keinen Zugriff auf die Kartendaten und speichert sie nicht.\n\nLieferoptionen:\n- Kostenlose Abholung am Hafen von Blanes, Terminabsprache per WhatsApp.\n- Kostenlose Abholung im Geschäft von Laura Cabanas, Carrer del Carme 5, Lloret de Mar.\n- Lieferung nach Hause auf das spanische Festland für 4,95 EUR, mit einer geschätzten Lieferzeit von 3 bis 7 Werktagen ab Zahlungsbestätigung.\n\nSollte ein Produkt nach der Zahlung nicht verfügbar sein, informiert der Verkäufer den Kunden so schnell wie möglich und erstattet den entsprechenden Betrag.",
        },
        {
          title: "15. Online-Shop: Widerrufsrecht",
          body: "Der Kunde hat das Recht, den Kauf ohne Angabe von Gründen innerhalb von 14 Kalendertagen ab Erhalt oder Abholung des Produkts zu widerrufen. Dazu genügt eine eindeutige Erklärung innerhalb dieser Frist per E-Mail an info@costabravarentaboat.com oder per WhatsApp an +34 611 500 372 unter Angabe der Bestellnummer. Dieses Muster kann verwendet werden, ist aber nicht verpflichtend: Hiermit widerrufe ich meinen Kaufvertrag über das folgende Produkt [Produkt], bestellt am [Datum] und erhalten am [Datum]; Name, Anschrift und Datum.\n\nDas Produkt muss unbenutzt und im Originalzustand innerhalb von höchstens 14 Kalendertagen ab der Mitteilung zurückgegeben werden, entweder an einem der beiden Abholpunkte oder per Versand an die vom Verkäufer angegebene Adresse; die unmittelbaren Kosten der Rücksendung trägt der Kunde. Der Verkäufer erstattet alle erhaltenen Zahlungen, einschließlich etwaiger ursprünglicher Lieferkosten, innerhalb von 14 Kalendertagen ab der Widerrufserklärung und über dasselbe Zahlungsmittel wie beim Kauf; die Erstattung kann zurückgehalten werden, bis das Produkt oder ein Nachweis der Rücksendung eingegangen ist.",
        },
        {
  ...
  relatedLocations: {
    ...
    categories: {
      ...
      licensed: {
        ...
        features: ["80-115 PS", "Höhere Geschwindigkeit", "Größere Reichweite"],
      },
    },
  },
    ...
    terms: [
      {
        ...
        definition: 'Spanischer Bootsführerschein der untersten Stufe, anerkannt durch das RD 875/2014. Berechtigt zum Führen von Booten bis 6 Meter Länge mit zum Rumpf passendem Motor und bis 2 Seemeilen von der Küste entfernt, bei Tageslicht. Dies ist der Mindestführerschein für die lizenzpflichtigen Boote unserer Flotte (Mingolla Brava 19, Trimarchi 57S und Pacific Craft 625). Keine Prüfung: die zugelassene Bootsfahrschule bescheinigt die Ausbildung und stellt den Schein in eigener Verantwortung aus.',
        category: 'titulacion',
      },
      {
  ...
  garantiasPage: {
    ...
    criteriaMarks: ["AEMET", "20 kn", "Das Unternehmen"],
    criteria: [
  ...
  navigationLicensePage: {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Motorboote bis 6 Meter Länge, bei Tag und bis zu 2 Seemeilen von einem Hafen oder Schutzort entfernt, außerdem Jetskis der Klasse C. In unserer Flotte deckt sie die Mingolla Brava 19, die Trimarchi 57S und die Pacific Craft 625 ab.",
      },
      {
  ...
  captainedPage: {
    ...
    seoDescription:
      "Private Bootstour mit Skipper ab Blanes: Buchten und Meereshöhlen bis Tossa de Mar, Badestopp inklusive. Bis zu 6 Personen, ab 265€/2 Std. {rating}★ bei Google.",
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Ab 265€ für 2 Stunden von April bis Juni und im September, 285€ im Juli und 310€ im August. Es gibt auch Ausfahrten von 3 Stunden (ab 350€) und 4 Stunden (ab 420€). Der Preis gilt pro Boot, für bis zu 6 Personen.",
      },
      {
  ...
  shopPage: {
    ...
    seoDescription:
      "T-Shirts und Tote Bags der Costa Brava Culture Kollektion, entworfen mit Laura Cabanas (Lloret de Mar). Limitierte Auflage, sichere Zahlung und kostenlose Abholung im Hafen von Blanes oder Versand auf das spanische Festland.",
    navLabel: "Shop",
    hero: {
    ...
    cart: {
      ...
      legalNote: "Mit der Zahlung akzeptierst du die {enlace}.",
      legalNoteLink: "Verkaufsbedingungen des Shops",
    },
    delivery: {
      title: "Lieferung",
      ...
      shippingText: "Versand auf das spanische Festland fuer 4,95 EUR. Lieferung in 3 bis 7 Werktagen.",
    },
    designer: {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Derzeit versenden wir nur auf das spanische Festland (4,95 EUR, Lieferung in 3 bis 7 Werktagen). Wenn du in der Gegend Urlaub machst, ist die Abholung im Hafen von Blanes kostenlos.",
      },
      {
  ...
  locationPages: {
    ...
    malgrat: {
      ...
      sections: {
        ...
        fuelIncludedDesc: 'Alle unsere Vermietungen beinhalten den Kraftstoff. Keine versteckten Kosten. Ab 85 €/Stunde.',
    ...
    costaBrava: {
      hero: {
        ...
        subtitle: 'Entdecke die schönsten Buchten und Strände der Costa Brava an Bord unserer Boote. Abfahrt vom Hafen von Blanes, im Herzen der katalanischen Küste. Führerscheinfreie Boote ab 85 €/Stunde inklusive Treibstoff und Versicherung.',
    ...
    tordera: {
      ...
      seo: {
        title: 'Bootsvermietung Tordera | Hafen Blanes 15 Min | Ohne Führerschein 85€/Std | Delta del Tordera',
        description: 'Wohnst du in Tordera oder in der Nähe des Deltas? Hafen Blanes 15 Min mit dem Auto oder 8 Min mit dem Zug R1. Boot ohne Führerschein ab 85€/Std mit Benzin inklusive. Erkunde das Delta del Tordera.',
        ogTitle: 'Bootsvermietung Tordera | Delta del Tordera mit dem Boot',
        ogDescription: 'Von Tordera zum Hafen Blanes in 15 Min. Boot ohne Führerschein ab 85€/Std. Delta del Tordera per Boot. 4.8★.',
      },
      schema: {
        name: 'Bootsvermietung in der Nähe von Tordera',
        description: 'Miete Boote ab dem Hafen von Blanes, nur 15 Autominuten von Tordera entfernt. Boote ohne Führerschein ab 85 €/Stunde mit Benzin inklusive.',
      },
      ...
      sections: {
        ...
        whyCard3Desc: 'Der Preis für Boote ohne Führerschein beinhaltet das Benzin. Ab 85 € pro Stunde. Keine versteckten Kosten oder Überraschungen beim Endpreis.',
        ...
        pricingLicEngines: 'Motoren von 80 bis 115 PS',
    ...
    palafolls: {
      ...
      seo: {
        title: 'Bootsvermietung Palafolls | Hafen Blanes 12 Min | Ohne Führerschein 85€/Std',
        description: 'Auf einem Campingplatz oder in einer Unterkunft in Palafolls? Hafen Blanes 12 Min mit dem Auto. Boot ohne Führerschein ab 85€/Std mit Benzin inklusive. Idealer Ausflug Costa Brava.',
        ogTitle: 'Bootsvermietung Palafolls | 12 Min zum Hafen Blanes',
        ogDescription: 'Von Palafolls zum Hafen Blanes in 12 Min. Boot ohne Führerschein ab 85€/Std. Benzin inklusive. 4.8★.',
      },
      schema: {
        name: 'Bootsvermietung in der Nähe von Palafolls',
        description: 'Miete Boote ab dem Hafen von Blanes, nur 12 Autominuten von Palafolls entfernt. Boote ohne Führerschein ab 85 €/Stunde mit Benzin inklusive.',
      },
      ...
      sections: {
        ...
        whyCard3Title: 'Benzin bei Booten ohne Führerschein inklusive',
        whyCard3Desc: 'Der Preis für Boote ohne Führerschein beinhaltet das Benzin. Ab 85 € pro Stunde. Keine versteckten Kosten oder Treibstoffzuschläge.',
        whyCard4Title: 'Keine Vorkenntnisse erforderlich',
    ...
    pineda: {
      ...
      seo: {
        title: 'Bootsvermietung Pineda de Mar | Hafen Blanes 18 Min | Ohne Führerschein 85€/Std',
        description: 'Unterkunft in Pineda de Mar? Hafen Blanes 18 Min mit dem Auto oder 12 Min mit dem Zug R1. Boot ohne Führerschein ab 85€/Std mit Benzin inklusive. Fahr nach Blanes, Lloret oder Tossa.',
        ogTitle: 'Bootsvermietung Pineda de Mar | 18 Min zum Hafen Blanes',
        ogDescription: 'Von Pineda de Mar zum Hafen Blanes in 18 Min. Boot ohne Führerschein ab 85€/Std. 4.8★ Google.',
      },
      schema: {
        name: 'Bootsvermietung in der Nähe von Pineda de Mar',
        description: 'Miete Boote ab dem Hafen von Blanes, nur 18 Autominuten von Pineda de Mar entfernt. Boote ohne Führerschein ab 85 €/Stunde mit Benzin inklusive.',
      },
      ...
      sections: {
        ...
        whyCard3Title: 'Benzin bei Booten ohne Führerschein inklusive',
        whyCard3Desc: 'Der Preis für Boote ohne Führerschein beinhaltet das Benzin, sodass es keine Überraschungen gibt. Ab 85 € pro Stunde. Der Preis, den du siehst, ist der Endpreis.',
        whyCard4Title: 'Keine Vorkenntnisse erforderlich',
