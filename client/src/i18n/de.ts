...
export const de: Translations = {
  ...
  neverSailed: {
    ...
    subtitle: 'In 3 Schritten segeln Sie durch die schoensten Buchten der Costa Brava',
    step1Title: 'Ankunft am Hafen von Blanes',
    step1Desc: 'Wir erwarten Sie im Hafen. Parkplaetze in der Naehe verfuegbar.',
    step2Title: 'Wir schulen Sie in 15 Minuten',
    step2Desc: 'Wir zeigen Ihnen alles, was Sie fuer sicheres Fahren brauchen.',
    step3Title: 'Geniessen Sie die Buchten',
    step3Desc: 'Fahren Sie frei durch die besten Buchten der Costa Brava.',
    cta: 'Boote ohne Fuehrerschein ansehen',
  },
  contact: {
    title: 'Fragen?',
