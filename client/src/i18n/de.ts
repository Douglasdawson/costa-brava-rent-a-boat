...
export const de: Translations = {
  ...
  hero: {
    title: 'Bootsverleih ohne Führerschein in Blanes',
    subtitle: 'Entdecken Sie geheime Buchten der Costa Brava, nur per Boot erreichbar. Ohne Erfahrung. 15 Min Einweisung und los geht\'s.',
    subtitleLine1: 'Ohne Erfahrung. 15 Min Einweisung und los geht\'s.',
    subtitleLine2: 'Entdecken Sie geheime Buchten der Costa Brava, nur per Boot erreichbar.',
  ...
  locationPages: {
    blanes: {
      ...
      sections: {
        ...
        expTossaDesc: 'Mit einem fuehrerscheinpflichtigen Boot fahren Sie eine Stunde nach Norden zur Vila Vella von Tossa de Mar, vorbei an versteckten Buchten und spektakulaeren Klippen.',
    ...
    malgrat: {
      ...
      sections: {
        ...
        boatDestinationsDesc: 'Fahren Sie nach Lloret de Mar (25 Min.) und Tossa de Mar (1 Std.) und entdecken Sie Buchten wie Cala Sant Francesc und Cala Brava.',
  ...
  rangeFromBlanes: {
    ...
    ext: {
      ...
      tossa: 'Tossa de Mar — mittelalterliche Vila Vella vom Meer (~60 min)',
