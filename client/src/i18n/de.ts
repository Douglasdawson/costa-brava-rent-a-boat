...
export const de: Translations = {
  ...
  categoryLicenseFree: {
    ...
    regulationTitle: 'Vorschriften fur das Fahren ohne Bootsfuhrerschein in Spanien',
    regulationIntro: 'In Spanien regelt das Konigliche Dekret 875/2014 die nautischen Qualifikationen und legt fest, dass Boote mit Motoren bis zu 11,26 kW (15 PS) ohne jeglichen Bootsfuhrerschein oder Qualifikation gefahren werden durfen. Diese Regelung ermoglicht es jeder Person ab 18 Jahren, ein Boot ohne Fuhrerschein vollig legal zu mieten und zu fahren.',
    regulationRequirements: 'Die Anforderungen sind einfach: mindestens 18 Jahre alt sein, ein Sicherheitsbriefing vor der Abfahrt erhalten (bei uns immer inklusive), Schwimmwesten fur alle Passagiere mitfuhren und die festgelegten Navigationsgrenzen einhalten. Keine Vorkenntnisse oder spezielle Ausbildung erforderlich.',
    regulationAllowed: 'Mit einem Boot ohne Fuhrerschein konnen Sie frei entlang der Kuste von Blanes fahren, in Buchten und an Stranden ankern, schnorcheln, auf dem Meer sonnenbaden und die Klippen der Costa Brava erkunden. All dies innerhalb eines Radius von 2 Seemeilen von der Kuste und bei gunstigen Wetterbedingungen.',
    regulationNotAllowed: 'Boote ohne Fuhrerschein durfen nicht nachts fahren, sich nicht weiter als 2 Seemeilen von der Kuste entfernen und nicht mehr Passagiere befordern, als in den technischen Spezifikationen des Bootes angegeben. Diese Einschrankungen dienen der Sicherheit aller Bootsfahrer.',
    regulationFuelIncluded: 'Bei unseren Booten ohne Fuhrerschein ist der Treibstoff im Mietpreis inbegriffen. Sie mussen sich keine Sorgen um das Tanken oder zusatzliche Treibstoffkosten machen. Der angezeigte Preis ist der Endpreis.',
    comparisonTitle: 'Detaillierter Vergleich Unserer Boote ohne Fuhrerschein',
    comparisonIntro: 'Wir haben 5 Boote ohne Fuhrerschein im Hafen von Blanes, jedes mit eigenem Charakter. Schauen Sie in die Tabelle, um das Boot zu finden, das am besten zu Ihren Planen passt.',
    ...
    testimonial1Text: 'Wir haben die Remus 450 fur einen Tag mit den Kindern gemietet. Man zeigte uns in 10 Minuten, wie man sie bedient, und wir ankerten in einer wunderschonen Bucht zum Schnorcheln. Die Kleinen horten nicht auf, ins Wasser zu springen. Wir kommen bestimmt wieder.',
    ...
    faqSpeedQuestion: 'Wie schnell fahren Boote ohne Fuhrerschein?',
    faqSpeedAnswer: 'Boote ohne Fuhrerschein mit einem 15-PS-Motor erreichen eine Hochstgeschwindigkeit von etwa 12-15 Knoten (ca. 22-28 km/h). Das ist eine komfortable und sichere Geschwindigkeit fur Kustenfahrten, Ankern in Buchten und Genuss der Landschaft in entspanntem Tempo.',
    faqChildrenQuestion: 'Kann ich Kinder auf ein Boot ohne Fuhrerschein mitnehmen?',
    faqChildrenAnswer: 'Ja, Kinder jeden Alters sind an Bord willkommen. Der Fahrer muss mindestens 18 Jahre alt sein, aber Passagiere konnen jeden Alters sein. Alle unsere Boote sind mit Schwimmwesten in allen Grossen ausgestattet, einschliesslich Kindergrossen. Viele Familien wahlen unsere Boote ohne Fuhrerschein gerade wegen ihrer Stabilitat und Sicherheit.',
    faqDistanceQuestion: 'Wie weit kann ich ohne Fuhrerschein von Blanes aus fahren?',
    faqDistanceAnswer: 'Die Vorschriften erlauben das Fahren bis zu 2 Seemeilen (3,7 km) von der Kuste. Vom Hafen Blanes aus konnen Sie zahlreiche Buchten nordwarts (Richtung Lloret de Mar) und sudwarts (Richtung Malgrat de Mar) erkunden. In 2-3 Stunden konnen Sie mehrere Buchten besuchen, zum Schnorcheln ankern und gemutlich zum Hafen zuruckkehren.',
  },
  categoryLicensed: {
  ...
  exitIntent: {
    ...
    abandonedSubtitle: 'Die {boat} ist bereit fur Sie',
