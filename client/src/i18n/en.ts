...
export const en: Translations = {
  ...
  categoryLicensed: {
    ...
    professionalEquipmentDesc:
      "Our licensed boats include advanced equipment: GPS, depth sounder, VHF radio, larger fuel capacity, better seating and professional navigation systems.",
    superiorPerformance: "Superior Performance",
    superiorPerformanceDesc:
      "Higher cruising speed, better stability in open waters, capacity to carry more passengers comfortably and enough range for full-day excursions.",
    ...
    ctaDescription:
      "Hire a licensed boat and experience true sailing freedom. Power, speed and unlimited access to the entire Costa Brava.",
  ...
  faqPage: {
    ...
    items: {
      ...
      licenciasAceptadas: {
        ...
        answer:
          "For boats with license we accept: PER (Patrón de Embarcaciones de Recreo), PNB (Patrón de Navegación Básica), Yacht Captain, equivalent European licenses and approved international licenses. You must present the original license on the day of rental.",
      },
      edadMinima: {
