...
export const en: Translations = {
  ...
  hero: {
    ...
    marqueeText: 'Boat Rental in Blanes | With and Without Licence | Fuel Included | From \u20AC70/h',
  ...
  boats: {
    ...
    imageAltNoLicense: 'Rent {name} boat without licence in Blanes, Costa Brava — {capacity} people, from {price}€',
    imageAltWithLicense: 'Rent {name} boat with licence in Blanes, Costa Brava — {capacity} people, from {price}€',
  },
  features: {
    ...
    exploreLinks: {
      licenseFree: 'Licence-free boats',
  ...
  contact: {
    ...
    navLicensedDesc: 'Powerful vessels to reach further. Licence required.',
  ...
  comparison: {
    ...
    withLicenseDesc: 'More power, more speed, further range. Licence required.',
  ...
  a11y: {
    ...
    filterByLicense: "Filter by boating licence",
  ...
  emotionTags: {
    ...
    premiumNoLicense: 'Premium licence-free',
  ...
  pricingPage: {
    ...
    heroSubtitle: 'Check and compare prices for all our boats. Low, mid and high season. Licence-free boats with fuel included.',
    fuelBadge: 'Fuel included (no licence)',
    ...
    licenseTypes: {
      none: 'No licence',
      navegacion: 'Navigation Licence',
      pnb: 'PNB required',
      per: 'PER required',
      patron_yate: 'Yacht Skipper',
      capitan_yate: 'Yacht Captain',
    },
    licenseFallback: 'Licence required',
    table: {
      boat: 'Boat',
      capacity: 'Capacity',
      license: 'Licence',
    ...
    info: {
      ...
      fuelIncludedItem: '<strong>Fuel included</strong> on licence-free boats',
    ...
    faq: {
      q1: 'How much does it cost to rent a licence-free boat in Blanes?',
      a1Template: 'Licence-free boats in Blanes cost from {noLicBaja1h} €/hour in low season (April-June, September-October). In mid season (July) from {noLicMedia1h} €/hour and in high season (August) from {noLicAlta1h} €/hour. The price includes fuel, insurance and safety equipment.',
      q2: 'Is fuel included in the price?',
      a2: 'Yes, all our licence-free boats include fuel in the price. For licensed boats, fuel is paid separately based on actual consumption.',
      ...
      q4: 'How much does it cost to rent a boat with a licence?',
  ...
  locationBarcelona: {
    hero: {
      ...
      description: 'Just 70 minutes from Barcelona, Blanes Port offers you the best boating experience on the Costa Brava. Boats without licence from {noLicBaja1h} € with fuel included.',
      badgeDistance: '70 min from Barcelona',
      badgeLicense: 'No licence from {noLicBaja1h} €',
      badgeWaters: 'Crystal-clear waters',
    },
    whyBlanes: {
      title: 'Why rent in Blanes instead of Barcelona',
      betterPricesTitle: 'Better prices',
      betterPricesBody: 'In Blanes, boats without licence start from {noLicBaja1h} €/hour with fuel included. In Barcelona, prices start from 120-150 €/hour without fuel. You save up to 50% on your rental.',
    ...
    boats: {
      title: 'Our boats',
      noLicenseTitle: 'Boats without licence',
      noLicenseBody: '5 boats for 4-5 people. No previous experience or licence required. We give you a 15-minute briefing and you\'re ready to sail. Fuel included in the price.',
      noLicenseBullet1: 'Up to 5 people per boat',
      noLicenseBullet2: 'From 1 hour rental',
      licensedTitle: 'Boats with licence',
      licensedBody: '2 powerful boats for up to 7 people. Require PER or equivalent boating licence. Greater range and speed to explore the entire Costa Brava.',
    ...
    cta: {
      ...
      subtitle: 'Just 70 minutes from Barcelona. Boats without licence from {noLicBaja1h} € with fuel included. Crystal-clear waters and secret coves await you.',
  ...
  seoSchemas: {
    seasonalEvent: {
      ...
      description: 'Rent boats without a licence in Blanes, Costa Brava. Season from April to October.',
    },
    coves: {
      listName: 'Coves accessible from Blanes Port with a licence-free boat',
      listDescription: 'Ordered list of the 8 main coves between Blanes and Fenals Beach accessible with a licence-free boat in under 25 minutes of navigation (legal limit 2 nautical miles, 5 knots).',
      ...
      propLicenseRequired: 'Boating licence required',
      propEndpoint: 'Northern no-licence legal limit',
      descriptions: {
        ...
        playaDeFenals: 'Urban beach south of Lloret de Mar. Northern legal limit for licence-free boats from Blanes.',
      },
    },
  },
  licenseTypes: {
    none: 'No licence required',
    navegacion: 'Basic Navigation Licence (LNB)',
  ...
  activityFamilies: {
    faqItems: [
      ...
      {
        question: 'Do I need a boating licence to rent a family boat?',
        answer: 'No. Our licence-free boats do not require any nautical qualification. You only need to be over 18 years old. We give you a full 15-minute briefing before departure. They are safe, stable boats that are very easy to handle.',
      },
      {
        question: 'What does the rental price include?',
        answer: 'The price for licence-free boats includes fuel, insurance, life jackets for everyone (including children\'s), bathing ladder, awning/bimini for shade and the safety briefing. Only snorkeling equipment is additional (7.50 EUR/person).',
      },
      {
  ...
  locationPages: {
    blanes: {
      faqItems: [
        {
          question: 'Do I need a licence to rent a boat in Blanes?',
          answer: 'No. We have 5 boats that don\'t require a licence for up to 5 people. You just need to be over 18 years old. We give you a 15-minute briefing before you set off.',
        },
        {
          question: 'How much does it cost to rent a boat at Blanes Marina?',
          answer: 'Boats without licence start from {noLicBaja1h} EUR/hour in low season (April–June, September–October). In high season (August) from {noLicAlta1h} EUR/hour. The price includes fuel, insurance and safety equipment.',
        },
        {
        ...
        {
          question: 'Is it safe to navigate without a licence from Blanes?',
          answer: 'Yes. Our licence-free boats have a maximum of 15 HP, require no qualification and navigate close to the coast. We include 15 minutes of safety training, life jackets and emergency equipment.',
        },
      ],
      hero: {
      ...
      sections: {
        ...
        crossLinkLicenseFree: 'Licence-free boat rental',
      ...
      schema: {
        ...
        description: 'Licence-free and licensed boat rental in Blanes. Blanes Port, Costa Brava. Boats for 4-7 people.',
      },
    },
    lloret: {
      faqItems: [
        {
          question: 'Do I need a licence or experience to reach Lloret by boat?',
          answer: 'No. Our licence-free boats meet the legal requirements to navigate to Fenals Beach (south of Lloret) without a qualification or prior experience. We give you a 15-minute briefing before you set off. The only restriction is being over 18 years old.',
        },
        {
          question: 'How far exactly can I go with a licence-free boat?',
          answer: 'Legally, up to 2 nautical miles from the coast, at a maximum of 5 knots, with 15 HP. From Blanes, that\'s 25 minutes of navigation to Fenals Beach, passing 7 coves. Lloret town beach and Cala Canyelles are north of Fenals — they are not accessible with a licence-free boat.',
        },
        {
          question: 'How much does it cost to rent a licence-free boat to go to Lloret?',
          answer: 'From {noLicBaja1h} €/hour (low season) and {noLicAlta1h} €/hour (high season, July–August). With fuel included on licence-free boats.',
        },
        {
          question: 'Can I reach Tossa de Mar from Lloret with a licence-free boat?',
          answer: 'No. Tossa is 4–5 miles north of Fenals, outside the legal range without a licence. To go to Tossa by boat from Blanes you need (a) a boat with a Basic Navigation Licence (LNB), or (b) a Private Excursion with Captain.',
        },
        {
      ...
      sections: {
        ...
        relatedLicenseFree: 'Licence-free boats available in Blanes',
    ...
    tossa: {
      faqItems: [
        {
          question: 'Can I reach Tossa de Mar with a licence-free boat from Blanes?',
          answer: 'No. Licence-free boats (2 miles from coast, 5 knots, 15 HP) reach as far as Fenals Beach (south of Lloret), 4 miles before Tossa. To reach Tossa you need a Basic Navigation Licence (LNB) or book the Private Excursion with Captain.',
        },
        {
        ...
        {
          question: 'How much does it cost to rent to Tossa with a Basic Licence (LNB)?',
        ...
        {
          question: 'Is it worth going to Tossa by boat if I don\'t have a licence?',
          answer: 'Yes, via the Private Excursion with Captain (Pacific Craft 625, 4 h, from {excursionBaja4h} €). The only option without needing a licence.',
        },
      ],
      hero: {
    ...
    malgrat: {
      ...
      sections: {
        ...
        varietyBoatsDesc: 'From licence-free boats perfect for families to licensed vessels for experienced sailors. For 4 to 7 passengers.',
        fuelIncluded: 'Fuel Included',
        ...
        noExperienceDesc: 'We offer licence-free boats with a 15-minute training included. Ideal for tourists wanting a unique experience.',
      ...
      faqItems: [
        ...
        },
        {
          ...
          answer: 'Boat rental starts from {noLicBaja1h} EUR per hour with fuel included. No licence required for boats up to 15 HP. We have {fleetCount} boats for 4-11 people.',
        },
        {
          question: 'Do I need a boating licence?',
          answer: 'Not necessarily. We offer licence-free boats that anyone over 18 can operate. We give you 15 minutes of training before setting off. We also have licensed boats.',
        },
        {
        ...
        },
        {
          ...
          answer: 'With a licence-free boat from Blanes you reach Fenals Beach (south of Lloret) in 25 minutes, passing 7 coves: Sa Forcanera, Cala Sant Francesc, Cala de s\'Agulla, Cala Treumal, Santa Cristina Beach, Cala Sa Boadella and Fenals Beach. With a Basic Licence boat you can reach Tossa de Mar (45 min) and beyond.',
        },
        {
    ...
    santaSusanna: {
      faqItems: [
        ...
        {
          question: 'Do I need a boating licence to rent a boat?',
          answer: 'Not necessarily. We offer licence-free boats that anyone over 18 can operate. We give you 15 minutes of training before setting off. We also have licensed boats.',
        },
        {
        ...
        },
        {
          ...
          answer: 'From Blanes we recommend: (a) 4h cove route without licence to Fenals Beach anchoring in 2-3 crystal-clear coves (from 135 EUR for 5 people); (b) 4h private excursion with skipper to Tossa and Cala Bona (from {excursionBaja4h} EUR, ideal if you have no boating experience); (c) Basic Licence boat if someone in the group has a qualification (from 240 EUR / 4h).',
        },
        {
          question: 'Can I do a sunset boat trip from Santa Susanna?',
          answer: 'Yes, it\'s very popular. From Blanes we offer sunset trips (18:30-21:00 depending on month) with a licence-free boat at 115 EUR for 2 hours. You\'ll navigate the 7 coves in golden light. From Santa Susanna you\'re 15 min by car or 10 min by train. Book ahead in summer.',
        },
      ],
      hero: {
        title: 'Boat Rental near Santa Susanna',
        subtitle: 'On holiday in Santa Susanna? Blanes Port is just 15 minutes by car. Rent a licence-free boat and explore the Costa Brava.',
      ...
      sections: {
        ...
        varietyBoatsDesc: 'Licence-free for beginners and families, licensed for experienced sailors. Capacity from 4 to 7 passengers per boat.',
    ...
    calella: {
      faqItems: [
        ...
        },
        {
          ...
          answer: 'You don\'t need experience. We offer licence-free boats that anyone over 18 can operate. We give you 15 minutes of training before setting off, including navigation rules and safety.',
        },
        {
        ...
        },
        {
          ...
          answer: 'Not directly from Calella (no rentals). From Blanes yes: with a boat with Basic Navigation Licence (LNB) you reach Tossa in 45 min (from {licBaja2h} EUR/2h), or with our Private Excursion with Captain 4h to Tossa including Cala Bona and Vila Vella (from {excursionBaja4h} EUR for up to 7 people). Licence-free boats cannot reach Tossa due to the legal limit of 2 miles.',
        },
        {
      ...
      sections: {
        ...
        varietyBoatsDesc: 'Licence-free boats from 70 EUR/h for families and groups of friends. Licensed boats for sailors with PER or private skipper.',
        ...
        noExperienceDesc: 'Never sailed before? No problem. Our licence-free boats are easy to handle and we provide training before you set sail.',
    ...
    costaBrava: {
      ...
      sections: {
        ...
        licensedDesc: 'To explore beyond the immediate coastline. Our licensed boats offer greater power, range and capacity. Ideal for reaching Tossa de Mar, Sant Feliu de Guixols or even the Medes Islands. Fuel is charged separately based on actual consumption. PER, PNB or equivalent European licence required.',
    ...
    tordera: {
      faqItems: [
        ...
        },
        {
          ...
          answer: 'Licence-free boat rental starts from {noLicBaja1h} EUR per hour with fuel included. Licensed boats from {licBaja2h} EUR for 2 hours. We have {fleetCount} boats for 4-11 people.',
        },
        {
          question: 'Do I need a boating licence?',
          answer: 'Not necessarily. We offer licence-free boats that anyone over 18 can operate. We give you 15 minutes of training before setting off. We also have licensed boats for experienced boaters.',
        },
        {
          question: 'Is there parking at Blanes Marina?',
      ...
      seo: {
        title: 'Boat Rental Tordera | Blanes Port 15 min | No Licence 70€/h | Tordera Delta',
        description: 'Do you live in Tordera or near the Delta? Blanes Port is 15 min by car or 8 min by R1 train. Rent a boat without a licence from 70€/h with fuel included. Explore the Tordera Delta.',
        ogTitle: 'Boat Rental Tordera | Tordera Delta by Boat',
        ogDescription: 'From Tordera to Blanes Port in 15 min. Boat without licence from 70€/h. Tordera Delta by boat. 4.8★.',
      },
      schema: {
        name: 'Boat Rental near Tordera',
        description: 'Rent boats from Blanes Port, just 15 minutes by car from Tordera. Boats without licence from 70 EUR/hour with fuel included.',
      },
      ...
      sections: {
        ...
        whyCard2Desc: 'Our fleet includes {fleetCount} boats: boats without licence ideal for families and beginners, and boats with licence for the more experienced. From boats for 4 people to vessels for groups of up to 11 people.',
        whyCard3Title: 'Fuel included on boats without licence',
        whyCard3Desc: 'The price of boats without licence includes fuel. From 70 EUR per hour with the Astec 400, or from 75 EUR per hour with other models. No hidden costs or surprises in the final price.',
        whyCard4Title: 'No previous experience necessary',
        whyCard4Desc: 'Before setting sail we offer you 15 minutes of practical training where you\'ll learn how to handle the engine, basic navigation rules and the best spots to explore. Anyone over 18 can pilot our boats without a licence.',
        ...
        pricingIntro: 'Transparent prices with fuel included on all boats without licence. No surprises or additional costs.',
        pricingNoLicTitle: 'Boats without licence',
        pricingNoLicFrom: 'From {noLicBaja1h} EUR/hour (fuel included)',
        pricingNoLicCapacity: 'Capacity: 4-7 people depending on model',
        pricingLicTitle: 'Boats with licence',
    ...
    palafolls: {
      faqItems: [
        ...
        },
        {
          ...
          answer: 'You don\'t need experience. We offer licence-free boats that anyone over 18 can operate. We give you 15 minutes of training before setting off, including navigation rules and safety tips.',
        },
      ],
      seo: {
        title: 'Boat Rental Palafolls | Blanes Port 12 min | No Licence 70€/h',
        description: 'At a campsite or accommodation in Palafolls? Blanes Port is 12 min by car. Rent a boat without a licence from 70€/h with fuel included. Ideal Costa Brava excursion.',
        ogTitle: 'Boat Rental Palafolls | 12 min to Blanes Port',
        ogDescription: 'From Palafolls to Blanes Port in 12 min. Boat without licence from 70€/h. Fuel included. 4.8★.',
      },
      schema: {
        name: 'Boat Rental near Palafolls',
        description: 'Rent boats from Blanes Port, just 12 minutes by car from Palafolls. Boats without licence from 70 EUR/hour with fuel included.',
      },
      breadcrumbName: 'Boat Rental Palafolls',
      sections: {
        heroTitle: 'Boat Rental near Palafolls',
        heroSubtitle: 'Palafolls is an inland Maresme town known for its extensive camping and natural resort area. Just 12 minutes by car from Blanes Port, it\'s the perfect starting point for a boat trip along the Costa Brava. Our boats without licence are ideal for camping families looking for something different.',
        ...
        whyCard3Title: 'Fuel included on boats without licence',
        whyCard3Desc: 'The price of boats without licence includes fuel. From 70 EUR per hour with the Astec 400, or from 75 EUR per hour with other longer models. No hidden costs or fuel surcharges.',
        whyCard4Title: 'No previous experience necessary',
        whyCard4Desc: 'Before setting sail, our team gives you 15 minutes of practical training. We teach you how to handle the engine, basic navigation rules and the best spots to explore. Anyone over 18 can pilot our boats without a licence.',
        ...
        destBlanes: 'Blanes Coves',
        pricingTitle: 'Boat rental prices',
        pricingIntro: 'Transparent prices with fuel included on all boats without licence. No hidden costs.',
        pricingNoLicTitle: 'Boats without licence',
        pricingNoLicFrom: 'From {noLicBaja1h} EUR/hour (fuel included)',
        pricingNoLicCapacity: 'Capacity: 4-7 people depending on model',
        pricingLicTitle: 'Boats with licence',
    ...
    pineda: {
      faqItems: [
        ...
        {
          question: 'Do I need a boating licence to rent a boat?',
          answer: 'Not necessarily. We offer licence-free boats that anyone over 18 can operate. We give you 15 minutes of training before setting off. We also have licensed boats for more experienced boaters.',
        },
        {
      ...
      seo: {
        title: 'Boat Rental Pineda de Mar | Blanes Port 18 min | No Licence 70€/h',
        description: 'Staying in Pineda de Mar? Blanes Port is 18 min by car or 12 min by R1 train. Rent a boat without a licence from 70€/h with fuel included. Sail to Blanes, Lloret or Tossa.',
        ogTitle: 'Boat Rental Pineda de Mar | 18 min to Blanes Port',
        ogDescription: 'From Pineda de Mar to Blanes Port in 18 min. Boat without licence from 70€/h. 4.8★ Google.',
      },
      schema: {
        name: 'Boat Rental near Pineda de Mar',
        description: 'Rent boats from Blanes Port, just 18 minutes by car from Pineda de Mar. Boats without licence from 70 EUR/hour with fuel included.',
      },
      breadcrumbName: 'Boat Rental Pineda de Mar',
      sections: {
        heroTitle: 'Boat Rental near Pineda de Mar',
        heroSubtitle: 'Pineda de Mar is one of the most important tourist destinations on the Maresme coast, with dozens of hotels and all-inclusive resorts. Blanes Port, just 18 minutes by car or 12 minutes by train, is the nearest boat rental point. Enjoy the Costa Brava without needing a boating licence.',
        ...
        whyCard2Desc: 'We have a fleet of {fleetCount} boats that includes boats without licence ideal for families and beginners, as well as boats with licence for experienced sailors. Capacity from 4 to 11 people depending on the model chosen.',
        whyCard3Title: 'Fuel included on boats without licence',
        whyCard3Desc: 'The price of boats without licence includes fuel, so there are no surprises. From 70 EUR per hour with the Astec 400, or from 75 EUR per hour with other longer models. The price you see is the final price.',
        whyCard4Title: 'No previous experience necessary',
        whyCard4Desc: 'Before setting sail, our team gives you 15 minutes of practical training: engine handling, basic navigation rules and tips on the best coves. Anyone over 18 can pilot a boat without a licence.',
        ...
        townCard3Desc: 'Pineda is a family destination par excellence. Our boats without licence are safe and easy to handle, ideal for a family trip along the coast.',
        ...
        destsTitle: 'What can you see by boat from Blanes?',
        destsIntro: 'From Blanes Port you can sail north along the spectacular Costa Brava coast. Discover hidden coves, impressive cliffs and medieval towns like Tossa de Mar. With a boat without licence you can explore up to 2 miles from the coast, enough to reach the most beautiful coves in the area.',
        destLloret: 'Lloret de Mar - 25 min',
        destTossa: 'Tossa de Mar - 1h',
        destBlanes: 'Blanes Coves',
        pricingTitle: 'Boat rental prices',
        pricingIntro: 'We offer competitive prices with fuel included on all boats without licence. No hidden costs or fuel surcharges.',
        pricingNoLicTitle: 'Boats without licence',
        pricingNoLicFrom: 'From {noLicBaja1h} EUR/hour (fuel included)',
        pricingNoLicCapacity: 'Capacity: 4-7 people depending on model',
        pricingLicTitle: 'Boats with licence',
  ...
  glossaryPage: {
    ...
    intro: '{count} essential terms for renting a boat on the Costa Brava. Licences, units of measurement, boat parts and marine vocabulary.',
    filterAll: 'All',
    ctaTitle: 'Ready to rent your boat?',
    ctaDesc: 'Now that you know the terminology, choose your licence-free or licensed boat to explore the Costa Brava.',
    ctaFleet: 'View the fleet',
    ctaFaq: 'Frequently asked questions',
    schemaName: 'Nautical glossary — Costa Brava boat rental',
    schemaDescription: 'Definitions of essential nautical terms for renting a boat on the Costa Brava: licences, units of measurement, boat parts and marine terminology.',
    categories: {
      titulacion: 'Licences',
    ...
    terms: [
      {
        ...
        definition: 'Spanish boating licence that allows you to operate vessels up to 8 metres in length and up to 5 miles from the coast. Mandatory for renting boats with more than 15 HP. Valid for life after passing the theoretical exam + practical course.',
        category: 'titulacion',
      },
      {
        term: 'PER (Patrón de Embarcaciones de Recreo)',
        definition: 'Spanish boating licence higher than the LNB. Allows you to operate vessels up to 15 metres in length and up to 12 miles from the coast. Requires theoretical exam + navigation practice + radio communications.',
        category: 'titulacion',
      },
      {
        term: 'PNB (Patrón de Navegación Básica)',
        definition: 'Former Spanish boating licence replaced in 2014 by the LNB. Allows you to operate vessels up to 8 metres and up to 5 miles. Those who hold it remain valid without needing to upgrade to LNB.',
        category: 'titulacion',
      },
      {
        term: 'Nautical mile',
        definition: 'International maritime distance unit equivalent to 1,852 metres (1.852 km). Licence-free boats in Spain can navigate up to a maximum of 2 nautical miles from the coast (3.7 km).',
        category: 'unidad',
      },
      {
        term: 'Knot',
        definition: 'Maritime speed unit equivalent to 1 nautical mile per hour (1.852 km/h). Licence-free boats are limited to 5 knots (9.3 km/h). Licensed boats can reach much higher speeds.',
        category: 'unidad',
      },
      {
        term: 'Length (Eslora)',
        definition: 'Total length of the boat, measured from bow to stern. Unit: metres. In Spain, the length determines the minimum boating licence: up to 5m may not require a licence, up to 8m requires LNB, up to 15m requires PER.',
        category: 'unidad',
      },
      {
        term: 'Beam (Manga)',
      ...
      {
        term: 'HP (horsepower)',
        definition: 'Marine engine power unit. Licence-free boats in Spain are limited to 15 HP. Licensed boats typically have 40-150 HP, allowing faster navigation and greater range.',
        category: 'unidad',
      },
      {
        term: 'Anchor (Fondear)',
      ...
      },
      {
        ...
        definition: 'Foldable awning that covers the cockpit of the boat providing shade. Essential for sailing with children or in summer. Most of our licence-free boats include it as standard.',
  ...
  faqPage: {
    ...
    categories: {
      ...
      licencias: 'Licences & Requirements',
    ...
    items: {
      precios: {
        question: 'What are the rental prices?',
        answer: 'Our prices vary depending on the boat and duration. Boats without licence from {noLicBaja1h}€ with fuel included (1h, 2h, 3h, 4h, 6h, 8h). Boats with licence from {licBaja2h}€ without fuel included (2h, 4h, 8h).',
      },
      reserva: {
      ...
      sinLicencia: {
        question: 'Can I rent without a boat licence?',
        answer: 'Yes! We have perfect boats without licence. They\'re up to 15 HP, maximum 4-5 people, easy to handle with a complete briefing. You only need to be over 18 years old.',
      },
      licenciasAceptadas: {
        question: 'What licences do you accept for larger boats?',
        answer: 'For boats with licence we accept: PER (Patrón de Embarcaciones de Recreo), PNB (Patrón de Navegación Básica), Yacht Captain, equivalent European licences and approved international licences. You must present the original licence on the day of rental.',
      },
      edadMinima: {
      ...
      queIncluye: {
        ...
        answer: 'Included: equipped boat, fuel (on boats without licence), life jackets, safety kit, anchor and rope, bathing ladder, instructions and map, basic insurance and telephone support.',
      },
      combustible: {
        question: 'Do I have to pay for fuel?',
        answer: 'Fuel is included on boats without licence. On boats with licence, they\'re delivered with a full tank and at the end of the rental our team accompanies you to the fuel station to refill the tank.',
      },
      extras: {
      ...
      queLlevar: {
        ...
        answer: 'Essential: ID or passport, boat licence (if applicable), sunscreen, cap/hat and towels. Recommended: food and drinks, sunglasses, non-slip footwear, change of clothes and camera/phone in waterproof bag.',
      },
      porDondeNavegar: {
        question: 'Where can I navigate?',
        answer: 'Authorized area: North to Fenals Beach (without licence) or Sant Feliu de Guíxols (with licence). South to the end of Blanes beach (without licence) or no limit (with licence). Maximum 2 miles from the coast. Recommended coves: Cala Brava, Cala Sant Francesc, Lloret Beach.',
      },
      seguridad: {
      ...
      pesca: {
        ...
        answer: 'Yes, you can fish from our boats. You\'ll need your own recreational fishing licence. We don\'t provide fishing equipment, but you can bring your own.',
      },
      diferenciaLicencia: {
        question: 'What\'s the difference between boats without licence and with licence?',
        answer: 'Boats without licence have up to 15 HP, capacity for 4-5 people, fuel included and cost from {noLicBaja1h}€. Boats with licence have 40-150 HP engines, capacity for up to 8 people, greater range and cost from {licBaja2h}€ (fuel not included). Boats with licence allow you to navigate further, to Tossa de Mar and beyond.',
      },
      precioBlanesVsLloret: {
        question: 'Is it cheaper to rent a boat in Blanes or Lloret de Mar?',
        answer: 'Blanes is the most affordable boat rental point on the Costa Brava, with boats without licence from {noLicBaja1h}€ per hour with fuel included. Operating from the Port of Blanes with our own fleet, we offer more competitive prices than other locations like Lloret de Mar or Tossa de Mar.',
      },
      barcoGrupoGrande: {
        question: 'Which boat do you recommend for a large group?',
        answer: 'For large groups we recommend the Pacific Craft 625 (up to 8 people, with licence) or our Private Excursion with captain (up to 10 people). The excursion with captain is ideal if no one in the group has a boat licence, as it includes a professional captain who takes you to the best coves.',
      },
      precioCostaBrava: {
        question: 'How much does it cost to rent a boat on the Costa Brava?',
        answer: 'On the Costa Brava you can rent a boat from {noLicBaja1h}€ per hour in Blanes, with fuel included and no licence required. Prices vary depending on duration (from 1h to full day), type of boat and season. July and August are high season with higher prices; June and September offer the best value for money.',
      },
      tossaBarco: {
        question: 'Can you go to Tossa de Mar by boat from Blanes?',
        answer: 'Yes, Tossa de Mar is about 30 minutes by boat from Blanes. However, you need a boat with licence or hire our excursion with captain, as boats without licence have a limited navigation radius. The coastal route from Blanes to Tossa is spectacular, with virgin coves and cliffs.',
      },
      excursionPatron: {
        question: 'How much does an excursion with a captain cost?',
        answer: 'Our private excursions with professional captain start from {excursionBaja2h}€ for 2 hours for up to 10 people. The captain takes you to the best coves, handles all the navigation and you don\'t need a licence. It\'s the perfect option for families or groups who want to enjoy without worrying about anything.',
      },
      seguroSinExperiencia: {
        question: 'Is it safe to rent a boat without experience?',
        answer: 'Totally safe. Before going out to navigate, our team gives you a 15-minute briefing where they explain how the boat works, navigation rules and the authorized area. Boats without licence are very stable and easy to handle, and the Blanes area has calm and protected waters.',
      },
      barcoVsExcursion: {
        question: 'What\'s better, renting a boat or an excursion with captain?',
        answer: 'It depends on what you\'re looking for. Renting a boat without licence (from {noLicBaja1h}€/h) gives you total freedom to go at your own pace and explore on your own. The excursion with captain (from {excursionBaja2h}€/2h) is ideal if you want to relax completely, have no experience or want to reach more distant coves like Tossa de Mar.',
      },
      mejorEpoca: {
        question: 'What\'s the best time to rent a boat in Blanes?',
  ...
  blogDetail: {
    ...
    relatedBlanesDesc: 'Home port. Licence-free boats from €70/h.',
