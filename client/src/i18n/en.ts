...
export const en: Translations = {
  ...
  fleet: {
    ...
    whatsappHelpPrefill:
      "Hi! I need help choosing the best boat to rent in Blanes. Could you advise me on prices and availability?",
  },
  boats: {
    ...
    imageAltWithLicense:
      "Rent {name} boat with license in Blanes, Costa Brava, {capacity} people, from {price}€",
  },
  features: {
    ...
    extras: {
      ...
      cooler: {
        ...
        description: "Cooler with ice and refreshing drinks for your day at sea",
      },
      privateTour: {
        name: "Private Tour",
        description: "Private tour with skipper included for an exclusive experience",
        price: "From €265",
      },
      parking: {
        name: "Parking",
        description: "Parking space near the harbour for your convenience",
        price: "€10/day",
      },
    },
  ...
  contact: {
    ...
    navBlanesDesc:
      "Operational home port with all amenities. Perfect starting point to explore the entire Costa Brava.",
    ...
    navLloretDesc:
      "Vibrant beaches and hidden coves. From Blanes you arrive in 25 minutes sailing along the coast.",
    ...
    navTossaDesc:
      "Medieval town with castle and crystal-clear waters. A Mediterranean paradise you cannot miss.",
    ...
    navLicensedTag1: "80-115 HP",
    navLicensedTag2: "Higher speed",
    navLicensedTag3: "Up to Tossa de Mar",
  ...
  footer: {
    ...
    newsletterEmailError: "Enter a valid email",
  ...
  booking: {
    ...
    sendBookingRequest: "Request via WhatsApp",
    needHelp: "Need help?",
    people: "people",
    ...
    extrasDetails: {
      parking: {
        name: "Parking inside the port",
        description: "Parking inside the port and in front of the boat",
      },
    ...
    quoteDescription:
      "Get the final price with seasonal rates and create a 30-minute temporary hold.",
    ...
    coverages: {
      ...
      weatherDesc: "If bad weather stops you sailing, you get back in cash whatever you paid upfront.",
      depositName: "Reduced deposit",
      depositDesc: "You leave a {amount}€ deposit{standard} on the day.",
      ...
      triggerWind: "Sustained wind or gusts above it, or the company's decision on safety.",
    ...
    errors: {
      codeValidation: {
        ...
        description: "We couldn't verify the discount code. Please try again.",
      },
      inquirySave: {
        title: "Could not save your request",
        description: "Your WhatsApp message went through, but we couldn't log it internally.",
      },
    },
    requestSent: {
      title: "Request sent via WhatsApp",
      description: "Check WhatsApp to confirm your booking with us.",
    },
    gdprConsent:
  ...
  boatClubPromo: {
    eyebrow: "A new way to get on the water",
    title: "Costa Brava Boat Club",
    subtitle: "Your boat all year without buying one. Monthly membership, limited spots per boat and online booking whenever you feel like sailing.",
    perk1: "Sail all year round",
    perk2: "Limited spots per boat",
    perk3: "Book online from your dashboard",
    priceFrom: "From",
    priceAmount: "€200",
    pricePer: "per month",
  ...
  codeValidation: {
    ...
    applied: "Applied",
    apply: "Apply",
    notFound: "This code doesn't exist, check the spelling",
    expired: "This code has expired",
    consumed: "This code has already been used",
    cancelled: "This code was cancelled",
    inactive: "This code is not active yet",
    serverError: "We couldn't check the code right now: please try again",
    validReferral: "Valid friend code",
    referralPerk: "You get the Premium Pack free (30€). We'll confirm it on WhatsApp.",
  },
  giftCards: {
    title: "Gift Cards",
  ...
  boatDetail: {
    ...
    whatsappPrefill: "Hi, I'm interested in the {boatName}. Could you give me more information?",
    ...
    noPricesForDate: "No rate available for this date",
    occupiedHoursForDay: "Already booked from {ranges}",
    checkAvailability: "Pick a date and you'll see the prices",
    selectDateTitle: "Your day, your price",
    selectDateBody: "Pick the day and we'll show you what's open and the real price.",
    ...
    fuelNotIncludedNote: "Fuel not included (based on consumption)",
    ...
    extrasNote:
      "You can add any of these extras when completing your online booking or directly at the port before departure.",
  ...
  wizard: {
    ...
    withoutLicense: "I don't have one",
    withLicense: "Yes, I do",
    ...
    yourData: "Your info",
    confirmViaWhatsApp: "We confirm via WhatsApp within 2 hours",
    firstName: "First name",
    lastName: "Last name",
    fullName: "Full name",
    phone: "Phone",
  ...
  bookingWizard: {
    ...
    boatStatus: {
      partial: "Few hours left",
      booked: "Fully booked that day",
      changeDate: "Change date",
      seeOtherBoat: "See another boat",
    },
    multiBoat: {
      title: "Your boats",
    ...
    exitIntent: {
      title: "Your booking is still here",
      description: "Want us to confirm it on WhatsApp?",
      cta: "Chat on WhatsApp",
      whatsappMessage: "Hi, I was about to book a boat in Blanes. Could you help me confirm availability?",
    },
    slotConflict: {
    ...
    licenseVerifier: {
      title: "Check your nautical licence",
      subtitle: "30 seconds to confirm whether your licence works for renting a boat in Spain.",
      panelEyebrow: "Check your licence · 30 s",
      panelHelper: "Confirm whether your licence works for renting in Spain.",
      discoverCta: "Is your licence valid here? Check it in 1 minute",
      countryLabel: "Country that issued your licence",
      countryPlaceholder: "Select a country",
      countrySearchPlaceholder: "Search country...",
      countryNotFound: "No countries found.",
      licenseTypeLabel: "Licence type",
      licenseTypeOptions: {
        ...
        national: "National nautical licence",
        icc_only: "I only have the ICC (International Certificate of Competence)",
        other: "Other",
      },
      hasIccLabel: "Do you have an ICC (International Certificate of Competence)?",
      hasIccYes: "Yes",
      hasIccNo: "No",
      verify: "Check",
      ...
      change: "Change",
      result: {
        valid: "Your licence is valid in Spain",
        probablyValid: "Likely valid",
      ...
      meetsFleet: "Valid for our licensed fleet.",
  ...
  destinations: {
    ...
    fromBlanesSub:
      "Explore the most spectacular locations on the Costa Brava from our home port in Blanes",
    ...
    tossaDesc:
      "Medieval village protected by walls. The most beautiful historical gem of the Costa Brava.",
  ...
  categoryLicenseFree: {
    ...
    freeNavigationDesc:
      "Licence-free boats are vessels of up to 15 HP (11 kW) that can be operated without an official boating licence. They are perfect for anyone who wants to enjoy the sea without any fuss.",
    easyToHandle: "Easy to Handle",
    easyToHandleDesc:
      "These boats are designed to be intuitive and safe. With simple controls and guaranteed stability, anyone can learn to handle them in just a few minutes.",
    safeLimits: "Safe Limits",
    safeLimitsDesc:
      "By law, they may only sail up to 2 nautical miles from the coast and in sheltered waters. This ensures you are always in a safe zone with the option to return to port easily.",
    completeEquipment: "Complete Equipment",
    completeEquipmentDesc:
      "All our boats include mandatory safety equipment, life jackets, fire extinguisher, plus extras such as a cool box, sun canopy, snorkelling gear and radio.",
    ...
    ctaDescription:
      "Hire a licence-free boat and discover the freedom of sailing the Costa Brava without any hassle. Ideal for beginners and families!",
    ctaButton: "Book a Licence-Free Boat",
    regulationTitle: "Licence-Free Boating Regulations in Spain",
    regulationIntro:
      "In Spain, Royal Decree 875/2014 governs nautical qualifications and establishes that vessels with engines up to 11.26 kW (15 HP) may be operated without any boating licence or qualification. This regulation means any person aged 18 or over can legally hire and drive a licence-free boat.",
    regulationRequirements:
      "The requirements are straightforward: be at least 18 years old, receive a safety briefing before departure (always included with us), carry life jackets for all passengers and respect the established navigation limits. No prior experience or specific training is needed.",
    regulationAllowed:
      "With a licence-free boat you can cruise freely along the Blanes coastline, anchor in coves and beaches, go snorkelling, sunbathe on the water and explore the Costa Brava cliffs. All within a radius of 2 nautical miles from shore and in favourable weather conditions.",
    regulationNotAllowed:
      "Licence-free boats may not navigate at night, venture beyond 2 nautical miles from shore, or carry more passengers than indicated on the boat's technical specifications. These limits exist to ensure the safety of all boaters.",
    ...
    testimonial1Text:
      "We hired the Remus 450 for a day with the kids. They showed us how to handle it in 10 minutes and we anchored in a beautiful cove for snorkelling. The children kept jumping into the water non-stop. We will definitely come back.",
    testimonial1Context: "Family with 2 children, 4-hour hire in July",
    testimonial2Name: "Laura and Marc, Barcelona",
    testimonial2Text:
      "We went out at sunset on the Solar 450 and it was an unforgettable experience. Watching the Costa Brava bathed in golden tones from the sea, no engine noise, anchored in front of the cliffs... Romantic and very easy to handle.",
    testimonial2Context: "Couple, 2-hour sunset hire in September",
    testimonial3Name: "Javier's Group, Zaragoza",
    testimonial3Text:
      "There were 4 of us and we took the Astec 480 with bluetooth. We explored several coves from Blanes southwards, played music and stopped to swim in crystal-clear water. Best plan of the summer, no doubt.",
    testimonial3Context: "Group of 4 friends, 6-hour hire in August",
    testimonial4Name: "Sarah, London",
    testimonial4Text:
      "I was nervous because I had never driven a boat before, but the Costa Brava Rent a Boat team explained everything patiently. Within 15 minutes I was sailing on my own. The feeling of freedom on the Mediterranean is incomparable.",
    testimonial4Context: "Tourist, first time on a boat, 3-hour hire in June",
    faqSpeedQuestion: "How fast do licence-free boats go?",
    faqSpeedAnswer:
      "Licence-free boats with a 15 HP engine reach a top speed of approximately 12-15 knots (about 22-28 km/h). This is a comfortable and safe speed for coastal cruising, anchoring in coves and enjoying the scenery at a relaxed pace.",
    faqChildrenQuestion: "Can I take children on a licence-free boat?",
    faqChildrenAnswer:
      "Yes, children of any age are welcome on board. The driver must be at least 18, but passengers can be of any age. All our boats include life jackets of every size, including children's sizes. Many families choose our licence-free boats precisely because of their stability and safety.",
    ...
    howToCostLabel: "From",
    howToCostValue: "€85/h with fuel included",
    ...
    vsMarketplacesConclusion:
      "The final price with a marketplace is typically 20-35% higher than advertised once you add fuel, commission and extras. Our €85/h already includes everything: fuel, equipment, briefing, civil liability insurance and on-site support.",
  },
  categoryLicensed: {
    heroTitle: "Self-drive powerboat hire in Blanes: reach Tossa de Mar at the helm",
    heroDescription:
      "Three licensed powerboats, 80 to 115 HP, at the Port of Blanes. You take the helm with your Licencia de Navegación or an equivalent foreign qualification, which we check online before your trip. From 175 EUR for 2 hours.",
    badgeLicense: "The Licencia de Navegación is enough",
    badgePower: "80-115 HP",
    ...
    professionalEquipment: "Full equipment",
    professionalEquipmentDesc:
      "Approved safety gear, sun canopy, shower and bathing ladder. Every powerboat is checked between trips, and before you cast off we go through the handling with you in the technical briefing.",
    superiorPerformance: "Built for the whole day",
    superiorPerformanceDesc:
      "With 6 and 7 seats and range for a full day, they are the choice for groups and families who want a proper route: by the hour, half day or full day.",
    synonymsTitle: "Powerboat, motorboat or licensed boat? Same thing",
    synonymsBody:
      "On the Costa Brava you will hear all three names: powerboat, motorboat or licensed boat. They are motor vessels over 15 HP that require a boating qualification. And hiring without a skipper means exactly that: no hired skipper on board, because the skipper is you.",
    routeTitle: "From Blanes to Tossa at the helm: the route",
    routeIntro:
      "You leave the Port of Blanes and a quarter of an hour later you are off Lloret de Mar. From there the coast opens up into cove after cove all the way to the bay of Tossa de Mar, with its castle above the sea: 30-45 minutes with any of our powerboats.",
    routeStopLloret: "Lloret de Mar and Fenals beach: 15 minutes from the port",
    routeStopSantaCristina: "Cala Santa Cristina and Cala Treumal: quiet anchoring between Blanes and Lloret",
    routeStopCanyelles: "Cala Canyelles: the last stop before the cliffs on the way to Tossa",
    routeStopTossa: "Tossa de Mar: a bay with a medieval castle, 30-45 minutes at the helm",
    requirementsTitle: "Requirements and Qualifications",
    acceptedLicenses: "Accepted Qualifications",
    ...
    verifierLead: "Qualification from another country? Check it here in 30 seconds:",
    additionalRequirements: "Additional Requirements",
    minAge: "Minimum age: 18",
    validId: "Valid ID document",
    validLicense: "Current boating qualification (bring the original)",
    deposit: "Deposit: €500 (refundable)",
    technicalBriefing: "Technical briefing included",
    fleetTitle: "Our Licensed Fleet",
    comparisonTitle: "Which powerboat should I pick? Quick comparison",
    comparisonIntro:
      "All three leave from the Port of Blanes and can be handled with the Licencia de Navegación. What changes is the power, the seats and the character: this table sums it up with the 2-hour price by season.",
    comparisonBoatName: "Powerboat",
    comparisonCapacity: "Seats",
    comparisonEngine: "Engine",
    comparisonBestFor: "Best for",
    comparisonPriceLow: "2h low season",
    comparisonPriceHigh: "2h in August",
    comparisonMingolla: "Your first powerboat: nimble, easy and the best value of the three",
    comparisonTrimarchi: "Italian sporty character for routes with a bit of pace",
    comparisonPacific: "Groups of 7: the biggest and steadiest of the three",
    regulationTitle: "What the regulations say",
    regulationIntro:
      "Since Spanish Royal Decree 875/2014 (RD 875/2014), handling a recreational vessel over 15 HP requires an official boating qualification. Our three powerboats are above that threshold, so to hire them self-drive you need your qualification in force: with the Licencia de Navegación you can already take out our entire fleet.",
    regulationForeign:
    ...
    howToStep1Title: "Pick your powerboat and time slot",
    howToStep1Text:
      "Compare the three powerboats in the table and decide how many hours you want: 2 hours, half day or full day. Message us on WhatsApp or book from the website.",
    howToStep2Title: "Check your qualification",
    howToStep2Text:
      "Use the online checker on this page: pick your country and your qualification and you will know straight away whether it works. The Spanish Licencia de Navegación already covers the whole fleet.",
    howToStep3Title: "Come to the Port of Blanes",
    howToStep3Text:
      "On the day of departure bring the original qualification, your ID document and the 500 EUR deposit. The hire is paid at the port, with no online payment gateways.",
    howToStep4Title: "Briefing and off to Tossa",
    howToStep4Text:
      "We go through the boat and the navigation area with you in a few minutes and off you go at the helm: Lloret is 15 minutes away and Tossa de Mar 30-45.",
    howToStep5Title: "Bring it back and get your deposit",
    howToStep5Text:
      "Come back at the agreed time, we settle the fuel according to actual consumption and hand your deposit back on the spot if everything is in order.",
    vsMarketplacesTitle: "Booking direct or through a platform",
    vsMarketplacesIntro:
      "Our powerboats also appear on hire portals. The boat and the port are the same; what changes is who you deal with before and during your trip.",
    vsMarketplacesCol1: "Direct with us",
    vsMarketplacesCol2: "Through a platform",
    vsMarketplacesRow1Label: "Who you talk to",
    vsMarketplacesRow1Direct: "The owners on WhatsApp, from the first message to handover",
    vsMarketplacesRow1Market: "The portal's messaging system and its response times",
    vsMarketplacesRow2Label: "Your foreign qualification",
    vsMarketplacesRow2Direct: "We check it online before you book",
    vsMarketplacesRow2Market: "Checked at the port on the day of departure",
    vsMarketplacesRow3Label: "Weather guarantee",
    vsMarketplacesRow3Direct: "Optional when you book: new date or your money back",
    vsMarketplacesRow3Market: "Depends on each portal's terms",
    vsMarketplacesRow4Label: "Date changes",
    vsMarketplacesRow4Direct: "Free up to 7 days before, talking directly to us",
    vsMarketplacesRow4Market: "Handled through the intermediary",
    vsMarketplacesConclusion:
      "Same boat, same port: booking direct you talk to the people who hand the powerboat over, you arrive with your qualification already checked and you can add the Weather guarantee.",
    faqSinPatronQuestion: "Can I hire a boat without a skipper on the Costa Brava?",
    faqSinPatronAnswer:
    ...
    faqTitulacionQuestion: "What is the minimum qualification I need? Is the Licencia de Navegación enough?",
    faqTitulacionAnswer:
      "Yes, the Licencia de Navegación (the basic Spanish boating licence) is enough for our entire licensed fleet. The PNB, the PER and any higher qualification also work, as do the EU equivalents.",
    faqForeignLicenseQuestion: "Is my foreign licence valid (Permis Cotier, SBF See, ICC)?",
    faqForeignLicenseAnswer:
      "Yes, we accept equivalent foreign qualifications: the French Permis Cotier, the German SBF See, the international ICC and the equivalents from EEA countries. Check yours in the online checker on this page and bring the original on the day of departure.",
    faqPriceQuestion: "How much does it cost to hire a powerboat by the hour in Blanes?",
    faqPriceAnswer:
      "From 175 EUR for 2 hours in low season, and from 210 EUR in August depending on the powerboat. Half day and full day have their own rates by season: the comparison table on this page and the pricing page show the detail. Fuel is paid separately.",
    faqFuelQuestion: "Is fuel included on the licensed boats?",
    faqFuelAnswer:
      "No. On licensed powerboats fuel is paid separately according to the actual consumption of the trip. Insurance and safety equipment are always included.",
    faqDepositQuestion: "How does the 500 euro deposit work?",
    faqDepositAnswer:
      "It is left on the day of departure and returned in full when you bring the powerboat back in the same condition it went out in. There is also an optional Reduced deposit if you would rather block a smaller amount.",
    faqWeatherQuestion: "What happens if the weather is bad on the day of the hire?",
    faqWeatherAnswer:
      "You can change the date free of charge up to 7 days before departure. If bad weather stops the trip, we move your date at no cost or issue you a voucher for the amount paid, valid for 12 months. With the Weather guarantee contracted you choose between a new date or a full cash refund.",
    faqCrossLinkLabel: "See the licensed powerboats",
    crossLinkFromFree: "Got a qualification? Powerboats from 80 to 115 HP, all the way to Tossa",
    linksTitle: "Keep exploring",
    linksBlanes: "Port of Blanes: the starting point",
    ...
    ctaDescription:
      "Tell us the day, the hours and how many of you there are and we will confirm availability right away. No online payment: you book on WhatsApp and pay at the port.",
    ctaButton: "Book my powerboat",
  },
  blogPage: {
    title: "Sailing Blog",
    subtitle:
      "Guides, tips and destinations to make the most of your boating experience on the Costa Brava",
    breadcrumbHome: "Home",
    breadcrumbBlog: "Blog",
    article: "article",
    articles: "articles",
  ...
  faqPreview: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Of course! You can bring your own food, drinks and snacks. We have a cooler on board. We only ask that you avoid glass for safety reasons.",
      },
      {
        id: "fianza",
        question: "What is the deposit and when is it returned?",
        answer:
          "The deposit is a security bond (200-500€ depending on the boat) paid at the port before departure and fully returned when you come back if the boat is in good condition.",
      },
      {
        id: "equipamiento-seguridad",
        question: "What safety equipment is included?",
        answer:
          "All our boats include life jackets for all passengers, first aid kit, fire extinguisher, anchor, and signalling kit as required by regulations.",
      },
      {
        id: "descuentos",
      ...
      },
      {
        ...
        answer:
          "You can explore the entire coast between Blanes and Tossa de Mar. We recommend the coves of Sa Forcanera, Cala Bona and Cala Sant Francesc, accessible only by sea.",
      },
      ...
      },
      {
        ...
        answer:
          "Our private excursions with a professional captain start from 265€ for 2 hours for up to 6 people. The captain takes you to the best coves, handles all the navigation and you do not need a licence. It is the perfect option for families or groups who want to enjoy without any worries.",
      },
      ...
      },
      {
        ...
        answer:
          "September is the star month: the sea water is at its warmest (24-25 degrees C), prices are mid-season, there are fewer tourists and weather conditions are excellent. June and early July are also great options. July and August have the best weather but prices and crowds are higher.",
      },
    ],
  },
  ...
  holdCountdown: {
    ...
    hurry: "Hurry up",
    expiredSoft:
      "Your selection may have changed. You can continue, but we recommend verifying availability.",
    verifyButton: "Verify",
  },
  ...
  confirmation: {
    ...
    whatsNextSteps: [
      "You will receive confirmation via WhatsApp within 2 hours",
  ...
  reciprocity: {
    ...
    captainTipText:
      "If it is your first time, choose a licence-free boat for 4h in the morning. The sea is calmer and you will have plenty of time to explore 2-3 coves.",
    ...
    freeGuideSubtitle:
      "Get our guide with the 10 best coves on the Costa Brava accessible only by boat",
  ...
  pricingPage: {
    ...
    info: {
      ...
      minPerHour:
        "Prices shown are the <strong>minimum per hour</strong>. Depending on the duration selected, the hourly rate may vary.",
      deposit:
  ...
  locationBarcelona: {
    hero: {
      ...
      description:
        "Just 70 minutes from Barcelona, Blanes Port offers you the best boating experience on the Costa Brava. Boats without license from {noLicBaja1h} € with fuel included.",
    ...
    whyBlanes: {
      ...
      betterPricesBody:
        "In Blanes, boats without license start from {noLicBaja1h} €/hour with fuel included. In Barcelona, prices start from 120-150 €/hour without fuel. You save up to 50% on your rental.",
      crystalWatersTitle: "Crystal-clear waters",
      crystalWatersBody:
        "The Costa Brava offers transparent turquoise waters you won't find along Barcelona's coast. Hidden coves, rocky seabeds for snorkeling and spectacular natural landscapes.",
      lessTrafficTitle: "Less maritime traffic",
      lessTrafficBody:
        "Barcelona port has heavy traffic from ferries, cruise ships and commercial vessels. In Blanes you sail peacefully through clean, uncrowded waters.",
      realCostaBravaTitle: "The authentic Costa Brava",
      realCostaBravaBody:
        "From Blanes you can explore secret coves like Cala Sant Francesc, reach Lloret de Mar or even Tossa de Mar. It's the gateway to the real Costa Brava, with cliffs, pine trees and emerald waters.",
    },
    howToGet: {
      ...
      carBody:
        "Take the AP-7 motorway towards Girona/France. Exit 9 (Blanes). Free parking next to the port.",
      trainTitle: "By train",
      trainDuration: "<strong>90 minutes</strong> RENFE Rodalies",
      trainBody:
        "R1 line from Barcelona Sants or Passeig de Gràcia to Blanes. Trains every 30 minutes. Station 10 min from the port.",
      busTitle: "By bus",
      busDuration: "<strong>80 minutes</strong> from Estació del Nord",
      busBody:
        "Direct buses from Barcelona's Estació del Nord. Multiple daily departures during summer season.",
    },
    boats: {
      title: "Our boats",
      noLicenseTitle: "Boats without license",
      noLicenseBody:
        "5 boats for 4-5 people. No previous experience or license required. We give you a 15-minute briefing and you're ready to sail. Fuel included in the price.",
    ...
    cta: {
      ...
      subtitle:
        "Just 70 minutes from Barcelona. Boats without license from {noLicBaja1h} € with fuel included. Crystal-clear waters and secret coves await you.",
    ...
    blog: {
      title: "Blog articles",
      description:
        'Discover more about sailing the Costa Brava on our <a href="{blogPath}" class="text-primary hover:underline font-medium">boating blog</a>.',
    },
  },
  whatsappMessages: {
    bookingWithBoatAndPrice:
      "Hello! I'm interested in booking the {boatName} (from {price}€). Could you help me with availability and prices? Thanks!",
    bookingWithBoat:
      "Hello! I'm interested in booking the {boatName}. Could you help me with availability and prices? Thanks!",
    bookingGeneric:
      "Hello! I'd like to make a reservation to rent a boat. Could you help me with availability and prices?",
  },
  seoSchemas: {
    seasonalEvent: {
    ...
    coves: {
      ...
      descriptions: {
        ...
        saForcanera:
          "Unspoiled rocky cove with gravel seabed. Rich marine biodiversity, ideal for snorkelling.",
        calaSantFrancescBlanes:
          "Cove with pine trees down to the sand and turquoise waters. Sheltered from north winds. Ideal for first-time snorkelling.",
        calaDeSAgulla: "Small semi-unspoiled cove, difficult land access. Transparent water.",
        calaTreumal:
          "Rocky cove with pine trees, crystal-clear waters. Peaceful anchorage. Accessible on foot via coastal path.",
        playaDeSantaCristina:
          "Quiet family-friendly beach with pine grove. Beach services in season. Sandy bottom.",
        calaSaBoadella:
    ...
    faqItems: [
      {
        ...
        answer:
          "We recommend leaving 2 hours before sunset. That gives you time to cruise along the coast, find a lovely cove and get settled before golden hour. In summer (June-July), head out around 7:00-7:30 PM. In spring and autumn, around 5:30-6:30 PM. Our team at the port will let you know the exact sunset time on the day of your trip.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Yes. All our boats are equipped with navigation lights for use after dark. Blanes port is well lit and easy to enter at dusk. We recommend returning no later than 30 minutes after sunset, when there's still plenty of light. Our team will brief you on the return route.",
      },
      {
    ...
    viewpoints: [
      {
        ...
        description:
          "Anchor off Cala Sant Francesc and watch the sun disappear behind the hills of Blanes. The cliffs catch the golden light spectacularly and the water shifts from amber to pink.",
        distance: "20 minutes from the harbour",
      },
      {
        name: "Open sea off Sa Palomera",
        description:
          "Position your boat facing Blanes' iconic Sa Palomera rock. As the sun sets behind the town, the rock creates a dramatic silhouette against the orange sky.",
        distance: "10 minutes from the harbour",
      },
      {
        name: "Stretch between Blanes and Lloret",
        description:
          "The coastline between Blanes and Lloret de Mar offers unobstructed westward views. No buildings, no crowds, just you, the sea and an incredible sunset.",
    ...
    romanticIdeas: [
      {
        ...
        description:
          "Pack cheese, cured meats, olives, bread and a bottle of cava or wine. Enjoy your spread floating in a cove as the sky changes colour.",
      },
      {
        title: "Music on board",
        description:
          "Bring a small Bluetooth speaker with a curated playlist. Soft jazz, acoustic guitar or chilled electronic music pair perfectly with golden hour.",
      },
      {
        title: "Capture the moment",
        description:
          "Golden hour light (30-60 minutes before sunset) is the most flattering for photos. Use your phone's portrait mode for stunning results.",
      },
      {
  ...
  activitySnorkel: {
    faqItems: [
      {
        ...
        answer:
          "Yes. We offer snorkel kits (mask, snorkel and fins) for 7.50 € per person. Equipment is collected when boarding and returned at the end of the rental. You can also bring your own equipment at no extra cost.",
      },
      {
        question: "What's the best time for snorkeling in Blanes?",
        answer:
          "From June to September the water temperature ranges between 22 and 26 degrees, ideal for snorkeling without a wetsuit. The best visibility is in June and September, when it's less crowded and the water is calmer. In July and August the water is warmer but there may be more waves on windy days.",
      },
      {
        question: "Is it safe to snorkel from the boat without experience?",
        answer:
          "Absolutely. Before heading out we give you a 15-minute safety briefing where we explain how to anchor the boat correctly. All boats carry life jackets. We recommend snorkeling in sheltered coves like Cala Sant Francesc for beginners.",
      },
      {
        question: "How many coves can I visit on a snorkeling trip?",
        answer:
          "In 2 hours you can visit 1-2 coves with enough time for snorkeling. In 4 hours you can do a full route of 3-4 coves. We recommend a minimum of 3 hours to enjoy the snorkeling and boating without rushing.",
      },
    ],
    spots: [
      {
        ...
        depth: "2-8 metres",
        highlights:
          "Posidonia oceanica, white seabream, saddled seabream, starfish. Mixed sandy and rocky bottom with excellent visibility.",
        ideal:
          "Ideal for beginners and families thanks to its crystal-clear water and mild currents.",
      },
      {
        name: "Cala Bona",
        ...
        depth: "3-10 metres",
        highlights:
          "Rock formations, juvenile groupers, octopuses, nudibranchs. Submerged walls teeming with marine life.",
        ideal:
          "Perfect for intermediate snorkelling. Anchor the boat and explore the rocky coastline.",
      },
      {
        name: "Cala Treumal",
        ...
        depth: "2-6 metres",
        highlights:
          "Posidonia meadows, seahorses (protected species), shoals of damselfish and wrasse.",
    ...
    recommendedBoats: [
      ...
      },
      {
        ...
        price: "From 90 €/hour",
        description:
          "Greater range to visit multiple coves in one trip. Ideal for groups wanting to combine snorkelling with sailing to Lloret or Tossa.",
      },
    ],
    depthLabel: "Depth:",
    heroTitle: "Boat Snorkelling Trip from Blanes",
    heroDescription:
      "Discover the Costa Brava seabed from our boats at the Port of Blanes. Sail to the best coves, drop anchor and dive into crystal-clear waters with visibility of up to 15 metres. Snorkelling gear available for € 7.50/person.",
    ...
    rentalTitle: "Extra rental: € 7.50/person",
    rentalItems: [
    ...
    faqItems: [
      {
        ...
        answer:
          "There is no minimum age. Babies and children of any age are welcome. All minors must wear approved life jackets during navigation. For babies we recommend short trips of 1-2 hours and choosing days with calm seas.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "We recommend bringing: high protection sunscreen (waterproof), caps or hats, plenty of water, snacks or picnic, towels, swimwear and a change of dry clothes. Optional: waterproof camera, beach toys and your own snorkeling equipment.",
      },
    ],
    safetyFeatures: [
      {
        ...
        description:
          "All boats carry approved life jackets for children of all ages and sizes. Minors are required to wear them while sailing.",
      },
      {
      ...
      },
      {
        ...
        description:
          "The coast between Blanes and Lloret offers coves sheltered from the waves. We recommend calm coves where children can swim safely.",
      },
    ],
    familyRoutes: [
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "No. You must bring your own fishing equipment (rods, reels, lures, bait). Our boats provide the navigation platform, but do not include fishing gear. In Blanes there are chandleries near the port where you can buy fresh bait and basic equipment.",
      },
      {
        question: "Do I need a fishing licence to fish from the boat?",
        answer:
          "Yes. For recreational sea fishing you need the maritime recreational fishing licence from the Generalitat de Catalunya. You can obtain it online at gencat.cat for approximately 14 € (valid for 2 years). It is different from the boating licence: the fishing licence is for fishing, the boating licence is for operating the boat.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Recreational fishing in Catalonia has catch limits: maximum 5 kg per person per day (except if a single fish exceeds that weight). There are minimum sizes by species (sea bass 36 cm, sea bream 20 cm). Fishing is prohibited in marine reserves and bathing areas. Some techniques such as spearfishing require a specific licence.",
      },
    ],
    fishSpecies: [
      {
    ...
    recommendedBoats: [
      {
        ...
        price: "From 90 €/hour (fuel not included)",
        advantages: [
    ...
    fishingSpots: [
      {
        ...
        description:
          "The rocky formations off Sa Palomera are a classic for coastal spinning. Depths of 5-15 meters with plenty of marine life.",
      },
      {
        ...
        description:
          "Mixed rock and sand bottoms between 10-25 meters. Excellent for bottom fishing with natural bait.",
      },
      {
  ...
  faqPage: {
    ...
    heroDescription:
      "Find answers to all your questions about boat rentals in Blanes, Costa Brava. If you can't find what you're looking for, contact us directly!",
    schemaName: "FAQ - Boat Rentals in Blanes",
    schemaDescription:
      "Get answers to all your questions about boat rentals in Blanes, Costa Brava",
    whatsappGenericMessage: "Hello, I have a question about boat rentals. Could you help me?",
    filterLabel: "Filter by category",
    contactTitle: "More Questions?",
    contactDesc:
      "If you haven't found the answer you were looking for, we're here to help. Our team responds quickly and will be happy to answer any questions.",
    ...
    items: {
      ...
      pago: {
        ...
        answer:
          "We accept credit/debit card (Visa, Mastercard), bank transfer, cash (only at the port, before departure) and Bizum (for Spanish customers). A deposit of 50€ is required to confirm the booking.",
      },
      cancelacion: {
        question: "What is the cancellation policy?",
        answer:
      ...
      licenciasAceptadas: {
        ...
        answer:
          "For licensed boats the Licencia de Navegación (LN) is enough, the entry-level Spanish qualification: it covers our entire fleet. We also accept the PNB (Patrón de Navegación Básica), the PER (Patrón de Embarcaciones de Recreo), Yacht Captain, equivalent European licences and approved international licences such as the ICC. You must present the original licence on the day of the rental.",
      },
      edadMinima: {
        question: "What is the minimum age to rent?",
        answer:
          "The captain must be at least 18 years old. Passengers have no age limit (with a responsible adult). Children under 12 must wear a life jacket. The captain must present a valid ID or passport.",
      },
      experiencia: {
        question: "Do I need previous boating experience?",
        answer:
          "No previous experience necessary. We provide a complete explanation of how it works, a map of the authorized area, safety tips, direct contact for emergencies and easy-to-handle boats.",
      },
      queIncluye: {
      ...
      extras: {
        ...
        answer:
          "Available extras: Paddle Board (+30€), Snorkel mask (+5€), GoPro waterproof camera (+30€) and Professional captain (+100€).",
      },
      queLlevar: {
        question: "What should I bring?",
        answer:
          "Essential: ID or passport, boat license (if applicable), sunscreen, cap/hat and towels. Recommended: food and drinks, sunglasses, non-slip footwear, change of clothes and camera/phone in waterproof bag.",
      },
      porDondeNavegar: {
      ...
      seguridad: {
        ...
        answer:
          "Approved life jackets for everyone, regulation safety kit, GPS and plotter on large boats, complete maritime signaling, 24h emergency contact and daily boat inspections.",
      },
      malTiempo: {
        question: "What happens if the weather is bad?",
        answer:
      ...
      emergencia: {
        ...
        answer:
          "Emergency procedure: 1) Stay calm, 2) Call us immediately at +34 611 500 372, 3) We'll find your position thanks to the GPS installed on our boats. Emergency numbers included in the briefing.",
      },
      horarios: {
        question: "What are the available times?",
        answer:
          "Rental times: Mid-morning (09:00 - 13:00), Afternoon (14:00 - 18:00), Full day (09:00 - 17:00), Sunset (18:00 - 21:00). Times may vary depending on season and availability.",
      },
      llegadaPuerto: {
        question: "When should I arrive at the port?",
        answer:
          "We recommend arriving 30 minutes before departure time for check-in and document verification, complete safety briefing, explanation of how it works, delivery of materials and map, and to answer any last-minute questions.",
      },
      parking: {
        question: "Is parking available?",
        answer:
          "Parking options: Port Parking 10€/rental (inside the port and in front of the boat), Blue zone 1.5€/hour (10 min walk), Free parking (20/30 min walk). In high season we recommend booking a space.",
      },
      equipaje: {
        question: "Can I leave luggage at the port?",
        answer:
          "Options for luggage: on the boat (limited but secure space), port lockers (5€/day per suitcase), hotel/apartment (we recommend leaving large luggage there). Avoid bringing valuables.",
      },
      temporada: {
        question: "When is the season open?",
        answer:
          "High season: June - September. Mid season: April-May and October. Closed: November - March. The best time is May-June and September (less crowded, good weather).",
      },
      disponibilidad: {
        question: "How can I check availability?",
        answer:
          "You can check availability through our website (real-time calendar), WhatsApp (immediate response), phone (direct call) or email (detailed inquiries).",
      },
      antelacion: {
        question: "How far in advance should I book?",
        answer:
          "Recommendations: High season 1-2 weeks minimum, weekends 3-5 days, weekdays same-day booking possible, large groups as much advance notice as possible. In July-August book at least 2 weeks in advance.",
      },
      comidaBebida: {
        question: "Can I bring food and drinks on board?",
        answer:
          "Of course! You can bring your own food, drinks and snacks. We have a cooler on board. We only ask that you don't use glass for safety reasons.",
      },
      fianza: {
        question: "What is the deposit and when is it returned?",
        answer:
          "The deposit is a security deposit (200-500€ depending on the boat) that is paid at the port before departure and is fully refunded upon return if the boat is in good condition.",
      },
      equipoSeguridad: {
        question: "What safety equipment does the boat include?",
        answer:
          "All our boats include life jackets for all passengers, first aid kit, fire extinguisher, anchor, and signaling kit according to regulations.",
      },
      descuentos: {
      ...
      mascotas: {
        ...
        answer:
          "Yes, pets are welcome on our boats. We recommend bringing fresh water and a towel for your pet. The animal should wear a life jacket if available.",
      },
      pesca: {
        question: "Can I fish from the boat?",
        answer:
          "Yes, you can fish from our boats. You'll need your own recreational fishing license. We don't provide fishing equipment, but you can bring your own.",
      },
      diferenciaLicencia: {
      ...
      mejorEpoca: {
        ...
        answer:
          "September is the star month: the sea water is at its warmest temperature (24-25°C), prices are mid-season, there are fewer tourists and weather conditions are excellent. June and the first half of July are also very good options.",
      },
    },
  },
  blogDetail: {
  ...
  legalPages: {
    legalDisclaimer:
      "This text is available in several languages. In case of discrepancy or ambiguity in translation, the Spanish version shall prevail for all legal purposes.",
    privacy: {
  ...
  relatedLocations: {
    ...
    categories: {
      ...
      licensed: {
        ...
        features: ["80-115 HP", "More speed", "Greater range"],
      },
    },
  },
  ...
  testimonios: {
    hero: {
      ...
      subtitle:
        "Real reviews from families, couples and groups who have set sail with us from Blanes. No filters, no edits.",
      ratingLabel: "Based on {count} reviews",
    },
    intro: {
      title: "Real experiences out at sea",
      paragraph1:
    ...
    card: { viewBoat: "View {boat}" },
    pagination: { showMore: "Show more reviews", showing: "Showing {shown} of {total}" },
    photoBreakAlt: "Sunset sailing along the Costa Brava",
    cta: {
      title: "Ready to live your own story at sea?",
      paragraph:
        "Book without online payment: write to us, we confirm by WhatsApp, and on the day all you need to do is step on board.",
      primary: "View our fleet",
  ...
  sharedSailing: {
    ...
    form: {
      ...
      subtitle: "We'll tell you about the first trips. No commitment.",
      name: "Name",
      ...
      successText: "Thank you. You'll be among the first to know when we open the shared trips.",
      errorText: "We couldn't send your details. Try again or message us on WhatsApp.",
      requiredError: "Please complete your name and phone.",
    },
  },
  routes: {
    ...
    lloretDesc: 'Golden beaches, hidden coves and nightlife. Just 25 min by boat from Blanes.',
  ...
  occasionMatrix: {
    pages: {
        ...
        spots: [
          {
            ...
            description: 'A sheltered pine-fringed inlet just outside Blanes, with calm water and rocky sides teeming with life: the best first anchorage for family snorkelling.',
          },
          {
            name: 'Sa Forcanera',
            description: 'A small cove beneath the cliffs of the Marimurtra Botanical Garden, with deep, transparent waters ideal for swimming over rocky seabeds.',
          },
          {
            name: 'Cala Treumal',
            description: 'On the border between Blanes and Lloret, a rocky and sandy seabed that attracts fish; a good anchorage sheltered from the south-westerly wind.',
          },
          {
            name: 'Punta de Santa Anna',
            description: 'Next to the Sant Joan castle, rocky walls dropping into the sea with excellent visibility for watching Mediterranean marine life.',
          },
        ],
      ...
      snorkel__locationLloret: {
        ...
        seoDescription: 'Discover the best snorkelling coves in Lloret de Mar by boat from Blanes: Cala Boadella, Cala Banys, Cala dels Frares. Licensed boat, around 25 minutes sailing.',
        h1: 'Snorkelling by boat in Lloret de Mar',
        intro: 'Lloret de Mar hides some of the best coves on the southern Costa Brava, many accessible only by sea. Leaving from Blanes, you reach its rocky corners in around 25 minutes and explore them snorkelling without the beach crowds.',
        spotsTitle: 'Best snorkelling coves in Lloret de Mar',
        spots: [
          {
            name: 'Cala Boadella',
            description: 'One of the prettiest coves in Lloret; its southern rocky end, with clean water, reveals fish as soon as you put your head under.',
          },
          {
            name: 'Cala Banys',
            description: 'A rocky inlet with dark cliffs and deep water, a classic for rock snorkelling with good visibility.',
          },
          {
            name: 'Cala dels Frares',
            description: 'A small pebble cove surrounded by vertical walls, a Mediterranean marine life refuge ideal for slow swimming.',
          },
          {
            name: 'Santa Cristina',
            description: 'A wide sandy cove with rocky ends; the sides offer easy, safe snorkelling, perfect for beginners.',
          },
        ],
        ...
        faq: [
          {
            q: 'How long does it take to get from Blanes to Lloret\'s coves by boat?',
            a: 'Around 25 minutes of calm sailing along the coast, depending on the cove and sea conditions.',
          },
          {
            q: 'Which coves in Lloret are best for snorkelling?',
            a: 'Cala Boadella, Cala Banys and Cala dels Frares stand out for their rocky seabeds and water transparency.',
          },
        ],
        ctaTitle: 'Book your snorkelling trip in Lloret de Mar',
      ...
      snorkel__locationTossa: {
        ...
        spotsTitle: 'Best snorkelling coves in Tossa de Mar',
        spots: [
          {
            name: 'La Mar Menuda',
            description: 'Next to the old town, a bay with sheltered waters and a rocky seabed highly valued by divers and snorkelling enthusiasts for its rich marine life.',
          },
          {
            name: 'Cala Giverola',
            description: 'A deep cove nestled between mountains, with exceptionally clear water and rocky walls perfect for swimming whilst watching fish.',
          },
          {
            name: 'Cala Pola',
            description: 'A protected natural area north of Tossa, with a rocky and sandy seabed and excellent transparency.',
          },
          {
            name: 'Cala Futadera',
            description: 'An unspoilt cove with no road access, only by sea or footpath; clean, calm waters, an exclusive snorkelling anchorage.',
          },
        ],
        ...
        faq: [
          ...
          },
          {
            ...
            a: 'Part of its coastline is protected, with very well-preserved rocky seabeds and meadows; coves like La Mar Menuda or Giverola offer excellent visibility.',
          },
        ],
        ctaTitle: 'Book your snorkelling trip in Tossa de Mar',
      ...
      snorkel__locationCostaBrava: {
        ...
        spots: [
          ...
          },
          {
            ...
            description: 'A rocky corner with clean water, one of the best snorkelling anchorages on the middle section of the coast.',
          },
          {
            name: 'Cala Giverola (Tossa)',
            description: 'A deep cove with crystal-clear waters between mountains, already at the northern end of the route.',
          },
          {
            name: 'Cala Pola (Tossa)',
            description: 'A protected natural area with a rocky and sandy seabed, a reward for those who make the full crossing.',
          },
        ],
        ...
        faq: [
          ...
          },
          {
            ...
            a: 'From June to September the sea is warmer and clearer; July and August offer the best conditions, and June or September, quieter coves.',
          },
        ],
      ...
      families__locationLloret: {
        ...
        seoDescription:
          "A family boat day in Lloret de Mar departing from Blanes (~25 min with a licensed boat): sandy beaches, calm coves and roomy boats for up to 7 people.",
        h1: "Family boat rental in Lloret de Mar",
        intro:
          "Lloret de Mar combines wide sandy beaches and sheltered coves, perfect for a family day out. Departing from Blanes you arrive in about 25 minutes of calm sailing and can explore its beaches with the freedom to anchor wherever you like.",
        ...
        boatsIntro:
          "Lloret lies beyond the 2-mile range, so you get there with one of our licensed boats. They are roomy and stable (the Pacific Craft 625 takes up to 7 people) and cover the trip from Blanes in about 25 minutes.",
        practicalTitle: "Practical information",
        practicalBody:
          "Season from April to October, departures from 09:00 to 20:00 from Blanes harbour. The trip to Lloret is about 25 minutes. We carry life jackets in all sizes; bring sun protection, a cap, water and some snacks.",
        faqTitle: "Frequently asked questions",
        faq: [
          { q: "How long does it take from Blanes to Lloret by boat?", a: "About 25 minutes of calm sailing along the coast with a licensed boat." },
      ...
      sunset__locationLloret: {
        ...
        seoDescription:
          "Sunset boat trip in Lloret de Mar departing from Blanes (~25 min with a licensed boat): golden light over the Cala Banys cliffs and the Lloret castle.",
        h1: "Sunset boat trip in Lloret de Mar",
        intro:
          "The coast of Lloret de Mar, with its cliffs and its castle above the sea, becomes spectacular in the late afternoon. Departing from Blanes in about 25 minutes with a licensed boat, you arrive in time for the best light of the day.",
        ...
        boatsIntro:
          "Lloret lies beyond the 2 miles, so the trip is made with one of our licensed boats, comfortable and with a good sundeck. They cover the trip from Blanes in about 25 minutes.",
        practicalTitle: "Practical information",
        practicalBody:
        ...
        faqTitle: "Frequently asked questions",
        faq: [
          { q: "How long does it take from Blanes to Lloret at sunset?", a: "About 25 minutes with a licensed boat; it's best to set off with time to spare to make the most of the best light." },
      ...
      fishing__locationLloret: {
        ...
        seoDescription:
          "Recreational fishing by boat in Lloret de Mar from Blanes (~25 min with a licensed boat). Rocky seabeds off the coast. Fishing licence is the customer's responsibility.",
        h1: "Boat rental for fishing in Lloret de Mar",
        intro:
          "The coast of Lloret de Mar, with its cliffs and rocky seabeds, offers good areas for recreational fishing. Departing from Blanes with a licensed boat you arrive in about 25 minutes and have the range to move between spots.",
        ...
        boatsIntro:
          "Lloret lies beyond the 2 miles, so you get there with one of our licensed boats, with the range to move between fishing areas. The trip from Blanes is about 25 minutes.",
        practicalTitle: "Practical information and regulations",
        practicalBody:
        ...
        faqTitle: "Frequently asked questions",
        faq: [
          { q: "How long does it take from Blanes to Lloret by boat?", a: "About 25 minutes with a licensed boat, the ones we use for fishing outings." },
  ...
  glossaryPage: {
    ...
    categories: {
      ...
      seguridad: 'Safety on board',
      meteo: 'Weather and sea',
    },
    terms: [
      {
      ...
      },
      {
        ...
        definition: 'Spanish nautical license higher than the LNB. Allows you to operate vessels up to 15 metres in length and up to 12 miles from the coast. Requires theory exam + navigation practice + radio communications.',
        category: 'titulacion',
      },
      {
        term: 'PNB (Patrón de Navegación Básica)',
        definition: 'Old nautical license replaced in 2014 by the LNB. Allows you to operate vessels up to 8 metres up to 5 miles. Those who hold it remain valid without needing to update to LNB.',
        category: 'titulacion',
      },
      {
        term: 'Milla náutica',
        definition: 'International maritime distance unit equivalent to 1,852 metres (1.852 km). Unlicensed boats in Spain can navigate up to a maximum of 2 nautical miles from the coast (3.7 km).',
        category: 'unidad',
      },
      {
        term: 'Nudo',
        definition: 'Maritime speed unit equivalent to 1 nautical mile per hour (1.852 km/h). Unlicensed boats are limited to 5 knots (9.3 km/h). Licensed boats can reach much higher speeds.',
        category: 'unidad',
      },
      {
        term: 'Eslora',
        definition: 'Total length of the boat, measured from bow to stern. Unit: metres. In Spain, length determines the minimum nautical license: up to 5m may not require a license, up to 8m requires LNB, up to 15m requires PER.',
        category: 'unidad',
      },
      {
        term: 'Manga',
        definition: 'Maximum width of the boat, measured from one side to the other at its widest point. Unit: metres. Together with length, it defines the stability and space available on board.',
        category: 'unidad',
      },
      {
        term: 'CV (caballos de vapor)',
        definition: 'Marine engine power unit. Unlicensed boats in Spain are limited to 15 HP. Licensed boats typically have 40-150 HP, allowing faster navigation and greater range.',
        category: 'unidad',
      },
      {
        term: 'Fondear',
        definition: 'The act of stopping the boat by dropping the anchor to the seabed to keep it stationary in a cove or area without mooring. Requires choosing a sandy (not rocky) bottom, releasing enough line (3-4 times the depth) and checking that the anchor holds.',
        category: 'accion',
      },
      {
        term: 'Cala',
      ...
      },
      {
        ...
        definition: 'Port facility for recreational vessels with moorings, fuel services, water, electricity and dry dock. Blanes Marina (Girona) is the main nautical marina on the southern Costa Brava.',
        category: 'parte',
      },
      {
        term: 'Proa',
        definition: 'Front part of the boat, opposite the stern. On recreational boats it usually has the main sundeck and the white navigation light.',
        category: 'parte',
      },
      {
        term: 'Popa',
        definition: 'Rear part of the boat, opposite the bow. Houses the outboard motor, the bathing ladder and typically the central table area.',
        category: 'parte',
      },
      {
        term: 'Estribor',
        definition: 'Right side of the boat looking from stern to bow. Identified by the green navigation light. Golden rule: \'Starboard = right\'.',
        category: 'parte',
      },
      {
        term: 'Babor',
      ...
      {
        term: 'Solárium',
        definition: 'Padded area of the boat for sunbathing, typically at the bow or stern. Premium boats have double sundecks (bow and stern).',
        category: 'equipamiento',
      },
      {
        term: 'Bañera',
        definition: 'Central area of the boat where the seats, helm station and table are located. It\'s the operational space of the boat while underway.',
        category: 'parte',
      },
      {
        term: 'PY (Patrón de Yate)',
        definition: 'Spanish nautical license higher than PER. Allows you to operate vessels up to 24 metres in length and up to 150 miles from the coast. Extends PER with navigation, meteorology and technical English. Not needed for any boat in our fleet, but is the reference for offshore navigation.',
        category: 'titulacion',
      },
      {
        term: 'Calado',
        definition: 'Depth a boat needs to float without touching the bottom, measured from the waterline to the lowest point of the keel or propeller. Unit: metres. Light recreational vessels have shallow drafts, allowing them to approach shallow coves.',
        category: 'unidad',
      },
      {
        term: 'Rumbo',
        definition: 'Direction the boat is sailing, measured in degrees (0° to 360°) from north: 0°/360° north, 90° east, 180° south, 270° west. Maintaining a steady course is the basis of navigation between Blanes and the Costa Brava coves.',
        category: 'unidad',
      },
      {
        term: 'Singladura',
        definition: 'Distance covered or navigation carried out in one day. In coastal recreational boating it\'s used colloquially to refer to the outing or full day at sea.',
        category: 'unidad',
      },
      {
        term: 'Braza',
        definition: 'Old depth unit equivalent to 1.8288 metres (6 feet). Still appears on some nautical charts and among sailors to refer to depth or the length of line released when anchoring.',
        category: 'unidad',
      },
      {
        term: 'Atracar',
        definition: 'Manoeuvre of approaching and mooring the boat to a quay, pontoon or jetty. Requires controlling speed, anticipating wind and current and protecting the hull with fenders.',
        category: 'accion',
      },
      {
        term: 'Largar amarras',
        definition: 'Releasing the lines that secure the boat to the mooring to begin navigation; the opposite of mooring. Colloquially, \'cast off\' is equivalent to setting sail.',
        category: 'accion',
      },
      {
        term: 'Virar',
        definition: 'Changing the boat\'s course by turning the bow to one side. Also describes the complete turn to reverse the direction of travel.',
        category: 'accion',
      },
      {
        term: 'Capear',
        definition: 'Weathering bad weather or heavy seas by keeping the boat with the bow or bow quarter to the waves at low speed, to minimize rolling and wave impacts.',
        category: 'accion',
      },
      {
        term: 'Dar avante / dar atrás',
        definition: 'Engine commands. \'Go ahead\' is propelling the boat forward; \'go astern\' (or reverse) is propelling it backwards. Essential in port manoeuvres and when anchoring.',
        category: 'accion',
      },
      {
        term: 'Aproar',
        definition: 'Pointing the boat\'s bow towards a specific point: the waves, wind or desired course. Heading into the sea is the basic technique for safe navigation when there are waves.',
        category: 'accion',
      },
      {
        term: 'Quilla',
        definition: 'Longitudinal piece at the base of the hull that provides stability and rigidity to the boat and reduces lateral drift. On light motorboats it\'s not very pronounced.',
        category: 'parte',
      },
      {
        term: 'Casco',
        definition: 'Body or floating structure of the boat, which keeps it afloat and supports the rest of the elements. Most common in recreational boating is fibreglass; there are also aluminium or wooden ones.',
        category: 'parte',
      },
      {
        term: 'Timón',
        definition: 'Movable piece located under the stern which, when turned, deflects the water flow and makes the boat change course. It\'s controlled with the wheel or tiller at the helm station.',
        category: 'parte',
      },
      {
        term: 'Hélice',
        definition: 'Rotating bladed piece that, powered by the engine, propels the boat by displacing water. On outboard motors it\'s integrated into the engine\'s lower unit.',
        category: 'parte',
      },
      {
        term: 'Amura',
        definition: 'Area of the boat\'s side near the bow, between it and the beam. We speak of port or starboard bow; \'sea on the bow\' is the waves coming from that area.',
        category: 'parte',
      },
      {
        term: 'Aleta',
        definition: 'Area of the boat\'s side near the stern, between the beam and stern. We speak of port or starboard quarter.',
        category: 'parte',
      },
      {
        term: 'Línea de flotación',
        definition: 'Line where the water surface touches the hull with the boat afloat and with its normal load. Separates the underwater body (submerged) from the topsides (emerged).',
        category: 'parte',
      },
      {
        term: 'Ancla',
        definition: 'Metal piece dropped to the seabed, attached to the boat by chain or line, to anchor and maintain position. The grapnel is a type of light multi-fluked anchor common on small boats.',
        category: 'equipamiento',
      },
      {
        term: 'Cabo',
        definition: 'Nautical name for any rope on board: never say \'rope\'. Lines are used for mooring, anchoring, towing or securing boat elements.',
        category: 'equipamiento',
      },
      {
        term: 'Defensas',
        definition: 'Cylindrical or spherical elements, usually inflatable, that hang from the side to protect the hull from impacts against the quay or other boats when mooring.',
        category: 'equipamiento',
      },
      {
        term: 'Cornamusa',
        definition: 'T-shaped metal fitting fixed on deck where mooring lines are secured. Allows securing and releasing the line quickly.',
        category: 'equipamiento',
      },
      {
        term: 'Ecosonda',
        definition: 'Instrument that measures the water depth under the hull by emitting ultrasound and measuring the echo from the bottom. Essential for safe anchoring and avoiding running aground.',
        category: 'equipamiento',
      },
      {
        term: 'GPS y carta náutica',
        definition: 'GPS gives the boat\'s position by satellite; the chartplotter displays it on an electronic nautical chart with depths, buoys and hazards. The nautical chart is the official map of the sea.',
        category: 'equipamiento',
      },
      {
        term: 'Chaleco salvavidas',
        definition: 'Individual flotation device mandatory on board, one per person. Keeps afloat anyone who falls into the water. Its use is mandatory in risky situations and highly recommended for children and non-swimmers.',
        category: 'seguridad',
      },
      {
        term: 'Aro salvavidas',
        definition: 'Circular float thrown to a person who has fallen overboard so they can hold on while being recovered. Usually has a line attached and, in some cases, a locating light.',
        category: 'seguridad',
      },
      {
        term: 'Hombre al agua',
        definition: 'Emergency in which a person falls into the sea. The manoeuvre consists of marking the casualty, not losing sight of them, throwing a lifebuoy and returning heading carefully to pick them up from leeward.',
        category: 'seguridad',
      },
      {
        term: 'Bengalas y señales de socorro',
        definition: 'Pyrotechnic safety equipment (hand flares, parachute rockets, smoke signals) to request help and be located in case of emergency at sea.',
        category: 'seguridad',
      },
      {
        term: 'VHF (Canal 16)',
        definition: 'Very high frequency radio for maritime communications. Channel 16 is the international distress, urgency and calling frequency, monitored by Maritime Rescue.',
        category: 'seguridad',
      },
      {
        term: 'Botiquín de a bordo',
        definition: 'Set of medical supplies, mandatory depending on navigation area, to treat seasickness, cuts, sunburn and minor emergencies during the outing.',
        category: 'seguridad',
      },
      {
        term: 'Tramontana',
        definition: 'Strong, cold and dry north wind characteristic of the Gulf of Lion and northern Costa Brava. Can pick up quickly and complicate navigation; it\'s advisable to check the forecast before leaving Blanes.',
        category: 'meteo',
      },
      {
        term: 'Garbí (Garbino)',
        definition: 'Southwest wind typical of summer afternoons on the Costa Brava, associated with the sea breeze. Usually moderate and refreshing, though it can roughen the sea in the afternoon.',
        category: 'meteo',
      },
      {
        term: 'Migjorn',
        definition: 'South wind (midday) on the Catalan coast. Warm and humid, usually heralds a weather change and increased swell.',
        category: 'meteo',
      },
      {
        term: 'Mar de fondo',
        definition: 'Swell formed by distant or past wind that reaches the coast as long, regular waves, even without local wind. Can make anchoring uncomfortable in exposed coves.',
        category: 'meteo',
      },
      {
        term: 'Marejada y mar rizada',
        definition: 'Sea states according to wave height: \'rippled sea\' is very small waves (up to 0.5 m) and \'slight sea\' is waves of 0.5 to 1.25 m. These are terms from the maritime weather forecast.',
        category: 'meteo',
      },
      {
        term: 'Banderas de baño',
        definition: 'Beach flag system: green flag (swimming allowed), yellow (caution, swimming with limitations) and red (swimming prohibited). Also guide the sea state for going out in a boat.',
        category: 'meteo',
      },
      {
        term: 'Parte meteorológico marítimo',
        definition: 'Specific forecast for the sea (wind, sea state, visibility and phenomena) issued by AEMET by areas. Checking it before each outing is the first safety rule.',
        category: 'meteo',
      },
    ],
  },
  ...
  garantiasPage: {
    ...
    criteriaMarks: ["AEMET", "20 kn", "The company"],
    criteria: [
  ...
  activitiesPage: {
    seoTitle: "What to do in Blanes and Lloret de Mar besides the boat | Activities",
    seoDescription: "Parasailing, buggies, wakeboard, paddle surf, inflatables and an escape room in Blanes, Lloret de Mar and Fenals, from 15 EUR. Booked through Activitatum; the boats and jet skis are ours.",
    navLabel: "Activities",
    hero: {
      title: "What to do in Blanes and Lloret besides sailing",
      subtitle: "A boat trip takes half a day. Blanes and Lloret are ten minutes apart, so the rest of it fits: here is what is within reach.",
    },
    chips: [
      "From 15 EUR",
      "Blanes and Lloret",
    ...
    intro: "We do not rent any of this: local companies run it and you book on Activitatum, the agency we work with. It is here because it is the question we get the most when you hand the boat back.",
    teaserTitle: "And the rest of the day?",
    teaserText: "Parasailing, buggies, wakeboard or paddle surf, ten minutes from the port. We do not rent them: Activitatum, the activity agency we work with, does.",
    afterBoatTitle: "The afternoon after the boat",
    afterBoatIntro: "All of this leaves from Blanes beach, a short walk from the port where we moor. Sessions run ten to twenty minutes: they fit between handing the boat back and dinner.",
    landDayTitle: "The day the sea is out",
    landDayIntro: "Half day plans in Lloret, for when the wind cancels the trip or you simply would rather not repeat it.",
    rainyDayTitle: "And if it rains",
    priceFrom: "from",
    activities: {
      flyfish: {
        name: "Flyfish",
        note: "The inflatable that takes off when the boat pulls. Five minutes, no experience needed.",
      },
      bananaBoat: {
        name: "Banana boat",
        note: "The towing classic, four to eight people per run. In a group it is the cheapest thing on the beach.",
      },
      paddle: {
        name: "Paddle surf",
        note: "An hour on the board around the bay. Standing up takes about ten minutes.",
      },
      wakeboard: {
        name: "Wakeboard and water ski",
        note: "With an instructor in the boat. Fifteen minutes is enough for several tries and to get up.",
      },
      crazyUfo: {
        name: "Crazy UFO",
        note: "An inflatable disc on tow that spins until someone falls off. Everyone falls off.",
      },
      parasailing: {
        name: "Parasailing over Lloret bay",
        note: "Two hundred metres of rope, taking off and landing from the boat platform. You go up and come back down dry.",
      },
      buggy: {
        name: "Buggy along the coast",
        note: "Two hours on tracks inland from Lloret with a stop at a viewpoint. A category B licence is enough.",
      },
      holidayPack: {
        name: "Holiday Pack",
        note: "Three water activities the same afternoon, cheaper than booking them separately.",
      },
      escapeRoom: {
        name: "Escape room in Malgrat de Mar",
        note: "Ninety minutes indoors, ten minutes from Blanes. The plan for tramuntana days.",
      },
    },
    operatedByTitle: "Booked through Activitatum",
    operatedByText: "Activitatum is the activity agency we work with, owned by the same people as us. It brings together the calendars and payments of the operators in Blanes, Lloret and Fenals. What runs on an engine over water is still ours: boats and jet skis are booked on this site.",
    cta: "See activities in Blanes",
    ctaSecondary: "See activities in Lloret de Mar",
    ctaNote: "Activitatum opens in a new tab.",
    faqTitle: "Frequently asked questions",
    faq: [
      {
        q: "Do the activities leave from the same place as the boats?",
        a: "The Blanes ones do: the beach is right next to the port where we moor. The Lloret de Mar ones are about ten minutes away by car.",
      },
      {
        q: "Can I do an activity on the same day I rent the boat?",
        a: "That is the usual thing. A half day trip leaves the afternoon free, and the water activities last between ten minutes and an hour.",
      },
      {
        q: "Why is it booked on another website?",
        a: "Because different companies run them. Activitatum brings the local operators together in one calendar, with instant confirmation and the pass on your phone.",
      },
      {
        q: "Do you rent jet skis there too?",
        a: "No. Jet skis and boats are ours and are booked here, on this site, with no middleman.",
      },
    ],
  },
  scootersPage: {
  ...
  captainedPage: {
    ...
    seoDescription:
      "Private boat trip with skipper from Blanes: coves and sea caves up to Tossa de Mar, with a swim stop. Up to 6 people, from 265€/2h. {rating}★ on Google.",
    ...
    faq: [
      ...
      },
      {
        ...
        a: "From 265€ for 2 hours from April to June and in September, 285€ in July and 310€ in August. There are also 3 hour trips (from 350€) and 4 hour trips (from 420€). The price is per boat, for up to 6 people.",
      },
      {
  ...
  shopPage: {
    gate: {
      ...
      subtitle: 'We are getting the launch ready. Enter the password to take a look.',
    ...
    products: {
      tee: {
        ...
        description:
          "Oversize cotton tee with the Costa Brava Rent a Boat and Laura Cabanas logos on the chest and the large illustration on the back.",
      },
      tote: {
        name: "Costa Brava Culture tote bag",
        description:
          "Royal blue canvas bag with the Costa Brava Culture illustration in white. For the beach, the shops or your boat day.",
      },
    },
    colors: {
    ...
    delivery: {
      title: "Delivery",
      pickupTitle: "Pickup at the port of Blanes",
      pickupText:
        "Free. We will contact you to arrange the pickup; if you have a boat trip booked, we will hand it to you that same day at the port.",
      pickupLauraTitle: 'Pickup at Laura Cabanas (Lloret de Mar)',
      pickupLauraText:
    ...
    designer: {
      ...
      text:
        "Laura Cabanas is a fashion designer from Lloret de Mar. This capsule was born from a summer shared on the Costa Brava: her stroke and our boats, in pieces made to wear the Mediterranean.",
      cta: "Visit lauracabanas.com",
    },
    success: {
    ...
    cancelled: {
      ...
      text: "No charge has been made. Your cart is still saved in case you want to finish your order.",
    },
    faqTitle: "Frequently asked questions",
    faq: [
      {
        q: "How does pickup at the port of Blanes work?",
        a: "At checkout, choose the pickup option (free). We will contact you to arrange a time; if you have a boat booking, we will hand you the order on the day of your trip at the same port.",
      },
      {
      ...
      },
      {
        ...
        a: "It is a unisex oversize fit. If you prefer it more fitted, we recommend going one size down from your usual one.",
      },
      {
        q: "Who is behind the design?",
        a: "The Costa Brava Culture collection is designed with Laura Cabanas, a fashion designer from Lloret de Mar, in collaboration with Costa Brava Rent a Boat (Blanes).",
      },
    ],
  },
  popularBoatsSection: {
    ...
    pages: {
      ...
      blanes: {
        title: 'Popular Boats at Blanes Harbour',
        description: 'Our entire fleet departs from Blanes Harbour: from licence-free boats for 2-5 people to skippered charters. These are our most frequently booked boats.',
      },
      malgrat: {
        title: 'Popular Boats for Hire from Blanes Harbour',
        description: '10 minutes from Malgrat de Mar. These are our most hired licence-free boats: they all reach Fenals Beach (south of Lloret) in 25 minutes and are ideal for 2-7 people.',
      },
      santaSusanna: {
        title: 'Popular Boats for Hire from Blanes Harbour',
        description: '15 minutes from Santa Susanna. These are our most hired licence-free boats: they all reach Fenals Beach (south of Lloret) in 25 minutes and are ideal for 2-7 people.',
      },
      calella: {
        title: 'Popular Boats for Hire from Blanes Harbour',
        description: '20 minutes from Calella. These are our most hired licence-free boats: they all reach Fenals Beach (south of Lloret) in 25 minutes and are ideal for 2-7 people.',
      },
      pineda: {
  ...
  locationTemplate: {
    ...
    destBlanesCoves: 'Blanes Coves',
    whyRentImgAlt: 'Friends enjoying a day out boating and snorkeling on the Costa Brava',
    coastBreakImgAlt: 'Boat anchored in a cove with crystal-clear waters on the Costa Brava',
  },
  locationPages: {
    blanes: {
      faqItems: [
        {
          ...
          answer: 'No. We have 4 license-free boats for 4 or 5 people. You just need to be over 18 years old. We give you a 15-minute briefing before you set off.',
        },
        {
          question: 'How much does it cost to rent a boat at Blanes Marina?',
          answer: 'Boats without license start from {noLicBaja1h} €/hour in low season (April–June, September–October). In high season (August) from {noLicAlta1h} €/hour. The price includes fuel, insurance and safety equipment.',
        },
        {
      ...
      sections: {
        ...
        expSnorkelDesc: 'Sail 15 minutes to Cala Brava and discover its rocky seabeds and posidonia meadows. Crystal-clear waters with up to 15 metres visibility, perfect for spotting rock fish, starfish and octopus. Rent snorkelling gear for just 7.50 €.',
    ...
    lloret: {
      faqItems: [
        ...
        },
        {
          ...
          answer: 'No. Tossa is 4–5 miles north of Fenals, outside the legal range without a license. To go to Tossa by boat from Blanes you need (a) a boat with the Licencia de Navegación (LN), or (b) a Private Excursion with Captain.',
        },
        {
        ...
        },
        {
          ...
          answer: 'By car it is 10 minutes on the GI-682 (free parking 100 m from the port). By bus, the Lloret-Blanes line takes about 20 minutes. A taxi costs around 15-18 euros. There is no rental base inside Lloret: all departures are from the Port of Blanes.',
        },
        {
          question: 'Which coves will I see on the boat route to Lloret?',
          answer: 'Leaving the Port of Blanes you pass Cala Sant Francesc, Sa Forcanera, Santa Cristina beach, Cala Treumal and Cala Sa Boadella before reaching Fenals Beach. They are the most photographed coves of the southern Costa Brava and all are within the legal license-free range.',
        },
      ],
      hero: {
    ...
    tossa: {
      faqItems: [
        {
          ...
          answer: 'No. License-free boats (2 miles from coast, 5 knots, 15 HP) reach as far as Fenals Beach (south of Lloret), 4 miles before Tossa. To reach Tossa you need the Licencia de Navegación (LN) or book the Private Excursion with Captain.',
        },
        {
        ...
        },
        {
          ...
          answer: 'Pacific Craft 625 with professional skipper, 4 h maximum, up to 6 people (plus the skipper). From {excursionBaja4h} € low season (April–June, September–close). Includes VAT, skipper, mooring, cleaning and insurance. Fuel extra.',
        },
        {
      ...
      hero: {
        ...
        subtitle: 'Sail past the Vila Vella, the only medieval castle over the sea in the western Mediterranean. From Blanes harbour, 30-45 minutes with the Licencia de Navegación (LN) or the Private Excursion with Captain.',
        badgeFrom: 'From Blanes Harbour',
    ...
    malgrat: {
      hero: {
        ...
        imageAlt: 'Costa Brava cove with cliffs and pine trees, 25 minutes by boat from Blanes Harbour',
      },
      sections: {
        whyRentTitle: 'Why Rent a Boat from Blanes?',
        closestPort: 'The Closest Port',
        closestPortDesc: 'Blanes is the nearest nautical port to Malgrat de Mar, just 10 minutes via the N-II road. Offering 8 boats ready to sail with all amenities.',
        ...
        fuelIncluded: 'Fuel Included',
        fuelIncludedDesc: 'All our rentals include fuel in the price. No surprises or hidden costs. From €85/hour.',
        ...
        byTaxi: 'By Taxi',
        byTaxiDesc: 'A taxi from Malgrat de Mar to Blanes Port costs approximately 12-15 € and takes about 10 minutes.',
      ...
      faqItems: [
        ...
        },
        {
          ...
          answer: 'Boat rental starts from {noLicBaja1h} € per hour with fuel included. No license required for boats up to 15 HP. We have {fleetCount} boats for 4-11 people.',
        },
        {
        ...
        },
        {
          ...
          answer: 'We don\'t offer a direct transfer, but the journey is very short: 5 minutes by R1 train (Malgrat → Blanes) or 10 minutes by car/taxi (approximate cost 12-15 €). Blanes station is a 10-minute walk from the marina. There\'s also local bus L23.',
        },
      ],
    },
    santaSusanna: {
      faqItems: [
        ...
        },
        {
          ...
          answer: 'From Blanes we recommend: (a) 4h cove route without license to Fenals Beach anchoring in 2-3 crystal-clear coves (from 135 € for 5 people); (b) 4h private excursion with skipper to Tossa and Cala Bona (from {excursionBaja4h} €, ideal if you have no boating experience); (c) Basic License boat if someone in the group has a qualification (from 255 € / 4h).',
        },
        {
        ...
        },
        {
          ...
          answer: 'Yes. Besides the license-free rental you drive yourself, we offer the private excursion with captain: a boat trip from the Port of Blanes lasting 2 to 8 hours for up to 6 people, with stops to swim and snorkel. Ideal if you travel with family and prefer to just enjoy.',
        },
      ],
      hero: {
        ...
        imageAlt: 'Cliff-lined coast with turquoise waters of the Costa Brava, accessible by boat from Blanes',
      },
      sections: {
        whyRentTitle: 'Why Rent a Boat from Blanes?',
        closestPort: 'Nearby and Accessible Port',
        closestPortDesc: 'Blanes Port is the closest boat rental point to Santa Susanna. Just 15 minutes by road, with 8 boats ready for your adventure.',
        ...
        fuelIncludedDesc: 'Price includes fuel from €85/hour. No hidden costs. Training, life jackets and safety equipment included.',
        ...
        byTaxi: 'By Taxi',
        byTaxiDesc: 'Taxi from Santa Susanna to Blanes Port: approximately 18-22 €, about 15 minutes.',
        byPublicTransport: 'By Public Transport',
        ...
        ctaDescription: 'Blanes Port awaits you with 8 boats ready. Book and discover the Costa Brava from the sea.',
        ctaButton: 'Book a Boat from Blanes',
      },
    },
    calella: {
      faqItems: [
        ...
        },
        {
          ...
          answer: 'Not directly from Calella (no rentals). From Blanes yes: with a boat with the Licencia de Navegación (LN) you reach Tossa in 45 min (from {licBaja2h} €/2h), or with our Private Excursion with Captain 4h to Tossa including Cala Bona and Vila Vella (from {excursionBaja4h} € for up to 6 people, plus the skipper). License-free boats cannot reach Tossa due to the legal limit of 2 miles.',
        },
        {
          question: 'How much does the R1 train from Calella to Blanes cost?',
          answer: 'A single R1 ticket Calella → Blanes costs approximately 3 € (ATM zone 4-5 fare). With a T-Casual 10-journey card it\'s more economical. Duration: 15 minutes. Frequency: every 30 minutes in season. From Blanes station to the Marina it\'s a 10-minute walk or 3 min by taxi.',
        },
      ],
      hero: {
        ...
        imageAlt: 'Hidden Costa Brava cove with crystal-clear water, on the boat route from Blanes',
      },
      sections: {
        whyRentTitle: 'Why Rent a Boat from Blanes?',
        closestPort: 'Your Costa Brava Port',
        closestPortDesc: 'Blanes is the most accessible nautical port from Calella. 20 minutes via the C-32 or N-II, with 8 boats and professional service.',
        varietyBoats: 'Full Fleet',
        varietyBoatsDesc: 'License-free boats from €85/h for families and groups of friends. Licensed boats for qualified sailors or private skipper.',
        ...
        byTaxi: 'By Taxi',
        byTaxiDesc: 'Taxi from Calella to Blanes Port: approximately 25-30 €, about 20 minutes.',
        byPublicTransport: 'By Public Transport',
        ...
        ctaDescription: '20 minutes by car from Blanes Port. 8 boats ready to explore the Costa Brava.',
        ctaButton: 'Book a Boat from Blanes',
      },
    },
    costaBrava: {
      hero: {
        ...
        subtitle: 'Discover the best coves and beaches of the Costa Brava aboard our boats. Departures from the Port of Blanes, in the heart of the Catalan coast. Licence-free boats from €85/hour with fuel and insurance included.',
      ...
      sections: {
        ...
        allLevelsDesc: 'Whether you have never sailed before or you are an experienced skipper, we have the perfect boat for you. 4 licence-free boats for beginners and powerful engine vessels for those who want to explore further. Training included with every rental.',
        ...
        ctaDescription: 'Choose your boat, date and time. Fuel, insurance and training included on licence-free boats. Book via WhatsApp: we confirm within 2 hours.',
    ...
    tordera: {
      faqItems: [
        ...
        },
        {
          ...
          answer: 'License-free boat rental starts from {noLicBaja1h} € per hour with fuel included. Licensed boats from {licBaja2h} € for 2 hours. We have {fleetCount} boats for 4-11 people.',
        },
        {
          question: 'Do I need a boating license?',
      ...
      seo: {
        title: 'Boat Rental Tordera | Blanes Port 15 min | No License 85€/h | Tordera Delta',
        description: 'Do you live in Tordera or near the Delta? Blanes Port is 15 min by car or 8 min by R1 train. Rent a boat without a license from 85€/h with fuel included. Explore the Tordera Delta.',
        ogTitle: 'Boat Rental Tordera | Tordera Delta by Boat',
        ogDescription: 'From Tordera to Blanes Port in 15 min. Boat without license from 85€/h. Tordera Delta by boat. 4.8★.',
      },
      schema: {
        name: 'Boat Rental near Tordera',
        description: 'Rent boats from Blanes Port, just 15 minutes by car from Tordera. Boats without license from €85/hour with fuel included.',
      },
      ...
      sections: {
        ...
        whyCard3Desc: 'The price of boats without license includes fuel. From €85 per hour. No hidden costs or surprises in the final price.',
        ...
        howTaxiDesc: 'A taxi from Tordera to Blanes Port costs approximately 15-20 €. It\'s a quick and comfortable option for getting there and back.',
        ...
        pricingNoLicFrom: 'From {noLicBaja1h} €/hour (fuel included)',
        pricingNoLicCapacity: 'Capacity: 4-7 people depending on model',
        pricingLicTitle: 'Boats with license',
        pricingLicFrom: 'From {licBaja2h} € / 2 hours',
        pricingLicEngines: 'Engines from 80 to 115 HP',
    ...
    palafolls: {
      ...
      seo: {
        title: 'Boat Rental Palafolls | Blanes Port 12 min | No License 85€/h',
        description: 'At a campsite or accommodation in Palafolls? Blanes Port is 12 min by car. Rent a boat without a license from 85€/h with fuel included. Ideal Costa Brava excursion.',
        ogTitle: 'Boat Rental Palafolls | 12 min to Blanes Port',
        ogDescription: 'From Palafolls to Blanes Port in 12 min. Boat without license from 85€/h. Fuel included. 4.8★.',
      },
      schema: {
        name: 'Boat Rental near Palafolls',
        description: 'Rent boats from Blanes Port, just 12 minutes by car from Palafolls. Boats without license from €85/hour with fuel included.',
      },
      ...
      sections: {
        ...
        whyCard3Title: 'Fuel included on boats without license',
        whyCard3Desc: 'The price of boats without license includes fuel. From €85 per hour. No hidden costs or fuel surcharges.',
        whyCard4Title: 'No previous experience necessary',
        ...
        howTaxiTitle: 'By taxi',
        howTaxiDesc: 'A taxi from Palafolls to Blanes Port costs approximately 12-18 €. It\'s a comfortable option if you don\'t have your own car.',
    ...
    pineda: {
      faqItems: [
        ...
        {
          question: 'Is there boat rental in Pineda de Mar itself?',
          answer: 'No, Pineda de Mar has no marina with boat rental. The nearest port for the whole Alt Maresme (Malgrat, Santa Susanna, Pineda and Calella) is the Port of Blanes, 18 minutes by car or 12 minutes on the R1 train.',
        },
        {
          question: 'Which coves can I visit departing from Blanes?',
          answer: 'With a license-free boat you reach Cala Sant Francesc, Sa Forcanera, Santa Cristina beach, Cala Sa Boadella and Fenals Beach (south Lloret), all within the legal 2-mile limit. With a license or the captained private excursion you can continue to Tossa de Mar.',
        },
        {
          question: 'Can I go on a boat trip without driving the boat myself?',
          answer: 'Yes. If you prefer not to drive, book the private excursion with captain: departures from the Port of Blanes from 2 to 8 hours, up to 6 people, with stops to swim and snorkel in the coves. No qualification needed.',
        },
      ],
      seo: {
        title: 'Boat Rental Pineda de Mar | Blanes Port 18 min | No License 85€/h',
        description: 'Staying in Pineda de Mar? Blanes Port is 18 min by car or 12 min by R1 train. Rent a boat without a license from 85€/h with fuel included. Sail to Blanes, Lloret or Tossa.',
        ogTitle: 'Boat Rental Pineda de Mar | 18 min to Blanes Port',
        ogDescription: 'From Pineda de Mar to Blanes Port in 18 min. Boat without license from 85€/h. 4.8★ Google.',
      },
      schema: {
        name: 'Boat Rental near Pineda de Mar',
        description: 'Rent boats from Blanes Port, just 18 minutes by car from Pineda de Mar. Boats without license from €85/hour with fuel included.',
      },
      ...
      sections: {
        ...
        heroImageAlt: 'Turquoise waters of the Costa Brava, 18 minutes from Pineda de Mar, departing from Blanes Harbour',
        ...
        whyCard3Title: 'Fuel included on boats without license',
        whyCard3Desc: 'The price of boats without license includes fuel, so there are no surprises. From €85 per hour. The price you see is the final price.',
        whyCard4Title: 'No previous experience necessary',
        ...
        howTaxiTitle: 'By taxi',
        howTaxiDesc: 'A taxi from Pineda de Mar to Blanes Port costs approximately 20-25 €. It\'s a good option if you don\'t have a car or prefer not to worry about parking.',
