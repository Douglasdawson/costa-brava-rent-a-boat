...
export const es: Translations = {
  ...
  boatDetail: {
    ...
    selectDateBody: "Toca un día verde en el calendario para ver los precios reales y disponibilidad.",
    calendarHint: "Toca un día disponible para ver los precios",
