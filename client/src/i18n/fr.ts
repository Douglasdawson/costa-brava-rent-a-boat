...
export const fr: Translations = {
  ...
  fleet: {
    ...
    whatsappHelpPrefill:
      "Bonjour ! J'ai besoin d'aide pour choisir le meilleur bateau à louer à Blanes. Pourriez-vous me conseiller sur les prix et la disponibilité ?",
  },
  boats: {
  ...
  features: {
    ...
    capacity: {
      ...
      description:
        "Bateaux pour couples, familles ou groupes d'amis. Vous choisissez celui qui vous convient.",
    },
    flexibleHours: {
      title: "Vous Décidez la Durée",
      description:
        "De 1 heure pour essayer à une journée complète de 8 heures à explorer les criques.",
    },
    location: {
    ...
    extras: {
      snorkel: {
        name: "Snorkeling",
        description: "Équipement complet de snorkeling pour découvrir la vie marine",
      },
      paddle: {
        name: "Paddle Surf",
        description: "Planche de paddle surf pour explorer criques et côtes",
      },
      cooler: {
        name: "Glacière avec Boissons",
        description: "Glacière avec glace et boissons fraîches pour votre journée en mer",
      },
      privateTour: {
        name: "Excursion Privée",
        description: "Tour privé avec skipper inclus pour une expérience exclusive",
        price: "À partir de 265€",
      },
      parking: {
        name: "Parking",
        description: "Place de parking près du port pour plus de commodité",
        price: "10€/jour",
      },
    },
  ...
  contact: {
    ...
    navBlanesDesc:
      "Port d'attache avec tout le confort. Point de départ idéal pour explorer toute la Costa Brava.",
    ...
    navLloretDesc:
      "Plages animées et criques cachées. De Blanes vous arrivez en 25 minutes en naviguant le long de la côte.",
    ...
    navTossaDesc:
      "Village médiéval avec château et eaux cristallines. Un paradis méditerranéen à ne pas manquer.",
    ...
    navLicensedTag3: "Jusqu'à Tossa de Mar",
  ...
  footer: {
    ...
    newsletterEmailError: "Saisissez un email valide",
    ...
    nameDifferentiator:
      "Costa Brava Rent a Boat est une entreprise indépendante. À ne pas confondre avec d'autres opérateurs au nom similaire.",
    // GSC 2026-05-17: SEO rich anchor texts para reforzar señal a landings locales
    locationsHeading: "Location de bateaux par lieu",
    locations: {
      blanes: "Location bateau Blanes",
      lloret: "Location bateau Lloret de Mar",
      tossa: "Location bateau Tossa de Mar",
      malgrat: "Location bateau Malgrat de Mar",
      santaSusanna: "Location bateau Santa Susanna",
      calella: "Location bateau Calella",
      pinedaDeMar: "Location bateau Pineda de Mar",
      palafolls: "Location bateau Palafolls",
      tordera: "Location bateau Tordera",
      barcelona: "Location bateau près de Barcelone",
      costaBrava: "Location bateau Costa Brava",
    },
    pricing: "Tarifs",
    boatsNearBarcelona: "Bateaux près de Barcelone",
  },
  booking: {
    ...
    continueToPayment: "Vérifier la demande",
    stripePaymentSecure:
      "Nous confirmerons la disponibilité par WhatsApp dans les 2 heures. Sans engagement jusque-là.",
    firstName: "Prénom",
    ...
    extrasDetails: {
      parking: {
        name: "Parking dans le port",
        description: "Parking dans le port et devant le bateau",
      },
    ...
    paymentError: "Erreur lors de l'envoi de la demande",
    noPaymentSession: "Impossible de créer la demande",
    bookingCreated: "Réservation créée",
    redirectingPayment: "Envoi de votre demande de réservation...",
    ...
    quoteDescription:
      "Obtenez le prix final avec les tarifs saisonniers et créez une réservation temporaire de 30 minutes.",
    quoteCreated: "Devis créé.",
    quoteTimeLimit: "Vous avez 30 minutes pour confirmer votre demande.",
    processingPayment: "Envoi de la demande...",
    ...
    coverages: {
      ...
      weatherDesc: "Si le mauvais temps empêche la sortie, vous récupérez en espèces ce que vous avez payé d'avance.",
      depositName: "Caution réduite",
      depositDesc: "Vous laissez {amount}€ de caution{standard} le jour de la sortie.",
      ...
      triggerWind: "Vent soutenu ou rafales au-dessus, ou décision de l'entreprise pour la sécurité.",
    ...
    timeSlotMaxDurationSuffix: " · seulement {n}h disponibles",
    errors: {
      codeValidation: {
    ...
    gdprPassive:
      "En envoyant cette demande, vous acceptez notre {privacyPolicy}, les {termsAndConditions} et les {siteTerms}.",
    errorGeneric: "Une erreur inattendue s'est produite",
    errorPayment: "Erreur lors de l'envoi de la demande",
    backToHome: "Retour à l'accueil",
    gdprPrivacyLink: "Politique de Confidentialité",
    gdprTermsLink: "Conditions Générales de Location",
    gdprSiteTermsLink: "Conditions Générales du site",
  ...
  faq: {
    ...
    subtitle:
      "Trouvez des réponses à toutes vos questions sur la location de bateaux à Blanes, Costa Brava.",
  ...
  boatClubPromo: {
    eyebrow: "Une autre façon de prendre la mer",
    title: "Costa Brava Boat Club",
    subtitle: "Votre bateau toute l'année sans l'acheter. Abonnement mensuel, places limitées par bateau et réservation en ligne quand l'envie de naviguer vous prend.",
    perk1: "Naviguez toute l'année",
    perk2: "Places limitées par bateau",
    perk3: "Réservez en ligne depuis votre espace",
  ...
  codeValidation: {
    haveCode: "Vous avez un code cadeau, de réduction, ami ou élève ?",
    phoneMismatch: "Ce code est lié à un autre téléphone : utilisez celui de votre inscription à l'école",
    notApplicable: "Ce code n'est valable que sur les bateaux avec permis",
    ...
    serverError: "Nous n'avons pas pu vérifier le code pour le moment : réessaye",
    validReferral: "Code ami valide",
    referralPerk: "Tu reçois le Pack Premium gratuit (30€). On te le confirme par WhatsApp.",
  },
  giftCards: {
    ...
    buy: "Demander la carte cadeau",
    processing: "Envoi de la demande...",
    purchaseSuccess: "Demande reçue",
    purchaseSuccessDesc:
      "Nous vous écrivons par email avec les étapes pour finaliser le paiement. Dès qu'il est confirmé, nous envoyons la carte au destinataire. Sans paiement en ligne.",
    code: "Code de la carte",
    forRecipient: "Pour",
    backHome: "Retour à l'accueil",
    buyAnother: "Demander une autre",
    whyTitle: "Pourquoi offrir une expérience en bateau ?",
    whyP1:
    ...
    ctaTitle: "La mer est toujours le plus beau cadeau",
    ctaSubtitle:
  ...
  boatDetail: {
    ...
    pricesForDay: "Prix pour {day}",
    backToSeasonPrices: "Voir les prix par saison",
    specialRateIncrease: "Tarif spécial",
    specialRateDiscount: "Remise appliquée",
    loadingPrices: "Chargement des prix…",
    noPricesForDate: "Aucun tarif configuré pour cette date",
    occupiedHoursForDay: "Déjà réservé de {ranges}",
    checkAvailability: "Choisissez une date et vous verrez les prix",
    selectDateTitle: "Votre jour, votre prix",
    selectDateBody: "Choisissez le jour et on vous montre les créneaux libres et le vrai prix.",
    ...
    viewCustomerGallery: "Voir la galerie photos clients",
    fuelIncludedShort: "Carburant inclus",
    fuelNotIncludedNote: "Carburant non inclus (selon consommation)",
    ...
    extrasNote:
      "Vous pouvez ajouter ces extras lors de votre réservation en ligne ou directement au port avant le départ.",
    importantInfo: "Informations Importantes",
    essentialDoc:
      "Indispensable : Se présenter avec une pièce d'identité ou un passeport en cours de validité",
    ...
    whatToBringTip:
      "Arrivez au Port de Blanes 15 minutes avant le départ pour le briefing de sécurité.",
    imageAria: "Image",
  },
  wizard: {
    stepBoat: "Bateau",
    ...
    withoutLicense: "Je n'en ai pas",
    withLicense: "Oui, j'en ai un",
    ...
    confirmViaWhatsApp: "Confirmation par WhatsApp en moins de 2 heures",
    firstName: "Prénom",
    lastName: "Nom de famille",
    ...
    email: "Email",
    emailHelper: "On t'envoie le résumé ici si tu le laisses",
    date: "Date",
    ...
    missingFieldsTitle: "Vérifie les champs marqués",
  ...
  bookingWizard: {
    ...
    boatStatus: {
      partial: "Peu d'heures disponibles",
      booked: "Complet ce jour-là",
      changeDate: "Changer de date",
      seeOtherBoat: "Voir un autre bateau",
    },
    multiBoat: {
      title: "Vos bateaux",
    ...
    licenseVerifier: {
      title: "Vérifie ton permis bateau",
      subtitle: "30 secondes pour savoir si ton permis te permet de louer un bateau en Espagne.",
      panelEyebrow: "Vérifie ton permis · 30 s",
      panelHelper: "Vérifie si ton permis te permet de louer en Espagne.",
      discoverCta: "Ton permis est-il valable ? Vérifie-le en 1 minute",
      countryLabel: "Pays qui a délivré ton permis",
      countryPlaceholder: "Sélectionne un pays",
      countrySearchPlaceholder: "Rechercher un pays...",
      countryNotFound: "Aucun pays trouvé.",
      licenseTypeLabel: "Type de permis",
      licenseTypeOptions: {
        ...
        national: "Permis nautique de mon pays",
        icc_only: "J'ai seulement l'ICC (International Certificate of Competence)",
        other: "Autre",
      },
      hasIccLabel: "As-tu un ICC (International Certificate of Competence) ?",
      hasIccYes: "Oui",
      hasIccNo: "Non",
      verify: "Vérifier",
      skip: "Je vérifie plus tard",
      change: "Modifier",
      result: {
        valid: "Ton permis est valide en Espagne",
        probablyValid: "Probablement valide",
      ...
      meetsFleet: "Valide pour notre flotte avec permis.",
      insufficientForFleet: "Insuffisant pour notre flotte. Il te faut la Licencia de Navegación (LN) ou plus.",
  ...
  destinations: {
    ...
    fromBlanesSub:
      "Explorez les endroits les plus spectaculaires de la Costa Brava depuis notre port de départ à Blanes",
    boatTypes: "Types d'Embarcation",
    boatTypesSub:
      "Choisissez le type de bateau qui correspond le mieux à votre expérience et vos besoins",
    viewDetails: "Voir Détails",
    viewBoats: "Voir Bateaux",
    tossaName: "Visite Tossa de Mar",
    tossaDesc:
      "Village médiéval protégé par des remparts. Le joyau historique le plus beau de la Costa Brava.",
    ...
    licenseFree: "Bateaux Sans Permis",
    licenseFreeDesc:
      "Embarcations jusqu'à 15 CV ne nécessitant pas de permis nautique. Parfaites pour les débutants et les familles.",
    licenseFreeFeat1: "Jusqu'à 15 CV",
    licenseFreeFeat2: "4-5 personnes",
    licenseFreeFeat3: "Maniement facile",
  },
  homepageLocations: {
    sectionTitle: "Location de bateaux sur la Costa Brava",
    sectionSubtitle:
      "Naviguez depuis le port de Blanes vers les meilleures destinations de la côte",
    ...
    tossa: "Location bateau Tossa de Mar",
    tossaDesc: "30-45 min de navigation avec permis, village médiéval fortifié",
  ...
  categoryLicenseFree: {
    ...
    freeNavigationDesc:
      "Les bateaux sans permis sont des embarcations d'une puissance maximale de 15 CV (11 kW) qui peuvent être pilotées sans permis nautique officiel. Parfaits pour ceux qui veulent profiter de la mer sans complications.",
    easyToHandle: "Facile à Manoeuvrer",
    easyToHandleDesc:
      "Ces embarcations sont conçues pour être intuitives et sûres. Avec des commandes simples et une stabilité garantie, n'importe qui peut apprendre à les piloter en quelques minutes.",
    safeLimits: "Limites de Sécurité",
    safeLimitsDesc:
      "Par la loi, la navigation est limitée à 2 milles nautiques de la côte et dans des eaux protégées. Cela garantit que vous serez toujours en zone sûre et pourrez revenir facilement au port.",
    completeEquipment: "Équipement Complet",
    completeEquipmentDesc:
      "Tous nos bateaux incluent l'équipement de sécurité réglementaire, gilets de sauvetage, extincteur, et des extras comme une glacière, un auvent solaire, un kit de plongée libre et une radio.",
    ...
    ctaDescription:
      "Louez un bateau sans permis et découvrez la liberté de naviguer sur la Costa Brava sans complications. Idéal pour les débutants et les familles !",
    ...
    regulationRequirements:
      "Les exigences sont simples : avoir au moins 18 ans, recevoir un briefing de securite avant le depart (toujours inclus chez nous), porter des gilets de sauvetage pour tous les passagers et respecter les limites de navigation etablies. Aucune experience prealable ni formation specifique n'est necessaire.",
    regulationAllowed:
      "Avec un bateau sans permis, vous pouvez naviguer librement le long de la cote de Blanes, mouiller dans des criques et plages, faire du snorkeling, bronzer en mer et explorer les falaises de la Costa Brava. Le tout dans un rayon de 2 milles nautiques du rivage et par conditions meteorologiques favorables.",
    regulationNotAllowed:
      "Les bateaux sans permis ne peuvent pas naviguer de nuit, s'aventurer au-dela de 2 milles nautiques du rivage, ni transporter plus de passagers que ce qui est indique dans les specifications techniques du bateau. Ces limites existent pour garantir la securite de tous les navigateurs.",
    regulationFuelIncluded:
      "Sur nos bateaux sans permis, le carburant est inclus dans le prix de location. Vous n'aurez pas a vous soucier du ravitaillement ni de frais supplementaires de carburant. Le prix affiche est le prix final.",
    comparisonTitle: "Comparatif Detaille de Nos Bateaux sans Permis",
    comparisonIntro:
      "Nous disposons de 4 bateaux sans permis au Port de Blanes, chacun avec sa propre personnalite. Consultez le tableau pour trouver celui qui correspond le mieux a vos projets.",
    ...
    testimonial1Text:
      "Nous avons loue le Remus 450 pour une journee avec les enfants. Ils nous ont appris a le manoeuvrer en 10 minutes et nous avons mouille dans une crique magnifique pour faire du snorkeling. Les petits n'ont pas arrete de sauter dans l'eau. On reviendra, c'est sur.",
    testimonial1Context: "Famille avec 2 enfants, location de 4 heures en juillet",
    testimonial2Name: "Laura et Marc, Barcelone",
    testimonial2Text:
      "Nous sommes sortis au coucher du soleil avec le Solar 450 et ce fut une experience inoubliable. Voir la Costa Brava baignee de tons dores depuis la mer, sans bruit de moteur, au mouillage devant les falaises... Romantique et tres facile a manoeuvrer.",
    ...
    testimonial3Text:
      "Nous etions 4 amis et nous avons pris l'Astec 480 avec bluetooth. Nous avons explore plusieurs criques depuis Blanes vers le sud, mis de la musique et fait des pauses baignade dans des eaux cristallines. Meilleur plan de l'ete, sans aucun doute.",
    testimonial3Context: "Groupe de 4 amis, location de 6 heures en aout",
    testimonial4Name: "Sarah, Londres",
    testimonial4Text:
      "J'etais nerveuse car je n'avais jamais conduit de bateau, mais l'equipe de Costa Brava Rent a Boat m'a tout explique avec patience. En 15 minutes, je naviguais seule. La sensation de liberte en Mediterranee est incomparable.",
    ...
    faqSpeedAnswer:
      "Les bateaux sans permis equipes d'un moteur de 15 CV atteignent une vitesse maximale d'environ 12-15 noeuds (environ 22-28 km/h). C'est une vitesse confortable et sure pour la navigation cotiere, le mouillage dans les criques et la contemplation du paysage sans se presser.",
    faqChildrenQuestion: "Puis-je emmener des enfants sur un bateau sans permis ?",
    faqChildrenAnswer:
      "Oui, les enfants de tout age sont les bienvenus a bord. Le conducteur doit avoir au moins 18 ans, mais les passagers peuvent etre de tout age. Tous nos bateaux comprennent des gilets de sauvetage de toutes tailles, y compris pour enfants. De nombreuses familles choisissent nos bateaux sans permis precisement pour leur stabilite et leur securite.",
    ...
    howToCostValue: "85 €/h carburant inclus",
    ...
    vsMarketplacesRow5Direct: "Changement de date gratuit jusqu'à 7 jours avant",
    vsMarketplacesRow5Market: "Politique du marketplace + frais de l'armateur",
    vsMarketplacesConclusion:
      "Le prix final via marketplace est généralement 20-35 % supérieur au prix annoncé une fois ajoutés le carburant, la commission et les extras. Nos 85 €/h incluent tout : carburant, équipement, formation, assurance responsabilité civile et assistance au port.",
  },
  categoryLicensed: {
    heroTitle: "Location de bateaux à moteur sans skipper à Blanes : jusqu'à Tossa de Mar, à la barre",
    heroDescription:
      "Trois bateaux à moteur avec permis, de 80 à 115 CV, au Port de Blanes. Vous êtes à la barre avec le permis espagnol Licencia de Navegación ou un titre étranger équivalent, que nous vérifions en ligne avant votre sortie. Dès 175 € les 2 heures.",
    badgeLicense: "La Licencia de Navegación suffit",
    ...
    professionalEquipment: "Équipement complet",
    professionalEquipmentDesc:
      "Équipement de sécurité homologué, auvent pour l'ombre, douche et échelle de bain. Chaque bateau est vérifié entre deux sorties et, avant d'appareiller, nous revoyons ensemble la conduite lors du briefing technique.",
    superiorPerformance: "Pensés pour la journée entière",
    superiorPerformanceDesc:
      "Avec 6 et 7 places et l'autonomie nécessaire pour la journée complète, ils sont le choix des groupes et des familles qui veulent une vraie navigation : à l'heure, en demi-journée ou en journée complète.",
    synonymsTitle: "Hors-bord, bateau à moteur ou bateau avec permis ? C'est la même chose",
    synonymsBody:
      "Sur la Costa Brava, on les appelle des trois façons : hors-bord, bateau à moteur ou bateau avec permis. Ce sont des embarcations à moteur de plus de 15 CV qui exigent un titre nautique. Et louer sans skipper veut dire exactement cela : vous n'embarquez pas de skipper professionnel, parce que le skipper, c'est vous.",
    routeTitle: "De Blanes à Tossa en pilotant vous-même : l'itinéraire",
    routeIntro:
      "Vous quittez le Port de Blanes et, en un quart d'heure, vous êtes face à Lloret de Mar. À partir de là, la côte s'ouvre en criques jusqu'à la baie de Tossa de Mar et son château au-dessus de la mer : 30-45 minutes de trajet avec n'importe lequel de nos bateaux.",
    routeStopLloret: "Lloret de Mar et la plage de Fenals : à 15 minutes du port",
    routeStopSantaCristina: "Cala Santa Cristina et Cala Treumal : mouillage tranquille entre Blanes et Lloret",
    routeStopCanyelles: "Cala Canyelles : la dernière halte avant la section de falaises vers Tossa",
    routeStopTossa: "Tossa de Mar : baie avec château médiéval, à 30-45 minutes à la barre",
    requirementsTitle: "Conditions et Permis",
    acceptedLicenses: "Permis Acceptés",
    licenciaNavegacion: "Licencia de Navegación (LN) : le permis espagnol minimum, il suffit pour toute notre flotte",
    per: "PER (Patrón de Embarcaciones de Recreo)",
    pnb: "PNB (Patrón de Navegación Básica)",
    yachtCaptain: "Capitaine de Yacht (Capitán de Yate)",
    icc: "ICC (certificat international)",
    euEquivalent: "Permis équivalents UE",
    verifierLead: "Un titre d'un autre pays ? Vérifiez-le ici en 30 secondes :",
    additionalRequirements: "Conditions Supplémentaires",
    minAge: "Âge minimum : 18 ans",
    validId: "Pièce d'identité valide",
    validLicense: "Titre nautique en cours de validité (apportez l'original)",
    deposit: "Caution : 500 € (remboursable)",
    technicalBriefing: "Briefing technique inclus",
    fleetTitle: "Notre Flotte Avec Permis",
    comparisonTitle: "Quel bateau choisir ? Comparatif rapide",
    comparisonIntro:
      "Les trois partent du Port de Blanes et se pilotent avec la Licencia de Navegación. Ce qui change, c'est la puissance, le nombre de places et le caractère : ce tableau le résume avec le prix de 2 heures par saison.",
    comparisonBoatName: "Bateau",
    comparisonCapacity: "Places",
    comparisonEngine: "Moteur",
    comparisonBestFor: "Idéal pour",
    comparisonPriceLow: "2h basse saison",
    comparisonPriceHigh: "2h août",
    comparisonMingolla: "Débuter au moteur : agile, facile et le plus économique",
    comparisonTrimarchi: "Caractère sportif italien pour des sorties rythmées",
    comparisonPacific: "Groupes de 7 : le plus grand et le plus stable des trois",
    regulationTitle: "Ce que dit la réglementation",
    regulationIntro:
      "Depuis le RD 875/2014, piloter une embarcation de plaisance de plus de 15 CV exige un titre nautique officiel. Nos trois bateaux dépassent ce seuil : pour les louer sans skipper, vous devez donc présenter votre titre en cours de validité. Avec la Licencia de Navegación, vous pouvez déjà mener toute notre flotte.",
    regulationForeign:
    ...
    howToStep1Title: "Choisissez le bateau et le créneau",
    howToStep1Text:
      "Comparez les trois bateaux du tableau et décidez du nombre d'heures : 2 heures, une demi-journée ou la journée complète. Écrivez-nous par WhatsApp ou réservez depuis le site.",
    howToStep2Title: "Faites vérifier votre titre",
    howToStep2Text:
      "Utilisez le vérificateur en ligne de cette page : vous sélectionnez votre pays et votre titre, et vous savez tout de suite s'il est valable. La Licencia de Navegación espagnole couvre déjà toute la flotte.",
    howToStep3Title: "Venez au Port de Blanes",
    howToStep3Text:
      "Le jour du départ, apportez le titre original, votre pièce d'identité et la caution de 500 €. Le paiement de la location se fait au port, sans passerelle en ligne.",
    howToStep4Title: "Briefing et cap sur Tossa",
    howToStep4Text:
      "Nous passons en revue avec vous le bateau et la zone de navigation en quelques minutes, et vous partez à la barre : Lloret est à 15 minutes et Tossa de Mar à 30-45.",
    howToStep5Title: "Rendez le bateau et récupérez la caution",
    howToStep5Text:
      "Rentrez à l'heure convenue, nous ajustons le carburant selon la consommation réelle et nous vous rendons la caution sur le moment si tout est en ordre.",
    vsMarketplacesTitle: "Réserver en direct ou via une plateforme",
    vsMarketplacesIntro:
      "Nos bateaux figurent aussi sur des portails de location. Le bateau et le port sont les mêmes ; ce qui change, c'est votre interlocuteur avant et pendant votre sortie.",
    vsMarketplacesCol1: "En direct avec nous",
    vsMarketplacesCol2: "Via une plateforme",
    vsMarketplacesRow1Label: "Votre interlocuteur",
    vsMarketplacesRow1Direct: "Les armateurs par WhatsApp, du premier message à la remise du bateau",
    vsMarketplacesRow1Market: "La messagerie du portail et ses délais de réponse",
    vsMarketplacesRow2Label: "Votre titre étranger",
    vsMarketplacesRow2Direct: "Nous le vérifions en ligne avant la réservation",
    vsMarketplacesRow2Market: "Il est contrôlé le jour du départ, au port",
    vsMarketplacesRow3Label: "Garantie mauvais temps",
    vsMarketplacesRow3Direct: "En option à la réservation : nouvelle date ou remboursement en espèces",
    vsMarketplacesRow3Market: "Selon les conditions de chaque portail",
    vsMarketplacesRow4Label: "Changements de date",
    vsMarketplacesRow4Direct: "Gratuits jusqu'à 7 jours avant, en nous parlant directement",
    vsMarketplacesRow4Market: "Gérés par l'intermédiaire",
    vsMarketplacesConclusion:
      "Même bateau et même port : en réservant en direct, vous parlez à celui qui vous remet le bateau, votre titre est vérifié avant votre venue et vous pouvez ajouter la Garantie mauvais temps.",
    faqSinPatronQuestion: "Puis-je louer un bateau sans skipper sur la Costa Brava ?",
    faqSinPatronAnswer:
    ...
    faqTitulacionQuestion: "Quel titre minimum faut-il ? La Licencia de Navegación suffit-elle ?",
    faqTitulacionAnswer:
      "Oui, la Licencia de Navegación (le permis espagnol de base) suffit pour toute notre flotte avec permis. Le PNB, le PER et tout titre supérieur conviennent également, ainsi que les équivalents de l'UE.",
    faqForeignLicenseQuestion: "Mon permis étranger est-il valable (Permis Côtier, SBF See, ICC) ?",
    faqForeignLicenseAnswer:
      "Oui, nous acceptons les titres étrangers équivalents : le Permis Côtier français, le SBF See allemand, l'ICC international et les équivalents des pays de l'EEE. Vérifiez-le avec le vérificateur en ligne de cette page et apportez le titre original le jour du départ.",
    faqPriceQuestion: "Combien coûte la location d'un bateau à moteur à l'heure à Blanes ?",
    faqPriceAnswer:
      "Dès 175 € les 2 heures en basse saison, et dès 210 € en août selon le bateau. La demi-journée et la journée complète ont leurs propres tarifs par saison : le tableau comparatif de cette page et la page des prix en donnent le détail. Le carburant se paie à part.",
    faqFuelQuestion: "Le carburant est-il inclus sur les bateaux avec permis ?",
    faqFuelAnswer:
      "Non. Sur les bateaux avec permis, le carburant se paie à part, selon la consommation réelle de la sortie. L'assurance et l'équipement de sécurité, eux, sont toujours inclus.",
    faqDepositQuestion: "Comment fonctionne la caution de 500 euros ?",
    faqDepositAnswer:
      "Elle est déposée le jour du départ et restituée intégralement lorsque le bateau est rendu dans l'état où il est parti. Il existe aussi une option de caution réduite si vous préférez bloquer un montant plus faible.",
    faqWeatherQuestion: "Que se passe-t-il en cas de mauvais temps le jour de la location ?",
    faqWeatherAnswer:
      "Vous pouvez changer la date gratuitement jusqu'à 7 jours avant le départ. Si le mauvais temps empêche la sortie, nous décalons la date sans frais ou nous vous émettons un bon du montant versé, valable 12 mois. Avec la Garantie mauvais temps souscrite, vous choisissez entre une nouvelle date et le remboursement intégral en espèces.",
    faqCrossLinkLabel: "Voir les bateaux avec permis",
    crossLinkFromFree: "Vous avez un titre ? Des bateaux de 80 à 115 CV jusqu'à Tossa",
    linksTitle: "Continuez à explorer",
    linksBlanes: "Port de Blanes : le point de départ",
    ...
    ctaDescription:
      "Dites-nous le jour, les heures et combien vous êtes, et nous vous confirmons la disponibilité tout de suite. Sans paiement en ligne : vous réservez par WhatsApp et vous payez au port.",
    ctaButton: "Réserver mon bateau",
  },
  blogPage: {
    title: "Blog de Navigation",
    subtitle:
      "Guides, conseils et destinations pour profiter au maximum de votre expérience en bateau sur la Costa Brava",
    ...
    errorDescription:
      "Nous n'avons pas pu charger les articles du blog pour le moment. Veuillez réessayer plus tard.",
    retry: "Réessayer",
    ...
    ctaBanner: "Vous savez quel bateau vous voulez ? R\u00E9servez d\u00E8s 75\u20AC/h",
  ...
  faqPreview: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Le titul\u00EDn est la Licencia de Navegaci\u00F3n : le titre nautique le plus rapide d'Espagne. On l'obtient en un jour avec 2 heures de th\u00E9orie et 4 de pratique \u00E0 bord, sans examen, et il n'expire jamais. Il permet de mener des bateaux jusqu'\u00E0 6 m\u00E8tres, de jour et jusqu'\u00E0 2 milles d'un abri : dans notre flotte, le Mingolla Brava 19, le Trimarchi 57S et le Pacific Craft 625. Nous organisons le cours et le combinons \u00E0 votre premi\u00E8re location ; \u00E9crivez-nous et nous vous expliquons.",
      },
      {
        id: "precios",
      ...
      },
      {
        ...
        answer:
          "Bien sûr ! Vous pouvez apporter votre propre nourriture, boissons et en-cas. Nous avons une glacière à bord. Nous demandons simplement de ne pas utiliser de verre pour des raisons de sécurité.",
      },
      {
        id: "fianza",
        question: "Qu'est-ce que la caution et quand est-elle rendue ?",
        answer:
          "La caution est un dépôt de garantie (200-500€ selon le bateau) payé au port avant le départ et intégralement restitué au retour si le bateau est en bon état.",
      },
      {
        id: "equipamiento-seguridad",
        question: "Quel équipement de sécurité est inclus ?",
        answer:
          "Tous nos bateaux comprennent des gilets de sauvetage pour tous les passagers, une trousse de premiers secours, un extincteur, une ancre et un kit de signalisation conforme à la réglementation.",
      },
      {
        id: "descuentos",
        question: "Y a-t-il des réductions pour les groupes ou les réservations anticipées ?",
        answer:
          "Le prix affiché est le prix final : nous n'utilisons pas de codes de réduction. Les sorties à la journée reviennent moins cher à l'heure que les demi-journées, et pour les grands groupes nous préparons un devis par WhatsApp.",
      },
      {
        id: "hasta-donde",
        question: "Jusqu'où puis-je naviguer ?",
        answer:
          "Vous pouvez explorer toute la côte entre Blanes et Tossa de Mar. Nous vous recommandons les criques de Sa Forcanera, Cala Bona et Cala Sant Francesc, accessibles uniquement par la mer.",
      },
    ],
  },
  ...
  holdCountdown: {
    ...
    hurry: "Dépêchez-vous",
    expiredSoft:
      "Votre sélection a peut-être changé. Vous pouvez continuer, mais nous vous recommandons de vérifier la disponibilité.",
  ...
  confirmation: {
    ...
    whatsNextSteps: [
      "Vous recevrez une confirmation par WhatsApp en moins de 2 heures",
  ...
  reciprocity: {
    ...
    captainTipText:
      "Si c'est votre première fois, choisissez un bateau sans permis pour 4h le matin. La mer est plus calme et vous aurez largement le temps d'explorer 2-3 criques.",
    ...
    freeGuideSubtitle:
      "Recevez notre guide des 10 meilleures criques de la Costa Brava accessibles uniquement en bateau",
  ...
  pricingPage: {
    ...
    info: {
      ...
      minPerHour:
        "Les tarifs affichés sont le <strong>minimum par heure</strong>. Selon la durée choisie, le prix horaire peut varier.",
      deposit:
        "Une <strong>caution</strong> est demandée et restituée à la fin de la location sans incident.",
      freeCancellation:
    ...
    faq: {
      ...
      a4Template:
        "Les bateaux avec permis à Blanes coûtent à partir de {licBaja2h} €/2h en basse saison. La Licencia de Navegación (LN) suffit, comme tout titre supérieur. Ce sont des bateaux plus puissants avec une plus grande autonomie pour explorer la Costa Brava.",
    },
    cta: {
      title: "Réservez votre bateau au meilleur tarif",
      subtitle: "Choisissez votre bateau, date et horaire. Nous confirmons en moins de 2 heures.",
  ...
  locationBarcelona: {
    hero: {
      ...
      description:
        "À seulement 70 minutes de Barcelone, le Port de Blanes vous offre la meilleure expérience nautique de la Costa Brava. Bateaux sans permis à partir de {noLicBaja1h} € avec essence incluse.",
    ...
    whyBlanes: {
      ...
      betterPricesBody:
        "À Blanes, les bateaux sans permis coûtent à partir de {noLicBaja1h} €/heure avec essence incluse. À Barcelone, les prix commencent à partir de 120-150 €/heure sans essence. Vous économisez jusqu'à 50 % sur la location.",
      crystalWatersTitle: "Eaux cristallines",
      crystalWatersBody:
        "La Costa Brava offre des eaux transparentes et turquoise que vous ne trouverez pas sur le littoral de Barcelone. Criques cachées, fonds rocheux pour le snorkeling et paysages naturels spectaculaires.",
      lessTrafficTitle: "Moins de trafic maritime",
      lessTrafficBody:
        "Le port de Barcelone connaît un trafic intense de ferries, de bateaux de croisière et d'embarcations commerciales. À Blanes, vous naviguez tranquillement dans des eaux propres et sans foule.",
      realCostaBravaTitle: "La véritable Costa Brava",
      realCostaBravaBody:
        "Depuis Blanes, vous pouvez explorer des criques secrètes comme Cala Sant Francesc, rejoindre Lloret de Mar ou même Tossa de Mar. C'est la porte d'entrée de la vraie Costa Brava, avec ses falaises, ses pins et ses eaux couleur émeraude.",
    },
    howToGet: {
      ...
      carBody:
        "Prenez l'autoroute AP-7 direction Girona/France. Sortie 9 (Blanes). Parking gratuit près du port.",
      trainTitle: "En train",
      trainDuration: "<strong>90 minutes</strong> RENFE Rodalies",
      trainBody:
        "Ligne R1 depuis Barcelona Sants ou Passeig de Gràcia jusqu'à Blanes. Trains toutes les 30 minutes. Gare à 10 min du port.",
      busTitle: "En bus",
      busDuration: "<strong>80 minutes</strong> depuis Estación del Nord",
      busBody:
        "Bus directs depuis l'Estación del Nord de Barcelone. Plusieurs fréquences quotidiennes en période estivale.",
    },
    boats: {
      title: "Nos bateaux",
      noLicenseTitle: "Bateaux sans permis",
      noLicenseBody:
        "4 embarcations pour 4-5 personnes. Aucune expérience préalable ni permis requis. Nous vous donnons une formation de 15 minutes et vous êtes prêt à naviguer. Essence incluse dans le prix.",
      ...
      licensedBody:
        "3 embarcations puissantes pour jusqu'à 7 personnes. La Licencia de Navegación (LN) suffit, comme tout titre supérieur. Plus d'autonomie et de vitesse pour explorer toute la Costa Brava.",
    ...
    cta: {
      ...
      subtitle:
        "À seulement 70 minutes de Barcelone. Bateaux sans permis à partir de {noLicBaja1h} € avec essence incluse. Eaux cristallines et criques secrètes vous attendent.",
    ...
    blog: {
      ...
      description:
        'Découvrez-en plus sur la navigation en Costa Brava dans notre <a href="{blogPath}" class="text-primary hover:underline font-medium">blog nautique</a>.',
    },
  },
  whatsappMessages: {
    bookingWithBoatAndPrice:
      "Bonjour ! Je souhaiterais réserver le {boatName} (à partir de {price}€). Pourriez-vous m'aider concernant les disponibilités et les tarifs ? Merci !",
    bookingWithBoat:
      "Bonjour ! Je souhaiterais réserver le {boatName}. Pourriez-vous m'aider concernant les disponibilités et les tarifs ? Merci !",
    bookingGeneric:
      "Bonjour ! J'aimerais faire une réservation pour louer un bateau. Pourriez-vous m'aider concernant les disponibilités et les tarifs ?",
  },
  seoSchemas: {
    seasonalEvent: {
    ...
    coves: {
      ...
      descriptions: {
        ...
        saForcanera:
          "Crique sauvage rocheuse avec fond de gravier. Biodiversité marine riche, idéale pour le snorkeling.",
        calaSantFrancescBlanes:
          "Crique avec pins jusqu'au sable et eaux turquoise. Protégée du vent du nord. Idéale pour un premier snorkeling.",
        calaDeSAgulla:
          "Petite crique semi-sauvage, accès difficile par la terre. Eau transparente.",
        calaTreumal:
          "Crique rocheuse avec pins, eaux cristallines. Mouillage tranquille. Accès à pied par le chemin de ronde.",
        playaDeSantaCristina:
          "Plage familiale tranquille avec pinède. Services de plage en saison. Fond sablonneux.",
        calaSaBoadella:
  ...
  boatFaq: {
    ...
    a3None:
      "Non, le {name} ne nécessite pas de permis bateau. Vous devez simplement avoir plus de 18 ans. Avant de prendre le large, vous recevrez une formation de 15 minutes sur le maniement du bateau.",
    a3Captained:
      "Vous n'avez besoin ni de permis ni d'expérience : le {name} navigue toujours avec notre capitaine professionnel. Vous montez à bord et profitez du voyage.",
    a3Licensed:
      "Oui, le {name} nécessite un {license}. Vous devrez présenter votre titre en cours de validité avant de prendre le large.",
    ...
    viewpoints: [
      {
        ...
        description:
          "Jetez l'ancre face à Cala Sant Francesc et regardez le soleil disparaître derrière les collines de Blanes. Les falaises reçoivent la lumière dorée de façon spectaculaire et l'eau passe de l'ambre au rose.",
        distance: "20 minutes depuis le port",
      },
      {
        name: "Large face à Sa Palomera",
        description:
          "Positionnez le bateau face au rocher emblématique de Sa Palomera à Blanes. Tandis que le soleil se couche derrière le village, le rocher crée une silhouette spectaculaire sur le ciel orangé.",
    ...
    romanticIdeas: [
      {
        ...
        description:
          "Préparez du fromage, de la charcuterie, des olives, du pain et une bouteille de cava ou de vin. Savourez l'apéritif en flottant dans une crique pendant que le ciel change de couleur.",
      },
      {
        title: "Musique à bord",
        description:
          "Emportez une petite enceinte Bluetooth avec une playlist soigneusement choisie. Du jazz doux, de la guitare acoustique ou de la musique électronique relaxante s'accordent parfaitement avec l'heure dorée.",
      },
      {
        title: "Capturez l'instant",
        description:
          "La lumière de l'heure dorée (30-60 minutes avant le coucher de soleil) est la plus flatteuse pour les photos. Utilisez le mode portrait de votre téléphone pour des résultats spectaculaires.",
      },
      {
  ...
  activitySnorkel: {
    faqItems: [
      {
        ...
        answer:
          "Oui. Nous proposons des kits de snorkeling (masque, tuba et palmes) pour 7,50 € par personne. Le matériel est récupéré à l'embarquement et rendu à la fin de la location. Vous pouvez également apporter votre propre équipement sans frais supplémentaires.",
      },
      {
        question: "Quelle est la meilleure période pour faire du snorkeling à Blanes ?",
        answer:
          "De juin à septembre, la température de l'eau oscille entre 22 et 26 degrés, idéale pour le snorkeling sans combinaison. La meilleure visibilité se situe en juin et septembre, lorsqu'il y a moins de fréquentation et que l'eau est plus calme. En juillet et août, l'eau est plus chaude mais il peut y avoir plus de houle les jours de vent.",
      },
      {
        question: "Est-il sûr de faire du snorkeling depuis le bateau sans expérience ?",
        answer:
          "Tout à fait. Avant de partir, nous vous donnons une formation à la sécurité de 15 minutes où nous expliquons comment mouiller le bateau correctement. Tous les bateaux sont équipés de gilets de sauvetage. Nous recommandons le snorkeling dans des criques protégées comme Cala Sant Francesc pour les débutants.",
      },
      {
        question: "Combien de criques puis-je visiter lors d'une sortie snorkeling ?",
        answer:
          "En 2 heures, vous pouvez visiter 1 à 2 criques avec suffisamment de temps pour le snorkeling. En 4 heures, vous pouvez faire un circuit complet de 3 à 4 criques. Nous recommandons un minimum de 3 heures pour profiter du snorkeling et de la navigation sans être pressé.",
      },
    ],
    spots: [
      {
        ...
        depth: "2-8 mètres",
        highlights:
          "Posidonie océanique, sars, oblades, étoiles de mer. Fond mixte de sable et roche avec une excellente visibilité.",
        ideal:
          "Idéale pour les débutants et les familles grâce à son eau cristalline et son faible courant.",
      },
      {
        name: "Cala Bona",
        ...
        depth: "3-10 mètres",
        highlights:
          "Formations rocheuses, mérous juvéniles, poulpes, nudibranches. Parois immergées avec une vie marine abondante.",
        ideal:
          "Parfaite pour le snorkeling intermédiaire. Mouiller le bateau et explorer la côte rocheuse.",
      },
      {
        name: "Cala Treumal",
        distance: "25 minutes depuis le port",
        depth: "2-6 mètres",
        highlights:
          "Herbiers de posidonie, hippocampes (espèce protégée), bancs de castagnoles et demoiselles.",
        ideal:
          "La crique la plus tranquille pour un snorkeling relaxant. Eau turquoise et peu de fréquentation.",
      },
    ],
    recommendedBoats: [
      {
      ...
      },
      {
        ...
        description:
          "Plus grande autonomie pour visiter plusieurs criques en une seule sortie. Idéaux pour les groupes qui souhaitent combiner snorkeling et navigation vers Lloret ou Tossa.",
      },
    ],
    depthLabel: "Profondeur :",
    heroTitle: "Excursion Snorkeling en Bateau depuis Blanes",
    heroDescription:
      "Découvrez les fonds marins de la Costa Brava depuis nos bateaux au Port de Blanes. Naviguez jusqu'aux plus belles criques, jetez l'ancre et plongez dans des eaux cristallines avec une visibilité jusqu'à 15 mètres. Équipement de snorkeling disponible pour 7,50 €/personne.",
    ...
    rentalTitle: "Location supplémentaire : 7,50 €/personne",
    rentalItems: [
    ...
    faqItems: [
      {
        ...
        answer:
          "Il n'y a pas d'âge minimum. Les bébés et les enfants de tout âge sont les bienvenus. Tous les mineurs doivent porter un gilet de sauvetage homologué pendant la navigation. Pour les bébés, nous recommandons des sorties courtes de 1 à 2 heures et de choisir des jours de mer calme.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Nous recommandons d'apporter : crème solaire haute protection (waterproof), casquettes ou chapeaux, eau en abondance, collations ou pique-nique, serviettes, maillots de bain et des vêtements de rechange secs. Optionnel : appareil photo étanche, jouets de plage et équipement de snorkeling personnel.",
      },
    ],
    safetyFeatures: [
      {
        ...
        description:
          "Tous les bateaux sont équipés de gilets homologués pour enfants de tous âges et toutes tailles. Le port est obligatoire pour les mineurs pendant la navigation.",
      },
      {
      ...
      },
      {
        ...
        description:
          "La côte entre Blanes et Lloret offre des criques protégées de la houle. Nous recommandons des criques tranquilles où les enfants peuvent se baigner en toute sécurité.",
      },
    ],
    familyRoutes: [
      {
  ...
  activityFishing: {
    faqItems: [
      {
        ...
        answer:
          "Non. Vous devez apporter votre propre équipement de pêche (cannes, moulinets, leurres, appâts). Nos bateaux fournissent la plateforme de navigation, mais n'incluent pas de matériel de pêche. À Blanes, il y a des magasins nautiques près du port où vous pouvez acheter des appâts frais et du matériel de base.",
      },
      {
        question: "Ai-je besoin d'un permis de pêche pour pêcher depuis le bateau ?",
        answer:
          "Oui. Pour la pêche récréative en mer, vous avez besoin du permis de pêche récréative maritime de la Generalitat de Catalunya. Vous pouvez l'obtenir en ligne sur gencat.cat pour environ 14 € (validité 2 ans). Il est différent du permis de navigation : le permis de pêche est pour pêcher, celui de navigation pour piloter le bateau.",
      },
      {
    ...
    recommendedBoats: [
      {
        ...
        price: "À partir de 90 €/heure (essence non incluse)",
        advantages: [
    ...
    fishingSpots: [
      {
        ...
        description:
          "Les formations rocheuses face à Sa Palomera sont un classique pour le spinning côtier. Fonds de 5-15 mètres très poissonneux.",
      },
      {
        ...
        description:
          "Fonds mixtes de roche et sable entre 10-25 mètres. Excellent pour la pêche au fond avec appât naturel.",
      },
      {
    ...
    licenseDesc:
      "Pour pêcher en mer depuis un bateau, vous avez besoin du permis de pêche récréative maritime de la Generalitat de Catalunya. Vous pouvez l'obtenir en ligne sur gencat.cat pour environ 14 € avec une validité de 2 ans.",
  ...
  faqPage: {
    ...
    heroDescription:
      "Trouvez les réponses à toutes vos questions sur la location de bateaux à Blanes, Costa Brava. Si vous ne trouvez pas ce que vous cherchez, contactez-nous directement !",
    schemaName: "Questions Fréquentes - Location de Bateaux à Blanes",
    schemaDescription:
      "Répondez à toutes vos questions sur la location de bateaux à Blanes, Costa Brava",
    whatsappGenericMessage:
      "Bonjour, j'ai une question concernant la location de bateaux. Pourriez-vous m'aider ?",
    filterLabel: "Filtrer par catégorie",
    contactTitle: "D'autres questions ?",
    contactDesc:
      "Si vous n'avez pas trouvé la réponse que vous cherchiez, nous sommes là pour vous aider. Notre équipe répond rapidement et se fera un plaisir de répondre à toutes vos questions.",
    ...
    items: {
      ...
      pago: {
        ...
        answer:
          "Nous acceptons les cartes de crédit/débit (Visa, Mastercard), le virement bancaire, les espèces (uniquement au port, avant le départ) et Bizum (pour les clients espagnols). Un acompte de 50€ est requis pour confirmer la réservation.",
      },
      cancelacion: {
        question: "Quelle est la politique d'annulation ?",
        answer:
      ...
      titulin: {
        question: "Qu'est-ce que le titulín et comment l'obtenir ?",
        answer:
          "Le titulín est la Licencia de Navegación : le permis bateau le plus rapide d'Espagne. Il s'obtient en une journée avec 2 heures de théorie et 4 heures de pratique dans une école nautique agréée, sans examen, et il n'expire jamais. Il permet de piloter des bateaux jusqu'à 6 mètres, de jour et jusqu'à 2 milles d'un abri : dans notre flotte, il couvre la Mingolla Brava 19, la Trimarchi 57S et la Pacific Craft 625. Écrivez-nous et nous vous indiquerons où le passer près de Blanes.",
      },
      licenciasAceptadas: {
        question: "Quels permis acceptez-vous pour les grands bateaux ?",
        answer:
          "Pour les bateaux avec permis, la Licencia de Navegación (LN), le permis espagnol minimum, suffit : elle couvre toute notre flotte. Nous acceptons aussi le PNB (Patrón de Navegación Básica), le PER (Patrón de Embarcaciones de Recreo), le Capitaine de Yacht, les permis européens équivalents (le Permis Côtier français est accepté) et les permis internationaux homologués comme l'ICC. Vous devez présenter le permis original le jour de la location.",
      },
      edadMinima: {
        question: "Quel est l'âge minimum pour louer ?",
        answer:
          "Le pilote doit avoir au minimum 18 ans. Les passagers n'ont pas de limite d'âge (avec un adulte responsable). Les moins de 12 ans doivent porter un gilet de sauvetage obligatoire. Le pilote doit présenter une carte d'identité ou un passeport valide.",
      },
      experiencia: {
        question: "Ai-je besoin d'une expérience préalable de navigation ?",
        answer:
          "Aucune expérience préalable n'est nécessaire. Nous fournissons une explication complète du fonctionnement, une carte de la zone autorisée, des conseils de sécurité, un contact direct pour les urgences et des embarcations faciles à manœuvrer.",
      },
      queIncluye: {
        question: "Qu'est-ce qui est inclus dans le prix ?",
        answer:
      ...
      extras: {
        ...
        answer:
          "Extras disponibles : Paddle Surf (+30€), Masque de snorkeling (+5€), Caméra aquatique GoPro (+30€) et Skipper professionnel (+100€).",
      },
      queLlevar: {
        question: "Que dois-je apporter ?",
        answer:
          "Indispensable : carte d'identité ou passeport, permis bateau (si applicable), crème solaire, casquette/chapeau et serviettes. Recommandé : nourriture et boissons, lunettes de soleil, chaussures antidérapantes, vêtements de rechange et appareil photo/téléphone dans un sac étanche.",
      },
      porDondeNavegar: {
      ...
      seguridad: {
        ...
        answer:
          "Gilets de sauvetage homologués pour tous, kit de sécurité réglementaire, GPS et traceur sur les grands bateaux, signalisation maritime complète, contact 24h pour les urgences et révisions quotidiennes des embarcations.",
      },
      malTiempo: {
      ...
      emergencia: {
        ...
        answer:
          "Procédure d'urgence : 1) Gardez votre calme, 2) Appelez-nous immédiatement au +34 611 500 372, 3) Nous localiserons votre position grâce aux GPS installés sur nos bateaux. Numéros d'urgence inclus dans le briefing.",
      },
      horarios: {
        question: "Quels sont les horaires disponibles ?",
        answer:
          "Horaires de location : Matinée (09:00 - 13:00), Après-midi (14:00 - 18:00), Journée complète (09:00 - 17:00), Coucher de soleil (18:00 - 21:00). Les horaires peuvent varier selon la saison et la disponibilité.",
      },
      llegadaPuerto: {
        question: "Quand dois-je arriver au port ?",
        answer:
          "Nous recommandons d'arriver 30 minutes avant l'heure de départ pour l'enregistrement et la vérification des documents, le briefing de sécurité complet, l'explication du fonctionnement, la remise du matériel et de la carte, et répondre aux dernières questions.",
      },
      parking: {
        question: "Y a-t-il un parking disponible ?",
        answer:
          "Options de stationnement : Parking du Port 10€/location (dans le port et devant le bateau), Zone bleue 1,5€/heure (10 min à pied), Parking gratuit (20/30 min à pied). En haute saison nous recommandons de réserver une place.",
      },
      equipaje: {
        question: "Puis-je laisser des bagages au port ?",
        answer:
          "Options pour les bagages : dans l'embarcation (espace limité mais sécurisé), consignes du port (5€/jour par valise), hôtel/appartement (nous recommandons de laisser les gros bagages). Évitez d'emporter des objets de valeur.",
      },
      temporada: {
        question: "Quand est ouverte la saison ?",
        answer:
          "Haute saison : Juin - Septembre. Moyenne saison : Avril-Mai et Octobre. Fermé : Novembre - Mars. La meilleure période est mai-juin et septembre (moins de monde, beau temps).",
      },
      disponibilidad: {
        question: "Comment puis-je consulter les disponibilités ?",
        answer:
          "Vous pouvez consulter les disponibilités via notre site web (calendrier en temps réel), WhatsApp (réponse immédiate), téléphone (appel direct) ou email (demandes détaillées).",
      },
      antelacion: {
        question: "Avec quelle anticipation dois-je réserver ?",
        answer:
          "Recommandations : Haute saison 1-2 semaines minimum, week-ends 3-5 jours, en semaine réservation du jour possible, grands groupes anticipation maximale. En juillet-août réserver au moins 2 semaines à l'avance.",
      },
      comidaBebida: {
        question: "Puis-je apporter de la nourriture et des boissons à bord ?",
        answer:
          "Bien sûr ! Vous pouvez apporter votre propre nourriture, boissons et snacks. Nous avons une glacière à bord. Nous demandons simplement de ne pas utiliser de verre pour des raisons de sécurité.",
      },
      fianza: {
        question: "Qu'est-ce que la caution et quand est-elle remboursée ?",
        answer:
          "La caution est un dépôt de garantie (200-500€ selon le bateau) qui est payé au port avant le départ et remboursé intégralement au retour si le bateau est en bon état.",
      },
      equipoSeguridad: {
        question: "Quel équipement de sécurité est inclus dans le bateau ?",
        answer:
          "Tous nos bateaux incluent des gilets de sauvetage pour tous les passagers, une trousse de premiers secours, un extincteur, une ancre et un kit de signalisation conforme à la réglementation.",
      },
      descuentos: {
        question: "Y a-t-il des réductions pour les groupes ou les réservations anticipées ?",
        answer:
      ...
      mascotas: {
        ...
        answer:
          "Oui, les animaux sont les bienvenus sur nos bateaux. Nous recommandons d'apporter de l'eau fraîche et une serviette pour votre animal. L'animal doit porter un gilet de sauvetage si disponible.",
      },
      pesca: {
        question: "Peut-on pêcher depuis le bateau ?",
        answer:
          "Oui, vous pouvez pêcher depuis nos bateaux. Vous aurez besoin de votre propre permis de pêche récréative. Nous ne fournissons pas d'équipement de pêche, mais vous pouvez apporter le vôtre.",
      },
      diferenciaLicencia: {
      ...
      mejorEpoca: {
        ...
        answer:
          "Septembre est le mois idéal : l'eau de mer est à sa température la plus chaude (24-25°C), les prix sont en moyenne saison, il y a moins de touristes et les conditions météorologiques sont excellentes. Juin et la première quinzaine de juillet sont également de très bonnes options.",
      },
    },
  },
  blogDetail: {
    ...
    newsletterSubtitle:
      "Recevez notre guide des meilleures criques accessibles uniquement en bateau",
    ...
    relatedTossaDesc: "Vila Vella médiévale et les plus belles criques de la Costa Brava.",
  },
  legalPages: {
    legalDisclaimer:
      "Ce texte est disponible en plusieurs langues. En cas de divergence ou d'ambiguïté dans la traduction, la version en castillan (espagnol) prévaut à toutes fins juridiques.",
    privacy: {
      ...
      sections: [
        {
          ...
          body: "Identité : DAMAR COSTA BRAVA S.L. (marque commerciale Costa Brava Rent a Boat)\nNuméro fiscal (CIF) : B22566327\nAdresse : Carrer Delícia, 1, 17310 Lloret de Mar, Gérone, Espagne\nTéléphone : +34 611 500 372\nCourriel de contact : info@costabravarentaboat.com",
        },
        {
          title: "2. Données personnelles que nous collectons",
          body: "Données fournies par l'utilisateur lors d'une réservation :\n- Nom et prénoms\n- Numéro de téléphone\n- Adresse e-mail\n- Date et heure de la réservation, embarcation sélectionnée et nombre de personnes\n\nDonnées collectées automatiquement :\n- Données de navigation (adresse IP, type de navigateur, pages visitées) via Google Analytics\n- Cookies techniques et de préférence (langue sélectionnée)\n\nNous ne collectons pas de données de catégories particulières (santé, origine raciale, opinions politiques, etc.) ni de données de mineurs de moins de 14 ans.",
        },
        {
        ...
        },
        {
          ...
          body: "- Données de réservation : 5 ans à compter de la date du service (RD 1619/2012, Loi 58/2003 Générale des Impôts).\n- Communications par WhatsApp/e-mail : 1 an à compter de la dernière communication, sauf réclamation en cours.\n- Données d'analyse web (Google Analytics) : selon la configuration de rétention de Google Analytics (par défaut, 14 mois).\n- Cookies de session : supprimés à la fermeture du navigateur.",
        },
        {
          title: "5. Destinataires et transferts internationaux",
          body: "Vos données peuvent être communiquées aux sous-traitants suivants :\n\n- SendGrid (Twilio Inc., États-Unis) : Service d'envoi d'e-mails de confirmation et de rappels. Transfert international couvert par les Clauses Contractuelles Types approuvées par la Commission Européenne.\n- Google LLC (États-Unis) : Google Analytics et Google Tag Manager. Uniquement si l'utilisateur a donné son consentement via la bannière de cookies. Transfert couvert par le Cadre de Confidentialité des Données UE-États-Unis.\n- Stripe Inc. (États-Unis) : Traitement des paiements par carte, le cas échéant. Nous ne stockons pas les données de carte ; Stripe agit en tant que sous-traitant indépendant sous PCI-DSS.\n- WhatsApp (Meta Platforms Ireland Ltd.) : Canal de communication pour la gestion des réservations. Les communications initiées par l'utilisateur sur WhatsApp sont soumises à la politique de confidentialité de WhatsApp.\n\nNous ne vendons ni ne cédons vos données à des tiers à des fins commerciales.",
        },
        {
          title: "6. Vos droits (ARCO+)",
          body: "En vertu des articles 15 à 22 du RGPD et de la LOPD-GDD, vous avez le droit de :\n\n- Accès : obtenir la confirmation que nous traitons vos données et, le cas échéant, une copie.\n- Rectification : demander la correction de données inexactes.\n- Suppression (« droit à l'oubli ») : demander l'effacement de vos données lorsqu'elles ne sont plus nécessaires aux finalités pour lesquelles elles ont été collectées, sauf obligation légale de conservation.\n- Opposition : vous opposer au traitement fondé sur l'intérêt légitime.\n- Limitation du traitement : demander que nous suspendions le traitement pendant la résolution d'une réclamation.\n- Portabilité : recevoir vos données dans un format structuré et lisible par machine.\n- Retrait du consentement : vous pouvez retirer à tout moment le consentement donné (par ex., pour les cookies analytiques) sans que cela n'affecte la licéité du traitement antérieur.\n\nComment exercer vos droits : envoyez un e-mail à info@costabravarentaboat.com en indiquant le droit que vous souhaitez exercer et en joignant une copie de votre pièce d'identité ou autre document d'identification. Nous vous répondrons dans un délai maximum d'1 mois.\n\nSi vous estimez que le traitement n'est pas conforme au RGPD, vous avez le droit de déposer une réclamation auprès de l'Agence Espagnole de Protection des Données (AEPD) : www.aepd.es",
        },
        {
          title: "7. Mesures de sécurité",
          body: "Nous appliquons des mesures techniques et organisationnelles appropriées pour protéger vos données contre les accès non autorisés, la perte ou la destruction accidentelle, conformément à l'art. 32 du RGPD :\n- Transmission chiffrée via HTTPS (TLS 1.2+)\n- Accès restreint aux données par authentification\n- En-têtes de sécurité HTTP (Content-Security-Policy, X-Frame-Options, etc.)\n- Limitation du débit de requêtes (rate limiting) pour prévenir les attaques",
        },
        {
          title: "8. Cookies",
          body: "Pour des informations détaillées sur les cookies que nous utilisons, consultez notre Politique relative aux Cookies.",
        },
        {
          title: "9. Modifications de cette politique",
          body: "Nous pouvons mettre à jour cette politique de confidentialité pour refléter des changements légaux ou dans nos services. Nous vous informerons des changements importants par un avis sur le site web. La date de dernière mise à jour apparaîtra toujours au début de ce document.",
        },
      ],
    },
    cookies: {
      ...
      sections: [
        {
          title: "Introduction",
          body: "Conformément aux dispositions de l'article 22.2 de la Loi 34/2002, du 11 juillet, relative aux Services de la Société de l'Information et au Commerce Électronique, ce site web vous informe, dans cette section, de la politique de collecte et de traitement des cookies.",
        },
        {
          title: "Qu'est-ce qu'un cookie ?",
          body: "Un cookie est un fichier qui se télécharge sur votre ordinateur lors de l'accès à certaines pages web. Les cookies permettent à une page web, entre autres choses, de stocker et de récupérer des informations sur les habitudes de navigation d'un utilisateur ou de son équipement et, selon les informations qu'ils contiennent et la façon dont vous utilisez votre équipement, ils peuvent être utilisés pour reconnaître l'utilisateur.",
        },
        {
          title: "Quels types de cookies ce site web utilise-t-il ?",
          body: "Ce site web utilise les types de cookies suivants :\n\nCookies d'analyse : Ce sont ceux qui, traités par nous ou par des tiers, nous permettent de quantifier le nombre d'utilisateurs et ainsi de réaliser la mesure et l'analyse statistique de l'utilisation que font les utilisateurs du service proposé.\n\nCookies techniques : Ils permettent à l'utilisateur de naviguer dans l'espace restreint et d'utiliser ses différentes fonctions, comme par exemple effectuer le processus de réservation d'une embarcation.\n\nCookies de personnalisation : Ils permettent à l'utilisateur d'accéder au service avec certaines caractéristiques générales prédéfinies en fonction d'une série de critères tels que la langue ou le type de navigateur.\n\nCookies publicitaires : Traités par ce site ou par des tiers, ils permettent de gérer de la manière la plus efficace possible l'offre des espaces publicitaires présents sur la page web.\n\nCookies tiers : Nous utilisons les services de Google Analytics pour nos statistiques. Certains cookies sont essentiels au fonctionnement du site. Notre site inclut d'autres fonctionnalités fournies par des tiers (partage sur les réseaux sociaux tels que Facebook, Instagram ou TikTok).",
        },
        {
          title: "Désactiver les cookies",
          body: "Vous pouvez autoriser, bloquer ou supprimer les cookies installés sur votre équipement en configurant les options du navigateur installé sur votre ordinateur. Dans la plupart des navigateurs web, il est possible d'autoriser, de bloquer ou de supprimer les cookies installés sur votre équipement.\n\nVous pouvez accéder aux paramètres des navigateurs web les plus courants pour accepter, installer ou désactiver les cookies : Google Chrome, Microsoft Internet Explorer, Mozilla Firefox, Safari (Apple), Opera.",
        },
        {
          title: "Avertissement concernant la suppression des cookies",
          body: "Vous pouvez supprimer et bloquer tous les cookies de ce site, mais une partie du site ne fonctionnera pas ou la qualité de la page web pourra être affectée.",
        },
        {
          title: "Contact",
          body: "Si vous avez des questions concernant notre politique relative aux cookies, vous pouvez nous contacter via nos canaux de contact disponibles dans la section contact du site web.",
        },
      ],
    },
    condicionesGeneralesPage: {
      langNoticeBody:
        "Le contrat de location est rédigé en espagnol, qui est la version qui prévaut. Vous pouvez lire les clauses équivalentes traduites dans votre langue dans les {termsLink}.",
      langNoticeLink: "Conditions Générales du site",
    },
      ...
      sections: [
        {
          ...
          body: "Raison sociale : DAMAR COSTA BRAVA S.L. (exploitant sous la marque commerciale Costa Brava Rent a Boat)\nNuméro fiscal (CIF) : B22566327\nSiège social : Carrer Delícia, 1, 17310 Lloret de Mar, Gérone, Espagne\nTéléphone de contact : +34 611 500 372\nCourrier électronique : info@costabravarentaboat.com\nActivité : location de bateaux de plaisance (avec et sans permis nautique) au Port de Blanes, Costa Brava.",
        },
        {
          title: "2. Objet",
          body: "Les présentes Conditions Générales régissent la relation contractuelle entre Costa Brava Rent a Boat (ci-après, « le prestataire ») et toute personne utilisant le site web costabravarentaboat.com ou contractant les services de location d'embarcations (ci-après, « le client »).\n\nL'utilisation du site web et la formalisation d'une réservation impliquent l'acceptation pleine et entière des présentes conditions.",
        },
        {
          title: "3. Processus de réservation",
          body: "Le site recueille des demandes de réservation. Le client remplit un formulaire avec la date, le bateau, la durée et ses coordonnées. Le prestataire confirme manuellement la disponibilité et envoie un message de confirmation par WhatsApp ou par courrier électronique.\n\nPour la location de bateaux, le paiement se fait sur place au Port de Blanes, au moment de l'embarquement : le site ne prélève pas automatiquement le montant de la location. Les produits de la boutique et les cartes cadeaux se paient en revanche en ligne par carte au moment de l'achat, conformément aux sections 13 à 17.\n\nLa réservation n'est ferme qu'après confirmation explicite du prestataire.",
        },
        {
          title: "4. Conditions requises pour le locataire",
          body: "- Le capitaine doit être âgé de plus de 18 ans et présenter une carte d'identité ou un passeport en cours de validité.\n- Pour les embarcations avec permis, le capitaine doit présenter le permis nautique original (Licencia de Navegación, PER, PNB, Capitaine de Yacht ou équivalent européen).\n- Pour les embarcations sans permis, aucun titre n'est requis, mais le capitaine recevra une formation de 15 minutes avant de prendre la mer.\n- Les mineurs doivent être accompagnés d'un adulte responsable et porter un gilet de sauvetage obligatoire pendant la navigation.",
        },
        {
          title: "5. Caution et conditions de paiement",
          body: "Avant l'appareillage, une caution est versée (200 € pour les bateaux sans permis et 500 € pour ceux qui en exigent un), restituée intégralement au retour si le bateau est rendu dans l'état où il a été reçu. Le montant applicable est toujours celui indiqué au moment de la réservation et dans le contrat signé au port.\n\nLe client peut souscrire volontairement la Caution réduite, qui abaisse le montant retenu contre un prix forfaitaire. Il s'agit d'une garantie commerciale propre et non d'un contrat d'assurance ; son prix n'est pas remboursable.\n\nEn cas de dommages, de perte de matériel ou de non-respect de la zone de navigation autorisée, le prestataire pourra retenir tout ou partie de la caution pour couvrir les frais.",
        },
        {
          title: "6. Zone de navigation et durée",
          body: "Zones autorisées : au nord jusqu'à la plage de Fenals (sans permis) ou Sant Feliu de Guíxols (avec permis) ; au sud jusqu'à l'embouchure du fleuve Tordera, à l'extrémité de la plage de Blanes (sans permis), ou sans limite (avec permis). Maximum 2 milles nautiques de la côte pour les bateaux sans permis.\n\nLa vitesse maximale dans les ports et dans les chenaux balisés des plages est de 3 nœuds. Il faut respecter la zone de baignade, mouiller en dehors des bouées jaunes, naviguer à plus de 200 m des plages et des falaises et garder 100 m de distance avec les bouées de plongeurs.\n\nLes bateaux devront regagner le Port de Blanes avant la fin du créneau horaire réservé. Si le check-out a lieu après l'heure convenue sans préavis, un montant de 150 € par tranche de 30 minutes de retard, ou sa part proportionnelle, sera facturé.",
        },
        {
          title: "7. Politique d'annulation",
          body: "- Changement de date gratuit jusqu'à 7 jours avant le départ, sous réserve de disponibilité du bateau.\n- Mauvais temps sans garantie souscrite : report sans frais ou, si aucune nouvelle date n'est convenue, bon du montant versé valable 12 mois. Aucun remboursement en espèces.\n- Mauvais temps avec la Garantie mauvais temps souscrite : le client choisit entre une nouvelle date ou le remboursement intégral en espèces des sommes versées pour la location, hors montant de la garantie elle-même, non remboursable.\n- Critère objectif de mauvais temps : avis côtier officiel de l'AEMET pour la zone de navigation pendant le créneau horaire de la location, vent soutenu ou rafales supérieures à vingt nœuds, ou décision du personnel de l'entreprise pour des raisons de sécurité.\n- Si la sortie ne peut avoir lieu pour une cause imputable à l'entreprise (panne ou autre), les sommes versées sont remboursées.\n- En dehors des cas ci-dessus, les réservations confirmées avec acompte ne sont pas remboursables en espèces.\n\nLa Garantie mauvais temps et la Caution réduite sont des garanties commerciales propres à Costa Brava Rent a Boat et ne constituent pas un contrat d'assurance. La décision de suspension pour conditions météorologiques appartient au prestataire et est prise pour des raisons de sécurité. Communication par écrit à info@costabravarentaboat.com ou WhatsApp +34 611 500 372.",
        },
        {
          title: "8. Obligations du client",
          body: "Le client s'engage à :\n- Utiliser l'embarcation conformément aux instructions reçues lors du briefing de sécurité.\n- Ne pas dépasser la capacité maximale autorisée pour chaque embarcation.\n- Ne pas pratiquer d'activités interdites (pêche illégale, accès aux réserves marines protégées, consommation de substances pendant la navigation, etc.).\n- Signaler immédiatement au prestataire tout incident, panne ou accident.\n- Respecter la réglementation de la Capitainerie Maritime de Gérone et les signalisations maritimes.",
        },
        {
        ...
        },
        {
          ...
          body: "Tous les contenus du site web (textes, images, logos, marques, design) sont la propriété de Costa Brava Rent a Boat ou de tiers titulaires de licences. Leur reproduction, distribution ou modification est interdite sans autorisation écrite expresse.",
        },
        {
        ...
        {
          title: "17. Cartes cadeaux",
          body: "Les cartes cadeaux s'achètent en ligne par carte bancaire et sont remises par courrier électronique avec un code unique. Elles sont valables 12 mois à compter de leur émission, utilisables pour tout service de location sous réserve de disponibilité, et ne sont ni fractionnables sur plusieurs réservations ni échangeables contre de l'argent.\n\nS'agissant d'un contenu numérique fourni immédiatement, le droit de rétractation ne s'applique pas une fois le code envoyé, conformément à l'article 103.m du décret royal législatif espagnol 1/2007. Si la carte n'est pas utilisée dans son délai de validité, le montant n'est pas remboursé.",
        },
        {
          title: "18. Jet-skis et autres activités nautiques",
          body: "Les jet-skis et l'eFoil proposés sur ce site fonctionnent sur demande : le site recueille la demande et le service est confirmé, contracté et réglé directement au point de départ. Ils n'exigent aucun permis nautique et se déroulent toujours en circuit délimité ou en excursion accompagnée par un guide.\n\nLe participant doit être majeur (ou mineur accompagné d'un adulte responsable dans les formules qui le permettent), suivre à tout moment les consignes du guide et porter le gilet de sauvetage pendant toute l'activité. Les conditions financières précises, la caution le cas échéant et la politique d'annulation applicables à ces activités sont celles communiquées au client au moment de la confirmation de la demande.",
        },
      ],
    },
    legalNotice: {
      ...
      lastUpdated: "Dernière mise à jour : juillet 2026",
      identificationTitle: "1. Données d'identification de l'éditeur",
      labels: {
        legalName: "Raison sociale",
        taxId: "Numéro fiscal (CIF)",
        address: "Siège social",
        phone: "Téléphone",
        email: "Courrier électronique",
        activity: "Activité",
      },
      activityValue: "Location de bateaux de plaisance avec et sans permis nautique au Port de Blanes (Gérone), et vente de produits de la collection maison via la boutique en ligne.",
      sections: [
        {
          title: "2. Objet et champ d'application",
          body: "Les présentes mentions légales rassemblent les informations que l'article 10 de la loi espagnole 34/2002 relative aux services de la société de l'information et au commerce électronique (LSSI-CE) impose de mettre à la disposition des utilisateurs du site costabravarentaboat.com.\n\nL'accès au site confère la qualité d'utilisateur et implique l'acceptation des conditions énoncées ici. Les conditions contractuelles de la location et de la boutique figurent dans les Conditions Générales et dans les Conditions Générales de Location, qui prévalent sur le présent avis pour tout ce qui touche à la contractualisation.",
        },
        {
          title: "3. Propriété intellectuelle et industrielle",
          body: "Les contenus de ce site (textes, photographies, illustrations, logotypes, marques, design et code) appartiennent au prestataire ou à des tiers qui en ont autorisé l'usage. Leur reproduction, distribution, communication publique ou transformation sans autorisation expresse et écrite est interdite.\n\nLes marques et noms commerciaux de tiers susceptibles d'apparaître sur le site appartiennent à leurs titulaires respectifs et leur mention n'implique ni parrainage ni recommandation.",
        },
        {
          title: "4. Responsabilité et liens vers des tiers",
          body: "Le prestataire n'est pas responsable de l'usage que les utilisateurs font des contenus du site ni des dommages découlant d'interruptions de service échappant à son contrôle.\n\nLe site peut contenir des liens vers des sites tiers (par exemple des entreprises partenaires ou des plateformes de paiement). Le prestataire n'en contrôle pas les contenus et n'assume aucune responsabilité à leur égard ; le lien n'implique ni relation, ni approbation, ni supervision.",
        },
        {
    ...
    accessibility: {
      ...
      lastUpdated: "Conformément au Décret Royal 1112/2018, du 7 septembre",
      sections: [
        {
          title: "Engagement en matière d'accessibilité",
          body: "Costa Brava Rent a Boat s'engage à rendre son site web costabravarentaboat.com accessible conformément au Décret Royal 1112/2018, du 7 septembre, sur l'accessibilité des sites web et des applications mobiles du secteur public, et en tenant compte des Règles pour l'accessibilité des contenus Web (WCAG) 2.1, niveau AA.\n\nBien que ce site soit de nature privée et ne soit pas strictement soumis au RD 1112/2018 (qui s'applique principalement au secteur public), nous nous engageons volontairement à atteindre et à maintenir le niveau de conformité WCAG 2.1 AA au bénéfice de tous nos utilisateurs.",
        },
        {
          title: "État de conformité",
          body: 'Ce site web est partiellement conforme aux WCAG 2.1, niveau AA. Les non-conformités connues sont détaillées ci-dessous.\n\nAspects conformes :\n- Attributs aria-label sur tous les éléments interactifs\n- Attributs alt sur les images\n- Navigation complète au clavier dans les formulaires et les menus déroulants personnalisés\n- Taille minimale des zones tactiles (44×44 px)\n- Rapport de contraste de couleur WCAG AA pour le texte principal\n- Formulaires avec aria-describedby, aria-invalid et aria-required\n- Structure sémantique avec en-têtes hiérarchisés\n- Menu de navigation avec aria-expanded, aria-hidden et aria-current\n- Régions repères (nav, main, footer) sur toutes les pages\n- Boîtes de dialogue modales avec role="dialog", aria-modal et gestion du focus\n- Menus déroulants avec rôles ARIA (combobox, listbox, option) et navigation avec les flèches\n- Carrousels avec aria-live="polite" et aria-roledescription\n- Icônes décoratives marquées avec aria-hidden="true"\n- Tableaux avec scope="col" dans les en-têtes\n- Galerie avec boutons sémantiques accessibles au clavier',
        },
        {
          title: "Non-conformités connues",
          body: "- Contraste des espaces réservés : certains champs de formulaire présentent un texte d'espace réservé avec un contraste inférieur à 4.5:1 (limitation du navigateur).\n- En-tête CSP avec scripts inline : la politique de sécurité du contenu inclut unsafe-inline requis par Google Tag Manager. Nous évaluons des alternatives basées sur nonce.\n\nDernière audit réalisé : mars 2026. Prochaine révision prévue : septembre 2026.",
        },
        {
          title: "Contact et réclamations",
          body: "Si vous détectez une barrière d'accessibilité sur notre site web ou si vous avez besoin d'accéder à du contenu dans un format alternatif, vous pouvez nous contacter :\n- E-mail : info@costabravarentaboat.com\n- Téléphone : +34 611 500 372\n\nNous nous engageons à répondre dans un délai maximum de 5 jours ouvrables.\n\nSi vous ne recevez pas de réponse satisfaisante, vous pouvez déposer une réclamation via le Portail de l'Administration Générale de l'État (https://administracion.gob.es).",
        },
        {
  ...
  cookieBanner: {
    ...
    message:
      "Nous utilisons des cookies propres et tiers (Google Analytics) pour améliorer votre expérience et analyser le trafic du site. Vous pouvez accepter tous les cookies ou uniquement les cookies essentiels.",
    cookiesPolicy: "Politique de Cookies",
    privacyPolicy: "Politique de Confidentialité",
  ...
  relatedLocations: {
    boatTitle: "Destinations en bateau",
    boatIntro: "Naviguez depuis le port de Blanes vers le nord de la Costa Brava",
    carTitle: "Vous logez à proximité ?",
    carIntro: "Si vous séjournez sur la côte du Maresme, le port de Blanes est à quelques minutes en voiture.",
    categoriesTitle: "Types d'embarcation",
    categoriesIntro: "Trouvez le bateau parfait selon votre expérience",
    viewDetails: "Voir détails",
    viewBoats: "Voir bateaux",
    locations: {
      costaBrava: {
        name: "Location de bateaux sur la Costa Brava",
        description: "Découvrez toute la côte en bateau : itinéraires, criques et destinations depuis le port de Blanes.",
        duration: "Toute la région",
      },
      blanes: {
        name: "Location de bateaux à Blanes",
        description: "Port d'attache avec parking gratuit près de l'amarrage. Point de départ de toutes les sorties.",
        duration: "Port d'attache",
      },
      lloret: {
        name: "Excursion à Lloret de Mar",
        description: "Plages animées et criques cachées. Depuis Blanes, vous atteignez Fenals en 25 minutes en longeant la côte.",
        duration: "25 min en bateau",
      },
      tossa: {
        name: "Visite de Tossa de Mar",
        description: "Village médiéval protégé par des remparts, le joyau historique de la Costa Brava. Accessible avec un bateau avec permis ou une excursion avec capitaine.",
        duration: "30-45 min avec permis",
      },
      malgrat: {
        name: "Malgrat de Mar",
        description: "Le point de location nautique le plus proche pour qui séjourne à Malgrat.",
        duration: "10 min en voiture",
      },
      santaSusanna: {
        name: "Santa Susanna",
        description: "Zone resort à un quart d'heure du port de Blanes.",
        duration: "15 min en voiture",
      },
      calella: {
        name: "Calella",
        description: "Playa Gran, la vieille ville et le port de Blanes à 20 minutes.",
        duration: "20 min en voiture",
      },
      pineda: {
        name: "Pineda de Mar",
        description: "Zone hôtelière avec accès direct en train R1 ou en voiture.",
        duration: "18 min en voiture",
      },
      palafolls: {
        name: "Palafolls",
        description: "L'excursion parfaite depuis les campings de Palafolls.",
        duration: "12 min en voiture",
      },
      tordera: {
        name: "Tordera",
        description: "Porte d'entrée de la Costa Brava, avec parking facile au port.",
        duration: "15 min en voiture",
      },
    },
    categories: {
      licenseFree: {
        name: "Bateaux sans permis",
        description: "Embarcations jusqu'à 15 CV parfaites pour les débutants et les familles.",
        features: ["Jusqu'à 15 CV", "4-5 personnes", "Maniement facile"],
      },
      licensed: {
        name: "Bateaux avec permis",
        description: "Embarcations puissantes pour une navigation avancée avec permis.",
        features: ["80-115 CV", "Plus de vitesse", "Plus d'autonomie"],
      },
    },
  },
  ...
  testimonios: {
    hero: {
      ...
      subtitle:
        "Avis réels de familles, couples et groupes ayant pris la mer avec nous depuis Blanes. Sans filtre, sans retouche.",
    ...
    cta: {
      ...
      paragraph:
        "Réservez sans paiement en ligne : vous nous écrivez, nous confirmons par WhatsApp, et le jour venu il ne reste qu'à monter à bord.",
  ...
  sharedSailing: {
    ...
    form: {
      ...
      subtitle: "Nous vous informerons des premières sorties. Sans engagement.",
      name: "Nom",
      ...
      successText: "Merci. Vous serez parmi les premiers informés dès l'ouverture des sorties partagées.",
  ...
  routes: {
    ...
    lloretDesc: 'Plages dorees, criques cachees et vie nocturne. A seulement 25 min en bateau depuis Blanes.',
  ...
  relatedContent: {
    ...
    items: {
      ...
      locationCostaBrava: [
        ...
        { title: "Naviguez jusqu'à Tossa de Mar", description: "Vila Vella médiévale et criques cristallines à 30-45 min avec permis" },
        { title: "Meilleures criques de la Costa Brava en bateau", description: "Les 10 criques les plus spectaculaires entre Blanes et Tossa" },
      ],
      activitySnorkel: [
      ...
      activityFishing: [
        ...
        { title: "Location de bateaux Costa Brava", description: "8 bateaux disponibles à Blanes" },
  ...
  occasionMatrix: {
    pages: {
      ...
      snorkel__locationLloret: {
        ...
        seoDescription: 'Découvrez les meilleures criques de snorkeling de Lloret de Mar en bateau depuis Blanes : Cala Boadella, Cala Banys, Cala dels Frares. Bateau avec permis, environ 25 minutes de navigation.',
        h1: 'Snorkeling en bateau à Lloret de Mar',
        intro: 'Lloret de Mar cache quelques-unes des criques aux plus belles eaux de la Costa Brava sud, beaucoup accessibles uniquement par la mer. En partant de Blanes, en environ 25 minutes de navigation vous atteignez ses recoins rocheux et les parcourez en snorkeling sans les foules de la plage.',
        ...
        faq: [
          {
            ...
            a: 'Environ 25 minutes de navigation tranquille en longeant la côte, selon la crique et l\'état de la mer.',
          },
          {
      ...
      families__locationLloret: {
        ...
        seoDescription:
          "Journée en bateau en famille à Lloret de Mar au départ de Blanes (~25 min avec un bateau avec permis) : plages de sable, criques tranquilles et bateaux spacieux jusqu'à 7 places.",
        h1: "Location de bateau en famille à Lloret de Mar",
        intro:
          "Lloret de Mar associe de vastes plages de sable et des criques abritées, parfaites pour une journée en famille. Au départ de Blanes vous y arrivez en environ 25 minutes de navigation tranquille et parcourez ses plages avec la liberté de mouiller où vous voulez.",
        ...
        boatsIntro:
          "Lloret se trouve au-delà des 2 milles, on y accède donc avec l'un de nos bateaux avec permis. Ils sont spacieux et stables (le Pacific Craft 625 admet jusqu'à 7 personnes) et couvrent le trajet depuis Blanes en environ 25 minutes.",
        practicalTitle: "Informations pratiques",
        practicalBody:
          "Saison d'avril à octobre, départs de 09h00 à 20h00 depuis le port de Blanes. Le trajet jusqu'à Lloret prend environ 25 minutes. Nous fournissons des gilets de toutes les tailles ; apportez protection solaire, casquette, eau et de quoi grignoter.",
        faqTitle: "Questions fréquentes",
        faq: [
          { q: "Combien de temps faut-il de Blanes à Lloret en bateau ?", a: "Environ 25 minutes de navigation tranquille en longeant la côte avec un bateau avec permis." },
      ...
      sunset__locationLloret: {
        ...
        seoDescription:
          "Coucher de soleil en bateau à Lloret de Mar au départ de Blanes (~25 min avec un bateau avec permis) : lumière dorée sur les falaises de Cala Banys et le château de Lloret.",
        h1: "Balade en bateau au coucher du soleil à Lloret de Mar",
        intro:
          "La côte de Lloret de Mar, avec ses falaises et son château au-dessus de la mer, devient spectaculaire en fin d'après-midi. Au départ de Blanes en environ 25 minutes avec un bateau avec permis vous arrivez à temps pour la plus belle lumière du jour.",
        ...
        boatsIntro:
          "Lloret se trouve au-delà des 2 milles, la balade se fait donc avec l'un de nos bateaux avec permis, confortables et dotés d'un bon solarium. Ils couvrent le trajet depuis Blanes en environ 25 minutes.",
        practicalTitle: "Informations pratiques",
        practicalBody:
        ...
        faqTitle: "Questions fréquentes",
        faq: [
          { q: "Combien de temps faut-il de Blanes à Lloret au coucher du soleil ?", a: "Environ 25 minutes avec un bateau avec permis ; mieux vaut partir avec de la marge pour profiter de la plus belle lumière." },
      ...
      fishing__locationLloret: {
        ...
        seoDescription:
          "Pêche récréative en bateau à Lloret de Mar depuis Blanes (~25 min avec un bateau avec permis). Fonds rocheux face à la côte. Licence de pêche à la charge du client.",
        h1: "Location de bateau pour pêcher à Lloret de Mar",
        intro:
          "La côte de Lloret de Mar, faite de falaises et de fonds rocheux, offre de bonnes zones pour la pêche récréative. Au départ de Blanes avec un bateau avec permis vous arrivez en environ 25 minutes et disposez de l'autonomie pour vous déplacer entre les points.",
        ...
        boatsIntro:
          "Lloret se trouve au-delà des 2 milles, on y accède donc avec l'un de nos bateaux avec permis, dotés de l'autonomie pour vous déplacer entre les zones de pêche. Le trajet depuis Blanes est d'environ 25 minutes.",
        practicalTitle: "Informations pratiques et réglementation",
        practicalBody:
        ...
        faqTitle: "Questions fréquentes",
        faq: [
          { q: "Combien de temps faut-il de Blanes à Lloret en bateau ?", a: "Environ 25 minutes avec un bateau avec permis, ceux que nous utilisons pour les sorties de pêche." },
    ...
    terms: [
      {
        ...
        definition: 'Permis nautique espagnol minimum reconnu par le RD 875/2014. Permet de piloter des embarcations jusqu\'à 6 mètres de longueur, avec un moteur adapté à la coque et jusqu\'à 2 milles nautiques de la côte, en journée. C\'est le permis minimum requis pour les bateaux avec licence de notre flotte (Mingolla Brava 19, Trimarchi 57S et Pacific Craft 625). Sans examen : l’école nautique agréée certifie la formation et délivre le titre sous sa propre responsabilité.',
        category: 'titulacion',
      },
      {
  ...
  garantiasPage: {
    ...
    criteriaMarks: ["AEMET", "20 kn", "L'entreprise"],
    criteria: [
  ...
  navigationLicensePage: {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Des bateaux à moteur jusqu'à 6 mètres de longueur, de jour et jusqu'à 2 milles nautiques d'un port ou d'un abri, ainsi que des motos aquatiques de classe C. Dans notre flotte, elle couvre la Mingolla Brava 19, la Trimarchi 57S et la Pacific Craft 625.",
      },
      {
  ...
  activitiesPage: {
    seoTitle: "Que faire à Blanes et Lloret de Mar en plus du bateau | Activités",
    seoDescription: "Parachute ascensionnel, buggies, wakeboard, paddle, jeux gonflables et escape game à Blanes, Lloret de Mar et Fenals, dès 15 EUR. Réservation via Activitatum ; les bateaux et les jet-skis, chez nous.",
    navLabel: "Activités",
    hero: {
      title: "Que faire à Blanes et Lloret en plus de naviguer",
      subtitle: "Une sortie en bateau occupe une demi-journée. Blanes et Lloret sont à dix minutes, donc le reste de la journée tient entier : voici ce qui est à portée de main.",
    },
    chips: [
      "Dès 15 EUR",
      "Blanes et Lloret",
    ...
    intro: "Nous ne louons rien de tout cela : ce sont des entreprises locales qui l'exploitent et la réservation se fait sur Activitatum, l'agence avec laquelle nous travaillons. C'est ici parce que c'est la question qu'on nous pose le plus au retour du bateau.",
    teaserTitle: "Et le reste de la journée ?",
    teaserText: "Parachute ascensionnel, buggies, wakeboard ou paddle, à dix minutes du port. Ce n'est pas nous qui les louons : c'est Activitatum, l'agence d'activités avec laquelle nous travaillons.",
    afterBoatTitle: "L'après-midi après le bateau",
    afterBoatIntro: "Tout cela part de la plage de Blanes, à deux pas du port où nous amarrons. Ce sont des séances de dix à vingt minutes : elles tiennent entre le retour du bateau et le dîner.",
    landDayTitle: "Le jour sans mer",
    landDayIntro: "Des plans d'une demi-journée à Lloret, pour quand le vent emporte la sortie ou simplement quand on n'a pas envie de recommencer.",
    rainyDayTitle: "Et s'il pleut",
    priceFrom: "dès",
    activities: {
      flyfish: {
        name: "Flyfish",
        note: "Le gonflable qui décolle sous la traction du bateau. Cinq minutes, aucune expérience requise.",
      },
      bananaBoat: {
        name: "Banana boat",
        note: "Le classique de la traction, de quatre à huit personnes par tour. En groupe, c'est le moins cher de la plage.",
      },
      paddle: {
        name: "Paddle",
        note: "Une heure de planche dans la baie. Tenir debout prend une dizaine de minutes.",
      },
      wakeboard: {
        name: "Wakeboard et ski nautique",
        note: "Avec un moniteur dans le bateau. Quinze minutes suffisent pour plusieurs essais et pour se lever.",
      },
      crazyUfo: {
        name: "Crazy UFO",
        note: "Un disque gonflable tracté qui tourne jusqu'à ce que quelqu'un tombe. Tout le monde tombe.",
      },
      parasailing: {
        name: "Parachute ascensionnel au-dessus de la baie de Lloret",
        note: "Deux cents mètres de câble, décollage et atterrissage depuis la plateforme du bateau. On monte et on redescend au sec.",
      },
      buggy: {
        name: "Buggy le long de la côte",
        note: "Deux heures de pistes dans l'arrière-pays de Lloret avec arrêt au belvédère. Le permis B suffit.",
      },
      holidayPack: {
        name: "Pack Holiday",
        note: "Trois activités nautiques le même après-midi, moins cher qu'en les réservant séparément.",
      },
      escapeRoom: {
        name: "Escape game à Malgrat de Mar",
        note: "Quatre-vingt-dix minutes à couvert, à dix minutes de Blanes. Le plan des jours de tramontane.",
      },
    },
    operatedByTitle: "Réservation via Activitatum",
    operatedByText: "Activitatum est l'agence d'activités avec laquelle nous travaillons, appartenant aux mêmes propriétaires que nous. Elle centralise le calendrier et le paiement des prestataires de Blanes, Lloret et Fenals. Ce qui avance au moteur sur l'eau reste chez nous : les bateaux et les jet-skis se réservent sur ce site.",
    cta: "Voir les activités à Blanes",
    ctaSecondary: "Voir les activités à Lloret de Mar",
    ctaNote: "Activitatum s'ouvre dans un nouvel onglet.",
    faqTitle: "Questions fréquentes",
    faq: [
      {
        q: "Les activités partent-elles du même endroit que les bateaux ?",
        a: "Celles de Blanes oui : la plage est juste à côté du port où nous amarrons. Celles de Lloret de Mar sont à une dizaine de minutes en voiture.",
      },
      {
        q: "Puis-je faire une activité le jour même de la location du bateau ?",
        a: "C'est le cas le plus courant. Une sortie d'une demi-journée laisse l'après-midi libre, et les activités nautiques durent entre dix minutes et une heure.",
      },
      {
        q: "Pourquoi la réservation se fait-elle sur un autre site ?",
        a: "Parce que ce sont d'autres entreprises qui les exploitent. Activitatum réunit les prestataires de la zone dans un seul calendrier, avec confirmation immédiate et le billet sur le téléphone.",
      },
      {
        q: "Louez-vous aussi des jet-skis là-bas ?",
        a: "Non. Les jet-skis et les bateaux sont à nous et se réservent ici, sur ce site, sans intermédiaire.",
      },
    ],
  },
  scootersPage: {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Oui, l'annulation est gratuite jusqu'à 24 heures avant la prise en main.",
      },
      {
        q: "Puis-je combiner le scooter avec une journée en bateau ?",
        a: "Oui. Nos bateaux partent du port de Blanes, à environ 10 minutes de Lloret de Mar : vous pouvez naviguer le matin et parcourir la côte en scooter l'après-midi, ou l'inverse.",
      },
    ],
  },
  captainedPage: {
    ...
    seoDescription:
      "Excursion privée en bateau avec skipper depuis Blanes : criques, grottes et arrêt baignade vers Tossa de Mar. Jusqu'à 6 personnes, dès 265€/2h. {rating}★ sur Google.",
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Dès 265€ les 2 heures d'avril à juin et en septembre, 285€ en juillet et 310€ en août. Il existe aussi des sorties de 3 heures (dès 350€) et de 4 heures (dès 420€). Le prix est par bateau, pour 6 personnes maximum.",
      },
      {
  ...
  shopPage: {
    gate: {
      ...
      subtitle: 'Nous préparons le lancement. Saisissez le mot de passe pour jeter un œil.',
    ...
    hero: {
      ...
      subtitle:
        "Une collection capsule dessinée avec Laura Cabanas, créatrice de mode de Lloret de Mar : t-shirt oversize en deux couleurs et tote bag, avec l'illustration de notre bateau naviguant le long de la côte.",
      limitedNote: "Édition limitée : quand il n'y en a plus, il n'y en a plus.",
      credit: "Illustration de Laura Cabanas. Photographié dans le port de Blanes.",
      meta: "3 pièces",
      cta: "Voir les pièces",
    },
    products: {
      tee: {
        ...
        description:
          "T-shirt oversize en coton avec les logos de Costa Brava Rent a Boat et Laura Cabanas sur la poitrine et la grande illustration dans le dos.",
      },
      tote: {
        name: "Tote bag Costa Brava Culture",
        description:
          "Sac en toile bleu royal avec l'illustration Costa Brava Culture en blanc. Pour la plage, les courses ou la journée en bateau.",
      },
    },
    colors: {
      butter: "Jaune beurre",
    ...
    colorLabel: "Couleur",
    sizeLabel: "Taille",
    viewBack: "Voir le dos",
    viewFront: "Voir le devant",
    viewEditorial: "Dans la rue",
    addToCart: "Ajouter au panier",
    outOfStock: "Épuisé",
    lowStock: "Dernières unités",
    unitsLeft: "Il en reste {n}",
    alsoIn: "Aussi en {color}",
    selectSizeFirst: "Choisissez votre taille pour continuer",
    fitNote: "Coupe oversize unisexe. Pour un rendu plus ajusté, prenez une taille en dessous.",
    trust: {
      pickup: "Retrait gratuit au port de Blanes",
      shipping: "Livraison en Espagne péninsulaire sous 3 à 7 jours",
      payment: "Paiement sécurisé par carte, Apple Pay ou Google Pay",
    },
    pack: {
      title: "Prenez les deux",
      text: "T-shirt et tote bag dans la même commande : nous déduisons le pack au paiement et la livraison à domicile est offerte.",
      saving: "Vous économisez",
      instead: "au lieu de",
      cta: "Choisir un t-shirt",
    },
    boatCta: {
    ...
    cart: {
      title: "Votre panier",
      empty: "Votre panier est vide. Ajoutez un t-shirt ou un tote bag pour commencer.",
      quantity: "Quantité",
      remove: "Retirer",
      subtotal: "Sous-total",
      added: "Ajouté au panier",
      discount: "Pack t-shirt + tote",
      freeShippingReached: "Livraison à domicile offerte",
      toFreeShipping: "Il vous manque {importe} pour la livraison offerte",
    ...
    delivery: {
      title: "Livraison",
      pickupTitle: "Retrait au port de Blanes",
      pickupText:
        "Gratuit. Nous vous écrivons pour convenir du retrait ; si vous avez une sortie en bateau réservée, nous vous le remettons le jour même au port.",
      pickupLauraTitle: 'Retrait chez Laura Cabanas (Lloret de Mar)',
      pickupLauraText:
    ...
    designer: {
      ...
      text:
        "Laura Cabanas est créatrice de mode à Lloret de Mar. Cette capsule est née d'un été partagé sur la Costa Brava : son trait et nos bateaux, dans des pièces pensées pour porter la Méditerranée sur soi.",
      cta: "Visiter lauracabanas.com",
    },
    success: {
    ...
    cancelled: {
      ...
      text: "Aucun débit n'a été effectué. Votre panier reste enregistré si vous souhaitez terminer votre commande.",
    },
    faqTitle: "Questions fréquentes",
    faq: [
      {
        q: "Comment fonctionne le retrait au port de Blanes ?",
        a: "Au paiement, choisissez l'option retrait (gratuit). Nous vous écrirons pour convenir d'un moment ; si vous avez une réservation de bateau, nous vous remettons la commande le jour de votre sortie au même port.",
      },
      {
      ...
      },
      {
        ...
        a: "C'est une coupe oversize unisexe. Si vous le préférez plus ajusté, nous vous conseillons de prendre une taille en dessous de votre taille habituelle.",
      },
      {
        q: "Qui est derrière le design ?",
  ...
  locationTemplate: {
    ...
    destBlanesCoves: 'Criques de Blanes',
    whyRentImgAlt: 'Amis profitant d\'une journée en bateau avec snorkeling sur la Costa Brava',
    coastBreakImgAlt: 'Bateau ancré dans une crique aux eaux cristallines de la Costa Brava',
  },
  locationPages: {
    blanes: {
      faqItems: [
        {
          ...
          answer: 'Non. Nous disposons de 4 bateaux sans permis pour 4 ou 5 personnes. Vous devez simplement être âgé d\'au moins 18 ans. Nous vous proposons une formation de 15 minutes avant le départ.',
        },
        {
          question: 'Combien coûte la location d\'un bateau au Port de Blanes ?',
          answer: 'Les bateaux sans permis coûtent à partir de {noLicBaja1h} €/heure en basse saison (avril-juin, septembre-octobre). En haute saison (août), à partir de {noLicAlta1h} €/heure. Le prix comprend le carburant, l\'assurance et l\'équipement de sécurité.',
        },
        {
      ...
      sections: {
        ...
        expSnorkelDesc: 'Naviguez 15 minutes jusqu\'à Cala Brava et découvrez ses fonds marins. Eaux cristallines avec une visibilité jusqu\'à 15 mètres, idéales pour observer les poissons de roche et les poulpes. Location de masque et tuba pour seulement 7,50 €.',
    ...
    lloret: {
      faqItems: [
        ...
        },
        {
          ...
          answer: 'Non. Tossa se trouve à 4-5 milles au nord de Fenals, en dehors de la limite légale sans permis. Pour aller à Tossa en bateau depuis Blanes, vous avez besoin (a) d\'un bateau avec la Licencia de Navegación (LN), ou (b) d\'une Excursion Privée avec Capitaine.',
        },
        {
        ...
        },
        {
          ...
          answer: 'En voiture, 10 minutes par la GI-682 (parking gratuit à 100 m du port). En bus, la ligne Lloret-Blanes prend environ 20 minutes. En taxi, le trajet coûte environ 15-18 €. Il n\'y a pas de base de location dans Lloret : tous les départs se font depuis le Port de Blanes.',
        },
        {
          question: 'Quelles criques verrai-je sur la route en bateau vers Lloret ?',
          answer: 'En partant du Port de Blanes, vous passerez par Cala Sant Francesc, Sa Forcanera, la plage de Santa Cristina, Cala Treumal et Cala Sa Boadella avant d\'arriver à la plage de Fenals. Ce sont les criques les plus photographiées de la Costa Brava sud et toutes sont dans le rayon légal sans permis.',
        },
      ],
      hero: {
        ...
        badgeCapacity: '4-5 personnes par bateau',
      },
      sections: {
      ...
      faqItems: [
        {
          ...
          answer: 'Non. Les bateaux sans permis (2 milles de la côte, 5 nœuds, 15 CV) vont jusqu\'à Playa de Fenals (sud de Lloret), 4 milles avant Tossa. Pour rejoindre Tossa, vous avez besoin de la Licencia de Navegación (LN) ou de réserver l\'Excursion Privée avec Capitaine.',
        },
        {
        ...
        {
          question: 'Combien coûte la location pour Tossa avec la Licencia de Navegación (LN) ?',
    ...
    malgrat: {
      hero: {
        ...
        imageAlt: 'Crique de la Costa Brava avec falaises et pins, à 25 minutes en bateau du Port de Blanes',
      },
      sections: {
        whyRentTitle: 'Pourquoi louer un bateau depuis Blanes ?',
        closestPort: 'Le Port le Plus Proche',
        closestPortDesc: 'Blanes est le port nautique le plus proche de Malgrat de Mar, à seulement 10 minutes par la N-II. 8 bateaux prêts à naviguer.',
        varietyBoats: '8 Bateaux Disponibles',
        ...
        fuelIncludedDesc: 'Toutes nos locations incluent le carburant. Pas de surprises. Dès 85 €/heure.',
        ...
        byTaxi: 'En Taxi',
        byTaxiDesc: 'Taxi depuis Malgrat au Port de Blanes : environ 12-15 €, 10 minutes.',
      ...
      faqItems: [
        ...
        },
        {
          ...
          answer: 'La location de bateau commence à partir de {noLicBaja1h} € par heure avec essence incluse. Aucun permis n\'est nécessaire pour les bateaux jusqu\'à 15 CV. Nous disposons de {fleetCount} bateaux pour 4 à 11 personnes.',
        },
        {
        ...
        },
        {
          ...
          answer: 'Nous n\'offrons pas de transfert direct, mais le trajet est très court : 5 minutes en train R1 (Malgrat → Blanes) ou 10 minutes en voiture/taxi (coût approximatif 12-15 €). La gare de Blanes se trouve à 10 minutes à pied du port. Il y a aussi le bus local L23.',
        },
      ],
    },
    santaSusanna: {
      faqItems: [
        ...
        },
        {
          ...
          answer: 'Depuis Blanes, nous recommandons : (a) Circuit des criques 4h sans permis jusqu\'à Playa de Fenals avec mouillage dans 2-3 criques cristallines (à partir de 135 € pour 5 personnes) ; (b) Excursion privée avec skipper 4h jusqu\'à Tossa et Cala Bona (à partir de {excursionBaja4h} €, idéal si vous n\'avez pas d\'expérience nautique) ; (c) Bateau avec Permis de Base si quelqu\'un du groupe a le permis (à partir de 265 € / 4h).',
        },
        {
      ...
      hero: {
        ...
        imageAlt: 'Côte aux falaises et eaux turquoise de la Costa Brava, accessible en bateau depuis Blanes',
      },
      sections: {
        whyRentTitle: 'Pourquoi louer un bateau depuis Blanes ?',
        closestPort: 'Le Port le Plus Proche',
        closestPortDesc: 'Blanes est le port nautique le plus proche de Santa Susanna, à seulement 15 minutes par la N-II. 8 bateaux prêts à naviguer.',
        varietyBoats: '8 Bateaux Disponibles',
        varietyBoatsDesc: 'Des bateaux sans permis pour familles aux bateaux avec permis pour navigateurs expérimentés. De 4 à 7 passagers.',
        fuelIncluded: 'Essence Incluse',
        fuelIncludedDesc: 'Toutes nos locations incluent le carburant. Pas de surprises. Dès 85 €/heure.',
        ...
        byTaxi: 'En Taxi',
        byTaxiDesc: 'Taxi depuis Santa Susanna au Port de Blanes : environ 18-22 €, 15 minutes.',
        byPublicTransport: 'En Transport Public',
    ...
    calella: {
      faqItems: [
        ...
        },
        {
          ...
          answer: 'Pas directement depuis Calella (il n\'y a pas de location). Depuis Blanes oui : avec un bateau avec la Licencia de Navegación (LN), vous atteignez Tossa en 45 min (à partir de {licBaja2h} €/2h), ou avec notre Excursion Privée avec Capitaine 4h jusqu\'à Tossa incluant Cala Bona et Vila Vella (à partir de {excursionBaja4h} € pour jusqu\'à 6 personnes, plus le skipper). Les bateaux sans permis ne peuvent pas atteindre Tossa en raison de la limite légale de 2 milles.',
        },
        {
          question: 'Combien coûte le train R1 de Calella à Blanes ?',
          answer: 'Le billet simple R1 Calella → Blanes coûte environ 3 € (tarif ATM zone 4-5). Avec la carte T-Casual 10 voyages, c\'est plus économique. Durée : 15 minutes. Fréquence : toutes les 30 minutes en saison. De la gare de Blanes au Port, comptez 10 minutes à pied ou 3 min en taxi.',
        },
      ],
      hero: {
        ...
        imageAlt: 'Crique cachée de la Costa Brava aux eaux transparentes, sur l\'itinéraire en bateau depuis Blanes',
      },
      sections: {
        whyRentTitle: 'Pourquoi louer un bateau depuis Blanes ?',
        closestPort: 'Le Port le Plus Proche',
        closestPortDesc: 'Blanes est le port nautique le plus proche de Calella, à seulement 20 minutes par la N-II. 8 bateaux prêts à naviguer.',
        varietyBoats: '8 Bateaux Disponibles',
        varietyBoatsDesc: 'Des bateaux sans permis pour familles aux bateaux avec permis pour navigateurs expérimentés. De 4 à 7 passagers.',
        fuelIncluded: 'Essence Incluse',
        fuelIncludedDesc: 'Toutes nos locations incluent le carburant. Pas de surprises. Dès 85 €/heure.',
        ...
        byTaxi: 'En Taxi',
        byTaxiDesc: 'Taxi depuis Calella au Port de Blanes : environ 25-30 €, 20 minutes.',
        byPublicTransport: 'En Transport Public',
    ...
    costaBrava: {
      hero: {
        ...
        subtitle: 'Découvrez les plus belles criques et plages de la Costa Brava à bord de nos bateaux. Départs du Port de Blanes, au coeur de la côte catalane. Bateaux sans permis à partir de 85 €/heure, carburant et assurance inclus.',
        badgePort: 'Port de Blanes',
        badgeCapacity: '4-7 personnes',
        badgeLicense: 'Avec et sans permis',
      },
      sections: {
        ...
        noLicensePrice: 'À partir de 85 €/heure',
        ...
        licensedTitle: 'Bateaux Avec Permis',
        licensedPower: 'De 80 à 115 CV',
        licensedCapacity: 'Jusqu\'à 7 personnes à bord',
        licensedNavigation: 'Navigation en haute mer sans limites',
        licensedFuel: 'Carburant NON inclus (dépôt séparé)',
        licensedPrice: 'À partir de 90 €/heure',
        licensedDesc: 'Pour les navigateurs qualifiés souhaitant explorer au-delà de la côte immédiate. Plus de puissance, d\'autonomie et de capacité. Le carburant est facturé séparément. La Licencia de Navegación (LN) suffit ; PNB, PER ou équivalents européens acceptés.',
        ...
        ctaDescription: 'Choisissez votre bateau, date et horaire. Carburant, assurance et formation inclus pour les bateaux sans permis. Réservez par WhatsApp : nous confirmons en moins de 2 heures.',
        ctaButton: 'Réserver par WhatsApp',
    ...
    tordera: {
      faqItems: [
        ...
        },
        {
          ...
          answer: 'La location de bateau sans permis commence à partir de {noLicBaja1h} € par heure avec essence incluse. Bateaux avec permis à partir de {licBaja2h} € pour 2 heures. Nous disposons de {fleetCount} bateaux pour 4 à 11 personnes.',
        },
        {
          question: 'Ai-je besoin d\'un permis de navigation ?',
      ...
      seo: {
        title: 'Location Bateau Tordera | Port Blanes 15 min | Sans Permis 85€/h | Delta du Tordera',
        description: 'Vous habitez à Tordera ou près du Delta ? Port de Blanes à 15 min en voiture ou 8 min en train R1. Louez un bateau sans permis dès 85€/h essence incluse. Naviguez sur le Delta du Tordera.',
        ogTitle: 'Location Bateau Tordera | Delta du Tordera en Bateau',
        ogDescription: 'De Tordera au Port de Blanes en 15 min. Bateau sans permis dès 85€/h. Delta du Tordera en bateau. 4.8★.',
      },
      schema: {
        name: 'Location de Bateaux près de Tordera',
        description: 'Louez des bateaux depuis le Port de Blanes, à seulement 15 minutes en voiture de Tordera. Bateaux sans permis dès 85 €/heure essence incluse.',
      },
      ...
      sections: {
        ...
        whyCard3Desc: 'Le prix des bateaux sans permis inclut l\'essence. Dès 85 € par heure. Sans coûts cachés ni surprises sur le prix final.',
        ...
        howTaxiDesc: 'Un taxi depuis Tordera jusqu\'au Port de Blanes coûte environ 15-20 €. C\'est une option rapide et confortable pour l\'aller-retour.',
        ...
        pricingNoLicFrom: 'Dès {noLicBaja1h} €/heure (essence incluse)',
        pricingNoLicCapacity: 'Capacité : 4-7 personnes selon le modèle',
        pricingLicTitle: 'Bateaux avec permis',
        pricingLicFrom: 'Dès {licBaja2h} € / 2 heures',
        pricingLicEngines: 'Moteurs de 80 à 115 CV',
    ...
    palafolls: {
      ...
      seo: {
        title: 'Location Bateau Palafolls | Port Blanes 12 min | Sans Permis 85€/h',
        description: 'En camping ou hébergement à Palafolls ? Port de Blanes à 12 min en voiture. Louez un bateau sans permis dès 85€/h essence incluse. Excursion idéale Costa Brava.',
        ogTitle: 'Location Bateau Palafolls | 12 min du Port de Blanes',
        ogDescription: 'De Palafolls au Port de Blanes en 12 min. Bateau sans permis dès 85€/h. Essence incluse. 4.8★.',
      },
      schema: {
        name: 'Location de Bateaux près de Palafolls',
        description: 'Louez des bateaux depuis le Port de Blanes, à seulement 12 minutes en voiture de Palafolls. Bateaux sans permis dès 85 €/heure essence incluse.',
      },
      ...
      sections: {
        ...
        whyCard3Title: 'Essence incluse pour les bateaux sans permis',
        whyCard3Desc: 'Le prix des bateaux sans permis inclut l\'essence. Dès 85 € par heure. Sans coûts cachés ni suppléments pour le carburant.',
        whyCard4Title: 'Aucune expérience préalable nécessaire',
        ...
        howTaxiTitle: 'En taxi',
        howTaxiDesc: 'Un taxi depuis Palafolls jusqu\'au Port de Blanes coûte environ 12-18 €. C\'est une option confortable si vous ne disposez pas de voiture.',
    ...
    pineda: {
      faqItems: [
        ...
        },
        {
          ...
          answer: 'Non, Pineda de Mar n\'a pas de port de plaisance avec location de bateaux. Le port le plus proche pour tout l\'Alt Maresme (Malgrat, Santa Susanna, Pineda et Calella) est le Port de Blanes, à 18 minutes en voiture ou 12 minutes en train R1.',
        },
        {
          question: 'Quelles criques puis-je visiter en partant de Blanes ?',
          answer: 'Avec un bateau sans permis, vous atteignez Cala Sant Francesc, Sa Forcanera, la plage de Santa Cristina, Cala Sa Boadella et la plage de Fenals (sud de Lloret), toutes dans la limite légale de 2 milles. Avec permis ou avec l\'excursion privée avec capitaine, vous pouvez continuer jusqu\'à Tossa de Mar.',
        },
        {
          question: 'Puis-je faire une balade en bateau sans piloter moi-même ?',
          answer: 'Oui. Si vous préférez ne pas conduire, réservez l\'excursion privée avec capitaine : départs du Port de Blanes de 2 à 8 heures, jusqu\'à 6 personnes, avec des arrêts pour nager et faire du snorkeling dans les criques. Aucun titre nautique n\'est nécessaire.',
        },
      ],
      seo: {
        title: 'Location Bateau Pineda de Mar | Port Blanes 18 min | Sans Permis 85€/h',
        description: 'Logé à Pineda de Mar ? Port de Blanes à 18 min en voiture ou 12 min en train R1. Louez un bateau sans permis dès 85€/h essence incluse. Naviguez vers Blanes, Lloret ou Tossa.',
        ogTitle: 'Location Bateau Pineda de Mar | 18 min du Port de Blanes',
        ogDescription: 'De Pineda de Mar au Port de Blanes en 18 min. Bateau sans permis dès 85€/h. 4.8★ Google.',
      },
      schema: {
        name: 'Location de Bateaux près de Pineda de Mar',
        description: 'Louez des bateaux depuis le Port de Blanes, à seulement 18 minutes en voiture de Pineda de Mar. Bateaux sans permis dès 85 €/heure essence incluse.',
      },
      ...
      sections: {
        ...
        heroImageAlt: 'Eaux turquoise de la Costa Brava à 18 minutes de Pineda de Mar, au départ du Port de Blanes',
        ...
        whyCard3Title: 'Essence incluse pour les bateaux sans permis',
        whyCard3Desc: 'Le prix des bateaux sans permis inclut l\'essence, donc pas de surprises. Dès 85 € par heure. Le prix que vous voyez est le prix final.',
        whyCard4Title: 'Aucune expérience préalable nécessaire',
        ...
        howTaxiTitle: 'En taxi',
        howTaxiDesc: 'Un taxi depuis Pineda de Mar jusqu\'au Port de Blanes coûte environ 20-25 €. C\'est une bonne option si vous ne disposez pas de voiture ou préférez ne pas vous préoccuper du stationnement.',
