...
export const it: Translations = {
  ...
  hero: {
    ...
    subtitleLine1: 'Senza esperienza. 15 min di formazione e via.',
    subtitleLine2: 'Naviga verso calette segrete della Costa Brava, accessibili solo in barca.',
  ...
  locationPages: {
    blanes: {
      ...
      sections: {
        ...
        expSunsetDesc: 'Prenota l\'ultima fascia del pomeriggio e goditi il tramonto in mare. La luce dorata sulle scogliere della Costa Brava e uno spettacolo indimenticabile.',
    ...
    costaBrava: {
      ...
      sections: {
        introP1: 'La Costa Brava e una delle destinazioni nautiche piu spettacolari del Mediterraneo. Con oltre 200 chilometri di litorale tra Blanes e il confine francese, offre una combinazione unica di scogliere, calette con acque cristalline e villaggi medievali.',
        introP2: 'Presso Costa Brava Rent a Boat vi offriamo il modo piu semplice per esplorare questa costa: noleggia una delle nostre barche al Porto di Blanes e naviga al tuo ritmo. Nessuna esperienza o patente nautica necessaria per la maggior parte delle nostre imbarcazioni.',
        ...
        routeBlanesLloretDesc: 'Una delle rotte piu popolari della Costa Brava. Perfetta per un\'escursione di mezza giornata con sosta a Cala Treumal.',
        routeBlanesTossa: 'Blanes - Tossa de Mar: 45 min, media, patente consigliata',
        routeBlanesTossaDesc: 'La rotta piu spettacolare dell\'intera costa. Raggiungerai l\'iconica Vila Vella di Tossa de Mar.',
        ...
        licensedDesc: 'Per navigatori qualificati che vogliono esplorare oltre la costa immediata. Piu potenza, autonomia e capacita. Il carburante viene addebitato separatamente.',
        ...
        calaBBoadellaDesc: 'Considerata la caletta piu bella di Lloret de Mar. Spiaggia di sabbia dorata protetta da scogliere boscose.',
        platjaPalomeraName: 'Platja de Sa Palomera',
        platjaPalomeraDesc: 'La spiaggia piu iconica di Blanes, che segna l\'inizio ufficiale della Costa Brava.',
      ...
      faq: {
        ...
        experienceA: 'No, non serve alcuna esperienza. Per le nostre barche senza patente (fino a 15 CV) basta avere piu di 18 anni. Offriamo una formazione pratica di 15 minuti prima della partenza.',
        ...
        weatherA: 'La sicurezza e la nostra priorita. Se le condizioni meteo non permettono una navigazione sicura, offriamo un cambio data gratuito o un rimborso completo.',
        petsQ: 'Posso portare animali domestici sulla barca?',
        petsA: 'Si, gli animali domestici sono benvenuti su tutte le nostre barche. Consigliamo di portare acqua fresca, un asciugamano e una protezione solare adeguata per il vostro animale.',
      },
    },
    newsletter: {
  ...
  categoryLicenseFree: {
    ...
    regulationNotAllowed: 'Le barche senza patente non possono navigare di notte, avventurarsi oltre 2 miglia nautiche dalla costa, ne trasportare piu passeggeri di quanti indicati nelle specifiche tecniche della barca. Questi limiti esistono per garantire la sicurezza di tutti i naviganti.',
    regulationFuelIncluded: 'Nelle nostre barche senza patente, il carburante e incluso nel prezzo del noleggio. Non dovrai preoccuparti di fare rifornimento ne di costi aggiuntivi per il carburante. Il prezzo che vedi e il prezzo finale.',
    ...
    comparisonRemus450: 'Famiglie e coppie (il piu popolare)',
    ...
    testimonial4Text: 'Ero nervosa perche non avevo mai guidato una barca, ma il team di Costa Brava Rent a Boat mi ha spiegato tutto con pazienza. In 15 minuti navigavo da sola. La sensazione di liberta nel Mediterraneo e incomparabile.',
    testimonial4Context: 'Turista, prima volta in barca, noleggio di 3 ore a giugno',
    faqSpeedQuestion: 'Che velocita raggiungono le barche senza patente?',
    faqSpeedAnswer: 'Le barche senza patente con motore da 15 CV raggiungono una velocita massima di circa 12-15 nodi (circa 22-28 km/h). E una velocita comoda e sicura per la navigazione costiera, l\'ancoraggio in calette e il godimento del paesaggio senza fretta.',
    faqChildrenQuestion: 'Posso portare bambini su una barca senza patente?',
    faqChildrenAnswer: 'Si, i bambini di qualsiasi eta sono benvenuti a bordo. Il conducente deve avere almeno 18 anni, ma i passeggeri possono essere di qualsiasi eta. Tutte le nostre barche includono giubbotti di salvataggio di tutte le taglie, comprese quelle per bambini. Molte famiglie scelgono le nostre barche senza patente proprio per la loro stabilita e sicurezza.',
