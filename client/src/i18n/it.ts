...
export const it: Translations = {
  ...
  boatDetail: {
    ...
    selectDateTitle: "Scegli una data",
    selectDateBody: "Tocca un giorno verde nel calendario per vedere prezzi reali e disponibilità.",
    calendarHint: "Tocca un giorno disponibile per vedere i prezzi",
