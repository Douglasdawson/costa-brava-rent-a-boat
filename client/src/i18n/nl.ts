...
export const nl: Translations = {
  ...
  boatDetail: {
    ...
    selectDateTitle: "Kies een datum",
    selectDateBody: "Tik op een groene dag in de kalender voor echte prijzen en beschikbaarheid.",
    calendarHint: "Tik op een beschikbare dag om de prijzen te zien",
