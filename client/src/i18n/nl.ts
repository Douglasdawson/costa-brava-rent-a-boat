...
export const nl: Translations = {
  ...
  hero: {
    title: 'Bootje Huren zonder Vaarbewijs in Blanes',
    subtitle: 'Ontdek geheime baaien van de Costa Brava, alleen bereikbaar per boot. Geen ervaring nodig. 15 min instructie en varen maar.',
    subtitleLine1: 'Ontdek geheime baaien van de Costa Brava, alleen bereikbaar per boot.',
    subtitleLine2: 'Geen ervaring nodig. 15 min instructie en varen maar.',
  ...
  locationPages: {
    blanes: {
      ...
      sections: {
        ...
        expTossaDesc: 'Met een boot met vaarbewijs vaart u een uur naar het noorden naar de Vila Vella van Tossa de Mar, langs verborgen baaien en spectaculaire kliffen.',
    ...
    malgrat: {
      ...
      sections: {
        ...
        boatDestinationsDesc: 'Vaar naar Lloret de Mar (25 min.) en Tossa de Mar (1 uur) en ontdek baaien zoals Cala Sant Francesc en Cala Brava.',
