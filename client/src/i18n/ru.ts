...
export const ru: Translations = {
  ...
  hero: {
    ...
    subtitle: 'Кристально чистые бухты, доступные только на лодке. Опыт не нужен. Отправление из Бланеса.',
    subtitleLine1: 'Кристально чистые бухты, доступные только на лодке.',
    subtitleLine2: 'Опыт не нужен. Отправление из Бланеса.',
    bookNow: 'Проверить наличие',
