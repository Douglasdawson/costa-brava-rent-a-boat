...
export interface Translations {
  ...
  // Retargeted 2026-08-06 to the self-drive powerboat vocabulary (lancha /
  // sin patrón / Tossa). The server FAQPage and HowTo schemas are built from
  // these same keys, so renaming any of them changes the emitted JSON-LD.
  categoryLicensed?: {
    heroTitle: string;
    heroDescription: string;
    badgeLicense: string;
    ...
    routeTitle: string;
    routeIntro: string;
    routeStopLloret: string;
    routeStopSantaCristina: string;
    routeStopCanyelles: string;
    routeStopTossa: string;
    ...
    comparisonPriceLow: string;
    comparisonPriceHigh: string;
    comparisonMingolla: string;
    comparisonTrimarchi: string;
    comparisonPacific: string;
    regulationTitle: string;
    regulationIntro: string;
    regulationForeign: string;
    regulationFuelDeposit: string;
    howToTitle: string;
    howToIntro: string;
    howToStep1Title: string;
    howToStep1Text: string;
    ...
    vsMarketplacesRow4Market: string;
    vsMarketplacesConclusion: string;
    faqSinPatronQuestion: string;
    faqSinPatronAnswer: string;
    faqTossaQuestion: string;
    faqTossaAnswer: string;
    faqLanchaQuestion: string;
    faqLanchaAnswer: string;
    faqTitulacionQuestion: string;
    faqTitulacionAnswer: string;
    faqForeignLicenseQuestion: string;
    faqForeignLicenseAnswer: string;
    faqPriceQuestion: string;
    faqPriceAnswer: string;
    faqFuelQuestion: string;
    faqFuelAnswer: string;
    faqDepositQuestion: string;
    faqDepositAnswer: string;
    faqWeatherQuestion: string;
    faqWeatherAnswer: string;
    faqCrossLinkLabel: string;
    crossLinkFromFree: string;
    linksTitle: string;
    linksBlanes: string;
    linksTossa: string;
    linksBlogTossa: string;
    linksPricing: string;
    linksNoLicense: string;
    linksSkipper: string;
    ctaTitle: string;
    ctaDescription: string;
    ctaButton: string;
  ...
  activitySunset?: {
    ...
    heroTitle?: string;
    heroDescription?: string;
    badgeGoldenHour?: string;
    badgeDuration?: string;
    badgeCouples?: string;
    whyTitle?: string;
    whyGoldenHourTitle?: string;
    whyGoldenHourDesc?: string;
    whyPrivateTitle?: string;
    whyPrivateDesc?: string;
    whyAffordableTitle?: string;
    whyAffordableDesc?: string;
    whyTemperatureTitle?: string;
    whyTemperatureDesc?: string;
    viewpointsTitle?: string;
    sunsetTimesTitle?: string;
    sunsetTimesTableMonth?: string;
    sunsetTimesTableTime?: string;
    sunsetTimesTableDeparture?: string;
    sunsetTimesNote?: string;
    romanticIdeasTitle?: string;
    whatToBringTitle?: string;
    whatToBringEssentials?: string;
    whatToBringEssentialItems?: string[];
    whatToBringNice?: string;
    whatToBringNiceItems?: string[];
    exploreMore?: string;
    linkNoLicense?: string;
    linkSnorkel?: string;
    linkPrices?: string;
    linkBlanes?: string;
    linkRoutes?: string;
  ...
  activitySnorkel?: {
    ...
    badgeDuration?: string;
    whyTitle?: string;
    whyAccessTitle?: string;
    whyAccessDesc?: string;
    whyBaseTitle?: string;
    whyBaseDesc?: string;
    whyMultiTitle?: string;
    whyMultiDesc?: string;
    whyNoExpTitle?: string;
    whyNoExpDesc?: string;
    spotsTitle?: string;
    ...
    boatsTitle?: string;
    routeTitle?: string;
    routeSteps?: Array<{ title: string; desc: string }>;
    exploreTitle?: string;
    linkNoLicense?: string;
    linkLicensed?: string;
    linkFamilies?: string;
  ...
  activityFamilies?: {
    ...
    heroDescription?: string;
    badgeNoLicense?: string;
    badgeKidsVests?: string;
    badgeFuel?: string;
    whyTitle?: string;
    whyMemoriesTitle?: string;
    whyMemoriesDesc?: string;
    whyNoStressTitle?: string;
    whyNoStressDesc?: string;
    whyCalmCovesTitle?: string;
    whyCalmCovesDesc?: string;
    whyFlexTitle?: string;
    whyFlexDesc?: string;
    safetyTitle?: string;
    routesTitle?: string;
  ...
  activityFishing?: {
    ...
    whyPortTitle?: string;
    whyPortDesc?: string;
    whyVarietyTitle?: string;
    whyVarietyDesc?: string;
    whySeasonTitle?: string;
    whySeasonDesc?: string;
    speciesTitle?: string;
    seasonLabel?: string;
    whereLabel?: string;
    ...
    licenseTitle?: string;
    licenseDesc?: string;
    catchLimitsTitle?: string;
    catchLimitsItems?: string[];
    minSizesTitle?: string;
    minSizesItems?: string[];
    prohibitedTitle?: string;
    prohibitedDesc?: string;
    equipmentTitle?: string;
    whatToBringTitle?: string;
    whatToBringItems?: string[];
    whereBaitTitle?: string;
    whereBaitDesc?: string;
