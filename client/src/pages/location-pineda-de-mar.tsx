            ...
            <CardContent>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <h3 className="font-semibold text-lg mb-3">9 barcos para elegir</h3>
                  <p className="text-muted-foreground">
                    Disponemos de una flota de 9 barcos que incluye embarcaciones sin licencia ideales para familias y principiantes, asi como barcos con licencia para navegantes experimentados. Capacidad de 4 a 11 personas segun el modelo elegido.
                  </p>
                </div>
                <div>
