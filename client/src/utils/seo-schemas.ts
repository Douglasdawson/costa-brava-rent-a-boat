...
// Glossary moved to shared/nauticalGlossary.ts so it can be served by the
// /api/ai-glossary endpoint as well. Re-exported here to preserve existing
// imports.
export { NAUTICAL_GLOSSARY_ES, type GlossaryTerm } from "@shared/nauticalGlossary";
