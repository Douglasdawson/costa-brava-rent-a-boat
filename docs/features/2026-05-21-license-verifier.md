...
**Estado**: TIER 1 + TIER 2 entregados. TIER 3 #1 (service worker), #2 (standalone PWA), #3 (offline awareness), #4 (geo-IP), #5 (SVG flags Windows) y #6 (keyboard nav a11y) entregados el mismo día. Solo queda #7 (iconos PWA maskable).
