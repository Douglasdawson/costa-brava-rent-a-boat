...
const BOAT_REVIEW_DATA: Record<string, { reviews: BoatReviewEntry[]; average: number; count: number }> = {
  "solar-450": {
    ...
    reviews: [
      { name: "Carlos Martinez", rating: 5, text: "Barco perfecto para una familia con ninos. Muy estable y el toldo Bi Mini es genial para protegerse del sol.", date: "2024-06" },
      ...
      { name: "Pierre Dubois", rating: 5, text: "Bateau tres stable, parfait pour une sortie en famille. Le bain de soleil rembourre est un vrai plus.", date: "2024-07" },
      { name: "Thomas Mueller", rating: 5, text: "Sehr stabiles Boot, perfekt fuer Familien mit Kindern. Das gepolsterte Sonnendeck ist super bequem.", date: "2024-07" },
    ],
  },
  "remus-450": {
    average: 4.8, count: 28,
    reviews: [
      { name: "Elena Navarro", rating: 5, text: "Sin titulo nautico y disfrutamos un dia genial en el mar. Mis hijos se lo pasaron en grande.", date: "2024-08" },
      ...
      { name: "Giulia Bianchi", rating: 5, text: "Il prendisole imbottito e comodissimo. I bambini si sono divertiti tantissimo.", date: "2024-08" },
      { name: "Marie Lefevre", rating: 5, text: "Pas besoin de permis, c'est genial. L'echelle de bain est tres pratique pour les enfants.", date: "2024-08" },
  ...
  "remus-450-ii": {
    ...
    reviews: [
      { name: "Fernando Iglesias", rating: 5, text: "Mismo modelo que el Remus 450, perfecto cuando el otro esta reservado. Calidad identica.", date: "2025-07" },
      { name: "Fiona Campbell", rating: 5, text: "Perfect family boat. Fuel included in the price which was a nice surprise.", date: "2025-08" },
      { name: "Luca Conti", rating: 5, text: "Ottima barca, stessa qualita del Remus 450. Molto comoda per le famiglie.", date: "2025-07" },
      { name: "Antoine Bernard", rating: 4, text: "Bon petit bateau, ideal pour une sortie en famille. Le Bi Mini protege bien du soleil.", date: "2025-06" },
  ...
  "astec-400": {
    ...
    reviews: [
      { name: "Raquel Dominguez", rating: 5, text: "Barco compacto pero muy comodo para dos personas. Perfecto para parejas.", date: "2024-07" },
      { name: "Claire Dumont", rating: 4, text: "Bateau compact mais tres maniable. Ideal pour un couple, un peu juste pour plus.", date: "2024-08" },
      ...
      { name: "Sabine Hoffmann", rating: 5, text: "Kleines aber feines Boot. Perfekt fuer einen romantischen Tag auf dem Meer.", date: "2024-09" },
  ...
  "astec-480": {
    ...
    reviews: [
      { name: "Javier Herrero", rating: 5, text: "Mas espacioso que el Astec 400, perfecto para grupos de amigos. Equipo de musica genial.", date: "2024-06" },
      ...
      { name: "Stefan Braun", rating: 5, text: "Geraeumiges Boot mit tollem Soundsystem. Perfekt fuer eine Gruppe von Freunden.", date: "2025-07" },
  ...
  "mingolla-brava-19": {
    ...
    reviews: [
      { name: "Miguel Angel Ruiz", rating: 5, text: "Barco con licencia pero vale la pena. Potente y comodo, llegamos hasta Tossa de Mar.", date: "2024-08" },
      ...
      { name: "Hans Schneider", rating: 5, text: "Leistungsstarkes Boot. GPS und Echolot sind sehr nuetzlich. Tossa de Mar war wunderbar.", date: "2025-08" },
      { name: "Monika Weber", rating: 5, text: "Tolles Boot mit viel Leistung. Der GPS ist sehr praktisch fuer die Navigation.", date: "2025-07" },
    ],
  },
  "trimarchi-57s": {
    average: 4.9, count: 16,
    reviews: [
      { name: "Pedro Sanchez Vidal", rating: 5, text: "El Trimarchi es una pasada. Potente, comodo y con un GPS excelente. Llegamos a Tossa sin problemas.", date: "2025-06" },
      ...
      { name: "Ana Belen Torres", rating: 5, text: "Barco premium, se nota la diferencia. Muy comodo y con equipamiento completo.", date: "2025-07" },
  ...
  "pacific-craft-625": {
    ...
    reviews: [
      ...
      { name: "Philippe Moreau", rating: 5, text: "Magnifique bateau, tres puissant. Nous sommes alles jusqu'a Tossa de Mar et au-dela.", date: "2025-07" },
      ...
      { name: "Marco Rossetti", rating: 5, text: "La barca piu bella della flotta. Molto potente e comoda per escursioni lunghe.", date: "2025-08" },
      { name: "Thomas Mueller", rating: 5, text: "Erstklassiges Boot fuer laengere Ausfluege. Sehr leistungsstark und komfortabel.", date: "2025-07" },
    ],
  },
  "excursion-privada": {
    average: 5.0, count: 12,
    reviews: [
      { name: "Ana Belen Torres", rating: 5, text: "Experiencia unica. El patron nos llevo a calas secretas que jamas habriamos encontrado solos.", date: "2025-07" },
      ...
      { name: "Sophie Martin", rating: 5, text: "Experience inoubliable. Le capitaine connait chaque crique secrete. Parfait pour les celebrations.", date: "2025-08" },
      ...
      { name: "Sabine Hoffmann", rating: 5, text: "Unvergessliches Erlebnis. Der Kapitaen kennt jede versteckte Bucht. Perfekt fuer Feiern.", date: "2025-08" },
    ],
  },
};
