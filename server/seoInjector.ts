...
const STATIC_META: Record<string, Partial<Record<LangCode, SEOMeta>>> = {
  "/": {
    ...
    fr: {
      ...
      ogTitle: `Location Bateau Blanes | Port de Blanes ${SEASON_YEAR}`,
      ogDescription: "Louez un bateau sans permis au Port de Blanes. Dès 70€/h, carburant inclus. 8 bateaux. Réservez maintenant!",
    },
    de: {
      ...
      ogTitle: `Bootsverleih Blanes | Hafen Blanes ${SEASON_YEAR}`,
      ogDescription: "Bootsverleih im Hafen Blanes ohne Führerschein. 8 Boote ab 70€/h. Kraftstoff inklusive. Buchen Sie Ihr Abenteuer!",
    },
    ca: {
    ...
    nl: {
      ...
      ogTitle: `Bootverhuur Blanes | Haven Blanes ${SEASON_YEAR}`,
      ogDescription: "Bootverhuur in Haven Blanes. 8 boten zonder vaarbewijs vanaf 70€/u. Brandstof inbegrepen. Boek uw avontuur!",
    },
    it: {
      ...
      ogTitle: `Noleggio Barche Blanes | Porto di Blanes ${SEASON_YEAR}`,
      ogDescription: "Noleggio barche senza patente al Porto di Blanes. 8 barche da 70€/h. Carburante incluso. Prenota la tua avventura!",
    },
    ru: {
      title: "Аренда Лодок Бланес Без Лицензии | Порт Бланес от 70€/ч",
      description: "Аренда лодок в порту Бланес без лицензии от 70€/ч. Топли��о включено. 8 лодок. 4.8★ Google (300+ отзывов). Бронируйте онлайн или WhatsApp.",
      ogTitle: `Аренда Лодок Бланес | Порт Бланес ${SEASON_YEAR}`,
      ogDescription: "Аренда лодок без лицензии в порту Бланес. 8 лодок от 70€/ч. Топливо включено. Забронируйте приключение!",
    },
  },
  "/faq": {
    es: {
