...
const FAQS_ES = [
  ...
  },
  {
    ...
    content: "Ofrecemos alquileres de 2, 4, 6 u 8 horas. Los horarios habituales de salida son: mañana (10:00), mediodía (14:00) y tarde (18:00 en verano). Para alquileres de dia completo, la salida es a las 10:00 y la devolucion antes del atardecer.",
    category: "faq",
  ...
  {
    title: "Mal tiempo",
    content: "Si hay mal tiempo (viento fuerte, tormenta, oleaje excesivo), la salida se pospone o se ofrece cambio de fecha sin coste adicional. La seguridad es nuestra prioridad. Nuestro equipo monitoriza las condiciones meteorologicas y te avisaremos con antelación si hay cambios.",
    category: "policy",
...
const FAQS_CA = [
  ...
  },
  {
    ...
    content: "Tenim tres temporades: BAIXA (abril, maig, juny, setembre, octubre) amb els millors preus; MITJA (juliol) amb preus intermedis; i ALTA (agost) que es la temporada de maxima demanda. Els preus varien segons el vaixell i la duració del lloguer.",
    category: "faq",
...
const BLOG_ES = [
  ...
  },
  {
    ...
    content: "Tenemos una guia completa sobre como alquilar un barco sin licencia en Blanes. Explica los requisitos, tipos de barco disponibles, normativa y consejos para principiantes. Léela aquí: https://www.costabravarentaboat.com/blog/alquiler-barco-sin-licencia-blanes-guia",
    category: "blog",
  ...
  },
  {
    ...
    content: "Si quieres saber que hacer en Blanes ademas de alquilar un barco, tenemos un articulo con 15 planes imprescindibles para el verano: restaurantes, playas, actividades, vida nocturna y mas. Léelo en: https://www.costabravarentaboat.com/blog/que-hacer-en-blanes-verano",
    category: "blog",
  ...
  },
  {
    ...
    content: "Si es tu primera vez alquilando un barco, tenemos una guia con consejos practicos para que disfrutes al maximo sin experiencia previa. Cubre seguridad, navegación básica, que llevar y errores comunes a evitar. Léela en: https://www.costabravarentaboat.com/blog/consejos-primera-vez-alquilar-barco",
    category: "blog",
  ...
  },
  {
    ...
    content: "Para información detallada sobre las temporadas de navegación en la Costa Brava y cuando es el mejor momento para reservar, consulta nuestro blog. Temporada baja (abril-junio, septiembre-octubre) ofrece mejores precios y menos gente. Temporada alta (agosto) requiere reservar con antelación. Mas info en nuestro blog: https://www.costabravarentaboat.com/blog",
    category: "blog",
...
const BLOG_CA = [
  ...
  },
  {
    ...
    content: "Tenim una guia completa sobre com llogar un vaixell sense llicencia a Blanes. Explica els requisits, tipus de vaixell disponibles, normativa i consells per a principiants. Llegeix-la aqui: https://www.costabravarentaboat.com/blog/alquiler-barco-sin-licencia-blanes-guia",
    category: "blog",
...
const BLOG_FR = [
  {
    ...
    content: "Decouvrez les 10 meilleures criques de la Costa Brava accessibles en bateau dans notre article de blog. Il comprend des criques cachees, des conseils de mouillage et des photos. Lisez-le ici: https://www.costabravarentaboat.com/blog/mejores-calas-costa-brava-en-barco",
    category: "blog",
  ...
  },
  {
    ...
    content: "Nous avons un guide complet sur la location de bateaux sans permis a Blanes. Il explique les conditions, les types de bateaux disponibles, la reglementation et les conseils pour les debutants. Lisez-le ici: https://www.costabravarentaboat.com/blog/alquiler-barco-sin-licencia-blanes-guia",
    category: "blog",
  ...
  },
  {
    ...
    content: "Decouvrez les meilleurs itineraires en bateau depuis Blanes dans notre article, y compris des routes vers Tossa de Mar, Lloret, des criques cachees et des villages cotiers. Lisez-le ici: https://www.costabravarentaboat.com/blog/rutas-barco-desde-blanes",
    category: "blog",
...
const BLOG_DE = [
  {
    ...
    content: "Entdecken Sie die 10 besten Buchten der Costa Brava, die mit dem Boot erreichbar sind, in unserem Blogartikel. Er enthalt versteckte Buchten, Ankertipps und Fotos. Lesen Sie ihn hier: https://www.costabravarentaboat.com/blog/mejores-calas-costa-brava-en-barco",
    category: "blog",
  ...
  },
  {
    ...
    content: "Wir haben einen umfassenden Ratgeber zur Bootsmiete ohne Fuhrerschein in Blanes. Er erklart die Voraussetzungen, verfugbare Bootstypen, Vorschriften und Tipps fur Anfanger. Lesen Sie ihn hier: https://www.costabravarentaboat.com/blog/alquiler-barco-sin-licencia-blanes-guia",
    category: "blog",
  ...
  },
  {
    ...
    content: "Entdecken Sie die besten Bootsrouten ab Blanes in unserem Artikel, einschliesslich Routen nach Tossa de Mar, Lloret, versteckten Buchten und Kustendorfern. Lesen Sie ihn hier: https://www.costabravarentaboat.com/blog/rutas-barco-desde-blanes",
    category: "blog",
