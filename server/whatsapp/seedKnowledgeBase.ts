...
const FAQS_CA = [
  ...
  },
  {
    ...
    content: "Tenim vaixells per a tothom. Oferim vaixells SENSE llicencia que qualsevol persona major de 18 anys pot conduir despres d'un breu briefing de seguretat. Tambe tenim vaixells AMB llicencia per a qui te titulacio nautica i busca embarcacions mes potents.",
    category: "faq",
    keywords: ["llicencia", "carnet", "titulacio", "sense llicencia"],
    priority: 10,
  },
  {
    title: "Que inclou el lloguer",
    content: "El lloguer inclou: equip de seguretat obligatori (armilles salvavides, extintor, bengales), ancora i cap de fondeig, tendal o bimini per a la proteccio solar, nevera portatil, i un briefing de seguretat abans de sortir. El combustible esta inclos en alguns vaixells, consulta les especificacions de cada embarcacio.",
    category: "faq",
    keywords: ["inclou", "inclos", "equip", "seguretat"],
    priority: 9,
  },
  {
    title: "Politica de diposit",
    content: "Es requereix un diposit que varia segons el vaixell (entre 200 i 500 euros). El diposit es paga abans de sortir i es retorna integrament en lliurar el vaixell en les mateixes condicions. Es pot pagar en efectiu o amb targeta.",
    category: "policy",
    keywords: ["diposit", "fianca", "retorn"],
    priority: 9,
  },
  {
    title: "Horaris de sortida i duracio",
    content: "Oferim lloguers de 2, 4, 6 o 8 hores. Els horaris habituals de sortida son: mati (10:00), migdia (14:00) i tarda (18:00 a l'estiu). Per a lloguers de dia complet, la sortida es a les 10:00 i la devolucio abans de la posta de sol.",
    category: "faq",
    keywords: ["horari", "hores", "duracio", "sortida"],
    priority: 8,
  },
  {
    title: "Temporades i preus",
    content: "Tenim tres temporades: BAIXA (abril, maig, juny, setembre, octubre) amb els millors preus; MITJA (juliol) amb preus intermedis; i ALTA (agost) que es la temporada de maxima demanda. Els preus varien segons el vaixell i la duracio del lloguer.",
    category: "faq",
  ...
  {
    title: "Mal temps",
    content: "Si hi ha mal temps (vent fort, tempesta, onatge excessiu), la sortida es posposara o s'oferira canvi de data sense cost addicional. La seguretat es la nostra prioritat. El nostre equip monitoritza les condicions meteorologiques i t'avisarem amb antelacio si hi ha canvis.",
    category: "policy",
...
const ROUTES_CA = [
  {
    ...
    content: "Des del port de Blanes, navega cap al nord per descobrir cales verges com Cala Sant Francesc, Sa Forcanera i Cala Bona. Son cales tranquilles amb aigues cristallines perfectes per banyar-se i fer snorkel. Temps estimat: 2-4 hores segons les parades.",
    category: "route",
    keywords: ["cala", "blanes", "ruta", "snorkel", "platja"],
    priority: 7,
  },
  {
    title: "Excursio a Tossa de Mar",
    content: "Una de les rutes mes populars. Navega des de Blanes cap al nord costejant la bella Costa Brava fins arribar a Tossa de Mar amb el seu famós recinte emmurallat. El trajecte dura aproximadament 45 minuts per sentit. Es recomana lloguer de 4-6 hores per gaudir de la ruta completa.",
    category: "route",
    keywords: ["tossa", "excursio", "costa", "muralla"],
    priority: 8,
  },
  {
    title: "Ruta cap a Lloret de Mar",
    content: "Cap al sud des de Blanes, pots explorar la costa de Lloret de Mar, passant per Santa Cristina i la seva ermita. Es una ruta mes curta, ideal per a lloguers de 2-4 hores. Les platges de Lloret son mes concorregudes pero molt pintoresques.",
    category: "route",
  ...
  },
  {
    ...
    content: "Per fondear, busca cales amb fons de sorra (millor agarre) i protegides del vent. Algunes recomanacions: Cala Sant Francesc (sorra, molt tranquilla), Cala Treumal (mixt, prop de Blanes), i Sa Forcanera (rocosa, aigues molt clares). Utilitza l'ancora amb almenys 3 vegades la profunditat en cap.",
    category: "route",
    keywords: ["fondeig", "ancora", "bany", "cala", "sorra"],
    priority: 6,
  },
];
...
const GENERAL_CA = [
  {
    title: "Ubicacio i com arribar",
    content: "Estem ubicats al Port de Blanes, Costa Brava, provincia de Girona. Blanes es a 60km de Barcelona i 35km de Girona. Pots arribar en cotxe (parking disponible), tren (estacio de Blanes a 10 minuts a peu) o autobus. T'enviarem la ubicacio exacta en confirmar la reserva.",
    category: "general",
    keywords: ["ubicacio", "adreca", "arribar", "port", "blanes"],
    priority: 7,
  },
  {
    title: "Que portar al vaixell",
    content: "Et recomanem portar: proteccio solar alta, gorra o barret, tovalloles, banyador, aigua i menjar si planegeu parades llargues, ulleres de sol, equip de snorkel si en teniu (tambe es pot llogar), i roba lleugera. Porta calcado que es pugui mullar per pujar i baixar del vaixell.",
    category: "general",
  ...
  },
  {
    ...
    content: "Els nostres vaixells tenen capacitats des de 4 fins a 8 persones depenent del model. Es important respectar la capacitat maxima per seguretat. Per a grups grans, podem organitzar sortides amb diversos vaixells. Contacta amb nosaltres per a grups especials.",
    category: "general",
...
const FAQS_FR = [
  ...
  },
  {
    ...
    content: "Nous avons des bateaux pour tout le monde. Nous proposons des bateaux SANS permis que toute personne de plus de 18 ans peut conduire apres un bref briefing de securite. Nous avons egalement des bateaux AVEC permis pour ceux qui possedent un titre nautique et recherchent des embarcations plus puissantes.",
    category: "faq",
  ...
  },
  {
    ...
    content: "La location comprend: equipement de securite obligatoire (gilets de sauvetage, extincteur, fusees eclairantes), ancre et corde de mouillage, taud ou bimini pour la protection solaire, glaciere portable, et un briefing de securite avant le depart. Le carburant est inclus sur certains bateaux, veuillez consulter les specifications de chaque embarcation.",
    category: "faq",
    keywords: ["inclus", "equipement", "securite", "ce qui est inclus"],
    priority: 9,
  },
  {
    title: "Politique de caution",
    content: "Une caution est requise et varie selon le bateau (entre 200 et 500 euros). La caution est payee avant le depart et est integralement remboursee lors de la restitution du bateau dans les memes conditions. Le paiement peut etre effectue en especes ou par carte.",
    category: "policy",
    keywords: ["caution", "depot", "remboursement"],
    priority: 9,
  },
  {
    title: "Horaires de depart et duree",
    content: "Nous proposons des locations de 2, 4, 6 ou 8 heures. Les horaires habituels de depart sont: le matin (10h00), le midi (14h00) et l'apres-midi (18h00 en ete). Pour les locations a la journee, le depart est a 10h00 et le retour avant le coucher du soleil.",
    category: "faq",
    keywords: ["horaire", "heures", "duree", "depart"],
    priority: 8,
  },
  {
    title: "Saisons et tarifs",
    content: "Nous avons trois saisons: BASSE (avril, mai, juin, septembre, octobre) avec les meilleurs tarifs; MOYENNE (juillet) avec des tarifs intermediaires; et HAUTE (aout) qui est la saison de plus forte demande. Les tarifs varient selon le bateau et la duree de la location.",
    category: "faq",
    keywords: ["saison", "prix", "tarif", "cout"],
    priority: 8,
  },
  {
  ...
  {
    title: "Mauvais temps",
    content: "En cas de mauvais temps (vent fort, tempete, houle excessive), le depart sera reporte ou un changement de date sera propose sans frais supplementaires. La securite est notre priorite absolue. Notre equipe surveille les conditions meteorologiques et vous avertira a l'avance en cas de changement.",
    category: "policy",
    keywords: ["meteo", "tempete", "vent", "securite", "previsions"],
    priority: 8,
  },
];
...
const ROUTES_FR = [
  {
    ...
    content: "Depuis le port de Blanes, naviguez vers le nord pour decouvrir des criques sauvages telles que Cala Sant Francesc, Sa Forcanera et Cala Bona. Ce sont des criques tranquilles aux eaux cristallines, parfaites pour se baigner et faire du snorkeling. Duree estimee: 2 a 4 heures selon les arrets.",
    category: "route",
  ...
  {
    title: "Excursion a Tossa de Mar",
    content: "L'une des routes les plus populaires. Naviguez depuis Blanes vers le nord en longeant la belle Costa Brava jusqu'a Tossa de Mar avec sa celebre ville medievale fortifiee. Le trajet dure environ 45 minutes dans chaque sens. Une location de 4 a 6 heures est recommandee pour profiter pleinement de la route.",
    category: "route",
    keywords: ["tossa", "excursion", "cote", "remparts"],
    priority: 8,
  },
  {
    title: "Route vers Lloret de Mar",
    content: "En direction du sud depuis Blanes, vous pouvez explorer la cote de Lloret de Mar, en passant par Santa Cristina et son ermitage. C'est une route plus courte, ideale pour des locations de 2 a 4 heures. Les plages de Lloret sont plus frequentees mais tres pittoresques.",
    category: "route",
  ...
  },
  {
    ...
    content: "Pour mouiller, cherchez des criques avec un fond de sable (meilleure tenue) et a l'abri du vent. Quelques recommandations: Cala Sant Francesc (sableux, tres calme), Cala Treumal (mixte, pres de Blanes), et Sa Forcanera (rocheux, eau tres claire). Utilisez l'ancre avec au moins 3 fois la profondeur en chaine ou en corde.",
    category: "route",
...
const GENERAL_FR = [
  {
    ...
    content: "Nous sommes situes au Port de Blanes, Costa Brava, dans la province de Girona. Blanes se trouve a 60 km de Barcelone et a 35 km de Girona. Vous pouvez venir en voiture (parking disponible), en train (la gare de Blanes est a 10 minutes a pied) ou en bus. Nous vous enverrons la localisation exacte lors de la confirmation de votre reservation.",
    category: "general",
    keywords: ["localisation", "adresse", "acces", "port", "blanes"],
    priority: 7,
  },
  {
    title: "Que apporter sur le bateau",
    content: "Nous vous recommandons d'apporter: une protection solaire a indice eleve, une casquette ou un chapeau, des serviettes, un maillot de bain, de l'eau et de la nourriture si vous prevoyez de longues escales, des lunettes de soleil, du materiel de snorkeling si vous en avez (egalement disponible a la location), et des vetements legers. Apportez des chaussures qui peuvent se mouiller pour monter et descendre du bateau.",
    category: "general",
    keywords: ["apporter", "bagages", "preparer", "necessaire"],
    priority: 6,
  },
  {
    title: "Capacite des bateaux",
    content: "Nos bateaux ont des capacites allant de 4 a 8 personnes selon le modele. Il est important de respecter la capacite maximale pour des raisons de securite. Pour les grands groupes, nous pouvons organiser des sorties avec plusieurs bateaux. Contactez-nous pour les groupes speciaux.",
    category: "general",
    keywords: ["capacite", "personnes", "groupe", "combien"],
    priority: 6,
  },
];
...
const FAQS_DE = [
  ...
  {
    title: "Benotigt man einen Fuhrerschein fur die Bootsmiete",
    content: "Wir haben Boote fur jeden. Wir bieten Boote OHNE Fuhrerschein an, die jede Person uber 18 Jahre nach einer kurzen Sicherheitseinweisung fahren kann. Wir haben auch Boote MIT Fuhrerschein fur diejenigen, die einen Bootsschein besitzen und nach leistungsstarkeren Fahrzeugen suchen.",
    category: "faq",
    keywords: ["fuhrerschein", "bootsschein", "lizenz", "ohne fuhrerschein"],
    priority: 10,
  },
  {
    title: "Was ist im Mietpreis enthalten",
    content: "Die Miete umfasst: obligatorische Sicherheitsausrustung (Schwimmwesten, Feuersloscher, Leuchtraketen), Anker und Mooring-Leine, Sonnensegel oder Bimini zum Sonnenschutz, portable Kuhlbox und eine Sicherheitseinweisung vor der Abfahrt. Der Kraftstoff ist bei einigen Booten enthalten; bitte prufen Sie die Spezifikationen des jeweiligen Fahrzeugs.",
    category: "faq",
    keywords: ["enthalten", "ausrustung", "sicherheit", "inklusive"],
    priority: 9,
  },
  {
    title: "Kaution",
    content: "Es wird eine Kaution verlangt, die je nach Boot variiert (zwischen 200 und 500 Euro). Die Kaution wird vor der Abfahrt bezahlt und bei Ruckgabe des Bootes im selben Zustand vollstandig zuruckerstattet. Die Zahlung kann in bar oder mit Karte erfolgen.",
    category: "policy",
    keywords: ["kaution", "pfand", "ruckerstattung"],
    priority: 9,
  },
  {
    title: "Abfahrtzeiten und Dauer",
    content: "Wir bieten Vermietungen von 2, 4, 6 oder 8 Stunden an. Ubliche Abfahrtzeiten sind: morgens (10:00 Uhr), mittags (14:00 Uhr) und nachmittags (18:00 Uhr im Sommer). Fur Ganztagsvermietungen ist die Abfahrt um 10:00 Uhr und die Ruckgabe vor Sonnenuntergang.",
    category: "faq",
  ...
  },
  {
    ...
    content: "Wir haben drei Saisons: NEBENSAISON (April, Mai, Juni, September, Oktober) mit den besten Preisen; MITTELSAISON (Juli) mit mittleren Preisen; und HOCHSAISON (August), die Saison mit der hochsten Nachfrage. Die Preise variieren je nach Boot und Mietdauer.",
    category: "faq",
  ...
  },
  {
    ...
    content: "Bei schlechtem Wetter (starker Wind, Sturm, ubermassiger Wellengang) wird die Abfahrt verschoben oder ein kostenloser Datumswechsel angeboten. Sicherheit hat fur uns hochste Prioritat. Unser Team beobachtet die Wetterbedingungen und informiert Sie rechtzeitig, wenn sich Anderungen ergeben.",
    category: "policy",
...
const ROUTES_DE = [
  {
    ...
    content: "Vom Hafen von Blanes aus navigieren Sie nach Norden, um unberuhrte Buchten wie Cala Sant Francesc, Sa Forcanera und Cala Bona zu entdecken. Es sind ruhige Buchten mit kristallklarem Wasser, ideal zum Schwimmen und Schnorcheln. Geschatzte Zeit: 2 bis 4 Stunden je nach Stopps.",
    category: "route",
  ...
  },
  {
    ...
    content: "Eine der beliebtesten Routen. Fahren Sie von Blanes nach Norden entlang der wunderschonen Costa Brava bis nach Tossa de Mar mit seiner beruhmten mittelalterlichen Stadtmauer. Die Fahrt dauert ca. 45 Minuten je Richtung. Eine Miete von 4 bis 6 Stunden wird empfohlen, um die gesamte Route zu genießen.",
    category: "route",
    keywords: ["tossa", "ausflug", "kuste", "stadtmauer"],
    priority: 8,
  },
  {
    title: "Route nach Lloret de Mar",
    content: "Sudlich von Blanes konnen Sie die Kuste von Lloret de Mar erkunden und dabei an Santa Cristina und seiner Einsiedelei vorbeikommen. Dies ist eine kurzere Route, ideal fur Vermietungen von 2 bis 4 Stunden. Die Strande von Lloret sind belebter, aber sehr malerisch.",
    category: "route",
    keywords: ["lloret", "santa cristina", "sud", "einsiedelei"],
    priority: 7,
  },
  {
    title: "Ankern und Baden in Buchten",
    content: "Beim Ankern suchen Sie Buchten mit Sandboden (besserer Halt) und Windschutz. Einige Empfehlungen: Cala Sant Francesc (Sandgrund, sehr ruhig), Cala Treumal (gemischt, in der Nahe von Blanes), und Sa Forcanera (felsig, sehr klares Wasser). Verwenden Sie den Anker mit mindestens der 3-fachen Tiefe an Kette oder Tau.",
    category: "route",
...
const GENERAL_DE = [
  {
    ...
    content: "Wir befinden uns im Hafen von Blanes, Costa Brava, in der Provinz Girona. Blanes liegt 60 km von Barcelona und 35 km von Girona entfernt. Sie konnen mit dem Auto (Parkplatz vorhanden), mit dem Zug (Bahnhof Blanes ist 10 Minuten zu Fuß entfernt) oder mit dem Bus anreisen. Wir senden Ihnen den genauen Standort bei der Buchungsbestatigung.",
    category: "general",
  ...
  },
  {
    ...
    content: "Wir empfehlen mitzubringen: Sonnenschutz mit hohem Lichtschutzfaktor, Mutze oder Hut, Handtucher, Badeanzug oder Badehose, Wasser und Essen fur langere Stopps, Sonnenbrille, Schnorchelausrustung falls vorhanden (auch zum Mieten erhaltlich) und leichte Kleidung. Bringen Sie Schuhe mit, die nass werden konnen, um das Boot betreten und verlassen zu konnen.",
    category: "general",
    keywords: ["mitbringen", "gepack", "vorbereitung", "notwendig"],
    priority: 6,
  },
  {
    title: "Kapazitat der Boote",
    content: "Unsere Boote haben je nach Modell eine Kapazitat von 4 bis 8 Personen. Es ist wichtig, die Hochstkapazitat aus Sicherheitsgrunden einzuhalten. Fur großere Gruppen konnen wir Ausflugsfahrten mit mehreren Booten arrangieren. Kontaktieren Sie uns fur Sondergruppen.",
    category: "general",
    keywords: ["kapazitat", "personen", "gruppe", "wie viele"],
    priority: 6,
  },
];
...
const FAQS_IT = [
  ...
  {
    title: "E necessaria la patente per noleggiare una barca",
    content: "Abbiamo barche per tutti. Offriamo barche SENZA patente che qualsiasi persona maggiore di 18 anni puo guidare dopo un breve briefing di sicurezza. Abbiamo anche barche CON patente per chi possiede una qualifica nautica e cerca imbarcazioni piu potenti.",
    category: "faq",
    keywords: ["patente", "licenza", "qualifica", "senza patente"],
    priority: 10,
  },
  {
    title: "Cosa e incluso nel noleggio",
    content: "Il noleggio include: attrezzatura di sicurezza obbligatoria (giubbotti salvagente, estintore, razzi), ancora e cima di ormeggio, tenda o bimini per la protezione solare, frigo portatile e un briefing di sicurezza prima della partenza. Il carburante e incluso in alcune barche; consultare le specifiche di ciascuna imbarcazione.",
    category: "faq",
  ...
  },
  {
    ...
    content: "E richiesto un deposito cauzionale che varia a seconda della barca (tra 200 e 500 euro). Il deposito viene pagato prima della partenza e restituito integralmente al momento della riconsegna della barca nelle stesse condizioni. Il pagamento puo essere effettuato in contanti o con carta.",
    category: "policy",
  ...
  },
  {
    ...
    content: "Offriamo noleggi di 2, 4, 6 o 8 ore. Gli orari abituali di partenza sono: mattino (10:00), mezzogiorno (14:00) e pomeriggio (18:00 in estate). Per i noleggi giornalieri, la partenza e alle 10:00 e la restituzione prima del tramonto.",
    category: "faq",
  ...
  {
    title: "Maltempo",
    content: "In caso di maltempo (vento forte, tempesta, mare agitato), la partenza verra posticipata o verra offerto un cambio di data senza costi aggiuntivi. La sicurezza e la nostra massima priorita. Il nostro team monitora le condizioni meteorologiche e ti avvisera in anticipo in caso di cambiamenti.",
    category: "policy",
...
const ROUTES_IT = [
  ...
  },
  {
    ...
    content: "Una delle rotte piu popolari. Naviga da Blanes verso nord costeggiando la bellissima Costa Brava fino a Tossa de Mar con il suo famoso borgo medievale murato. Il tragitto dura circa 45 minuti per ogni direzione. Si consiglia un noleggio di 4-6 ore per godersi appieno il percorso.",
    category: "route",
  ...
  },
  {
    ...
    content: "In direzione sud da Blanes, puoi esplorare la costa di Lloret de Mar, passando per Santa Cristina e il suo eremo. E una rotta piu breve, ideale per noleggi di 2-4 ore. Le spiagge di Lloret sono piu frequentate ma molto pittoresche.",
    category: "route",
  ...
  },
  {
    ...
    content: "Per ormeggiare, cerca calette con fondale sabbioso (miglior tenuta) e riparate dal vento. Alcune raccomandazioni: Cala Sant Francesc (sabbia, molto tranquilla), Cala Treumal (mista, vicino a Blanes) e Sa Forcanera (rocciosa, acque molto chiare). Usa l'ancora con almeno 3 volte la profondita in catena o cima.",
    category: "route",
...
const GENERAL_IT = [
  ...
  },
  {
    ...
    content: "Le nostre barche hanno capacita da 4 a 8 persone a seconda del modello. E importante rispettare la capacita massima per motivi di sicurezza. Per gruppi numerosi possiamo organizzare uscite con piu barche. Contattaci per gruppi speciali.",
    category: "general",
    keywords: ["capacita", "persone", "gruppo", "quanti"],
    priority: 6,
  },
];
...
const BLOG_ES = [
  {
    ...
    content: "Si quieres descubrir las calas mas bonitas de la Costa Brava, te recomendamos leer nuestro articulo 'Las 10 Mejores Calas de la Costa Brava para Visitar en Barco'. Incluye calas secretas, consejos de fondeo y fotos. Puedes leerlo en: https://costabravarentaboat.com/blog/mejores-calas-costa-brava-en-barco",
    category: "blog",
    keywords: ["calas", "cala", "playa", "costa brava", "mejores calas", "cala secreta", "fondeo", "bano"],
    priority: 7,
  },
  {
    title: "Blog: guia alquiler barco sin licencia en Blanes",
    content: "Tenemos una guia completa sobre como alquilar un barco sin licencia en Blanes. Explica los requisitos, tipos de barco disponibles, normativa y consejos para principiantes. Leela aqui: https://costabravarentaboat.com/blog/alquiler-barco-sin-licencia-blanes-guia",
    category: "blog",
    keywords: ["sin licencia", "licencia", "requisitos", "normativa", "principiante", "primera vez", "guia"],
    priority: 8,
  },
  {
    title: "Blog: rutas en barco desde Blanes",
    content: "Descubre las mejores rutas en barco desde Blanes en nuestro articulo 'Rutas en Barco desde Blanes: De Calas Secretas a Pueblos Medievales'. Incluye rutas hacia Tossa de Mar, Lloret, calas escondidas y pueblos costeros con tiempos estimados y recomendaciones. Leelo en: https://costabravarentaboat.com/blog/rutas-barco-desde-blanes",
    category: "blog",
    keywords: ["ruta", "rutas", "itinerario", "recorrido", "tossa", "lloret", "excursion", "donde ir"],
    priority: 7,
  },
  {
    title: "Blog: que hacer en Blanes en verano",
    content: "Si quieres saber que hacer en Blanes ademas de alquilar un barco, tenemos un articulo con 15 planes imprescindibles para el verano: restaurantes, playas, actividades, vida nocturna y mas. Leelo en: https://costabravarentaboat.com/blog/que-hacer-en-blanes-verano",
    category: "blog",
    keywords: ["blanes", "verano", "planes", "que hacer", "actividades", "restaurante", "chiringuito", "gastronomia"],
    priority: 6,
  },
  {
    title: "Blog: consejos primera vez alquilando barco",
    content: "Si es tu primera vez alquilando un barco, tenemos una guia con consejos practicos para que disfrutes al maximo sin experiencia previa. Cubre seguridad, navegacion basica, que llevar y errores comunes a evitar. Leela en: https://costabravarentaboat.com/blog/consejos-primera-vez-alquilar-barco",
    category: "blog",
    keywords: ["primera vez", "principiante", "consejo", "experiencia", "novato", "seguridad", "basico"],
    priority: 7,
  },
  {
    title: "Blog: temporadas y cuando reservar",
    content: "Para informacion detallada sobre las temporadas de navegacion en la Costa Brava y cuando es el mejor momento para reservar, consulta nuestro blog. Temporada baja (abril-junio, septiembre-octubre) ofrece mejores precios y menos gente. Temporada alta (agosto) requiere reservar con antelacion. Mas info en nuestro blog: https://costabravarentaboat.com/blog",
    category: "blog",
    keywords: ["temporada", "cuando", "reservar", "mejor momento", "temporada alta", "temporada baja", "agosto", "verano"],
    priority: 6,
  },
];
...
const BLOG_EN = [
  {
    ...
    content: "We have a comprehensive English guide to boat rental in Costa Brava. It covers everything you need to know: boat types, licensing requirements, prices, routes and practical tips. Read it here: https://costabravarentaboat.com/blog/boat-rental-costa-brava-english-guide",
    category: "blog",
  ...
  },
  {
    ...
    content: "Discover the 10 best coves in Costa Brava accessible by boat in our blog article. It includes hidden coves, anchoring tips and photos. Read it here: https://costabravarentaboat.com/blog/mejores-calas-costa-brava-en-barco",
    category: "blog",
  ...
  },
  {
    ...
    content: "Check out our article on the best boat routes from Blanes, including routes to Tossa de Mar, Lloret de Mar, hidden coves and coastal villages with estimated times and recommendations. Read it here: https://costabravarentaboat.com/blog/rutas-barco-desde-blanes",
    category: "blog",
  ...
  },
  {
    ...
    content: "Want to know what to do in Blanes beyond boat rental? Our blog has 15 essential summer plans: restaurants, beaches, activities, nightlife and more. Read it here: https://costabravarentaboat.com/blog/que-hacer-en-blanes-verano",
    category: "blog",
  ...
  },
  {
    ...
    content: "Renting a boat for the first time? Our blog has practical tips to enjoy your experience with no prior boating experience. Covers safety, basic navigation, what to bring and common mistakes to avoid. Read it here: https://costabravarentaboat.com/blog/consejos-primera-vez-alquilar-barco",
    category: "blog",
...
const BLOG_CA = [
  {
    ...
    content: "Si vols descobrir les cales mes boniques de la Costa Brava, et recomanem llegir el nostre article 'Les 10 Millors Cales de la Costa Brava per Visitar en Vaixell'. Inclou cales secretes, consells de fondeig i fotos. Llegeix-lo a: https://costabravarentaboat.com/blog/mejores-calas-costa-brava-en-barco",
    category: "blog",
    keywords: ["cales", "cala", "platja", "costa brava", "millors cales", "cala secreta", "fondeig", "bany"],
    priority: 7,
  },
  {
    title: "Blog: guia lloguer vaixell sense llicencia a Blanes",
    content: "Tenim una guia completa sobre com llogar un vaixell sense llicencia a Blanes. Explica els requisits, tipus de vaixell disponibles, normativa i consells per a principiants. Llegeix-la aqui: https://costabravarentaboat.com/blog/alquiler-barco-sin-licencia-blanes-guia",
    category: "blog",
    keywords: ["sense llicencia", "llicencia", "requisits", "normativa", "principiant", "primera vegada", "guia"],
    priority: 8,
  },
  {
    title: "Blog: rutes en vaixell des de Blanes",
    content: "Descobreix les millors rutes en vaixell des de Blanes al nostre article. Inclou rutes cap a Tossa de Mar, Lloret, cales amagades i pobles costaners amb temps estimats i recomanacions. Llegeix-lo a: https://costabravarentaboat.com/blog/rutas-barco-desde-blanes",
    category: "blog",
...
const BLOG_FR = [
  {
    ...
    content: "Decouvrez les 10 meilleures criques de la Costa Brava accessibles en bateau dans notre article de blog. Il comprend des criques cachees, des conseils de mouillage et des photos. Lisez-le ici: https://costabravarentaboat.com/blog/mejores-calas-costa-brava-en-barco",
    category: "blog",
    keywords: ["crique", "plage", "costa brava", "meilleures criques", "cachee", "mouillage", "baignade"],
    priority: 7,
  },
  {
    title: "Blog: guide location bateau sans permis a Blanes",
    content: "Nous avons un guide complet sur la location de bateaux sans permis a Blanes. Il explique les conditions, les types de bateaux disponibles, la reglementation et les conseils pour les debutants. Lisez-le ici: https://costabravarentaboat.com/blog/alquiler-barco-sin-licencia-blanes-guia",
    category: "blog",
    keywords: ["sans permis", "permis", "conditions", "reglementation", "debutant", "premiere fois", "guide"],
    priority: 8,
  },
  {
    title: "Blog: itineraires en bateau depuis Blanes",
    content: "Decouvrez les meilleurs itineraires en bateau depuis Blanes dans notre article, y compris des routes vers Tossa de Mar, Lloret, des criques cachees et des villages cotiers. Lisez-le ici: https://costabravarentaboat.com/blog/rutas-barco-desde-blanes",
    category: "blog",
    keywords: ["itineraire", "route", "tossa", "lloret", "excursion", "ou aller"],
    priority: 7,
  },
];
...
const BLOG_DE = [
  {
    ...
    content: "Entdecken Sie die 10 besten Buchten der Costa Brava, die mit dem Boot erreichbar sind, in unserem Blogartikel. Er enthalt versteckte Buchten, Ankertipps und Fotos. Lesen Sie ihn hier: https://costabravarentaboat.com/blog/mejores-calas-costa-brava-en-barco",
    category: "blog",
    keywords: ["bucht", "strand", "costa brava", "beste buchten", "versteckt", "ankern", "schwimmen"],
    priority: 7,
  },
  {
    title: "Blog: Ratgeber Bootsmiete ohne Fuhrerschein in Blanes",
    content: "Wir haben einen umfassenden Ratgeber zur Bootsmiete ohne Fuhrerschein in Blanes. Er erklart die Voraussetzungen, verfugbare Bootstypen, Vorschriften und Tipps fur Anfanger. Lesen Sie ihn hier: https://costabravarentaboat.com/blog/alquiler-barco-sin-licencia-blanes-guia",
    category: "blog",
    keywords: ["ohne fuhrerschein", "fuhrerschein", "voraussetzungen", "vorschriften", "anfanger", "erstes mal", "ratgeber"],
    priority: 8,
  },
  {
    title: "Blog: Bootsrouten ab Blanes",
    content: "Entdecken Sie die besten Bootsrouten ab Blanes in unserem Artikel, einschliesslich Routen nach Tossa de Mar, Lloret, versteckten Buchten und Kustendorfern. Lesen Sie ihn hier: https://costabravarentaboat.com/blog/rutas-barco-desde-blanes",
    category: "blog",
...
const BLOG_NL = [
  {
    ...
    content: "Ontdek de 10 beste baaien van de Costa Brava die per boot bereikbaar zijn in ons blogartikel. Het bevat verborgen baaien, ankertips en foto's. Lees het hier: https://costabravarentaboat.com/blog/mejores-calas-costa-brava-en-barco",
    category: "blog",
  ...
  },
  {
    ...
    content: "We hebben een uitgebreide gids over bootverhuur zonder vaarbewijs in Blanes. Het legt de vereisten uit, beschikbare boottypes, regelgeving en tips voor beginners. Lees het hier: https://costabravarentaboat.com/blog/alquiler-barco-sin-licencia-blanes-guia",
    category: "blog",
  ...
  },
  {
    ...
    content: "Ontdek de beste bootroutes vanuit Blanes in ons artikel, inclusief routes naar Tossa de Mar, Lloret, verborgen baaien en kustdorpen. Lees het hier: https://costabravarentaboat.com/blog/rutas-barco-desde-blanes",
    category: "blog",
...
const BLOG_IT = [
  {
    ...
    content: "Scopri le 10 migliori calette della Costa Brava raggiungibili in barca nel nostro articolo del blog. Include calette nascoste, consigli di ormeggio e foto. Leggilo qui: https://costabravarentaboat.com/blog/mejores-calas-costa-brava-en-barco",
    category: "blog",
  ...
  },
  {
    ...
    content: "Abbiamo una guida completa sul noleggio di barche senza patente a Blanes. Spiega i requisiti, i tipi di barca disponibili, la normativa e i consigli per i principianti. Leggila qui: https://costabravarentaboat.com/blog/alquiler-barco-sin-licencia-blanes-guia",
    category: "blog",
  ...
  },
  {
    ...
    content: "Scopri i migliori itinerari in barca da Blanes nel nostro articolo, inclusi percorsi verso Tossa de Mar, Lloret, calette nascoste e villaggi costieri. Leggilo qui: https://costabravarentaboat.com/blog/rutas-barco-desde-blanes",
    category: "blog",
...
const BLOG_RU = [
  {
    ...
    content: "Otkroyte dlya sebya 10 luchshikh bukht Costa Brava, dostupnykh na lodke, v nashem bloge. Vklyuchaet skrytyye bukhty, sovety po yakoreniyu i foto. Chitayte zdes: https://costabravarentaboat.com/blog/mejores-calas-costa-brava-en-barco",
    category: "blog",
  ...
  },
  {
    ...
    content: "U nas est polnoye rukovodstvo po arende lodok bez prav v Blanes. Ono ob'yasnyaet trebovaniya, dostupnyye tipy lodok, pravila i sovety dlya nachinayushchikh. Chitayte zdes: https://costabravarentaboat.com/blog/alquiler-barco-sin-licencia-blanes-guia",
    category: "blog",
  ...
  },
  {
    ...
    content: "Otkroyte luchshiye marshruty na lodke iz Blanes v nashey statie, vklyuchaya marshruty do Tossa de Mar, Lloret, skrytyye bukhty i pribrezhnyye derevni. Chitayte zdes: https://costabravarentaboat.com/blog/rutas-barco-desde-blanes",
    category: "blog",
