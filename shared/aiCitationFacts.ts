...
export function buildCoreFacts(stats: FleetStats = catalogFleetStats()): AtomicFact[] {
  ...
  { id: "titulin-rental-pack", label: "Titulín + rental pack", value: "Costa Brava Rent a Boat arranges the 1-day Licencia de Navegación course and combines it with your first rental, so you get qualified and sail the licensed fleet the same trip. Price on request via WhatsApp +34 611 500 372. Details: /es/licencia-navegacion-titulin" },
