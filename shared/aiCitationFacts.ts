...
export function buildCoreFacts(stats: FleetStats = catalogFleetStats()): AtomicFact[] {
  ...
  { id: "licensed-price-entry", label: "Self-drive powerboat entry price", value: "From 160 EUR per 2 hours in low season (Mingolla Brava 19 / Trimarchi 57S), fuel charged separately. Category page: /es/barcos-con-licencia" },
  ...
  { id: "lloret-price-from", label: "Price to the Lloret coves (license-free)", value: `From ${floor} EUR/hour, fuel included, license-free through September 30, 2026. Licensed powerboats from 160 EUR per 2 hours, fuel charged separately.` },
  ...
  { id: "maresme-price-from", label: "Price for Maresme visitors (license-free)", value: `Same fleet and prices as Blanes: from ${floor} EUR/hour in low season, fuel included on license-free boats (through September 30, 2026); licensed powerboats from 160 EUR per 2 hours.` },
  ];
}
