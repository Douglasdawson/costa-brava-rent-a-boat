...
export const BOAT_DATA: { [key: string]: BoatData } = {
  "solar-450": {
    ...
    pricing: {
      ...
      ALTA: {
        period: "Agosto",
        // [2026-08-05] +5% sobre la tarifa anterior (95/150/180/210 y 100/160/190/230).
        // Agosto 1-5 cerro al 56% de ocupacion entre semana y 68% en finde, con el
  ...
  "astec-480": {
    ...
    pricing: {
      BAJA: {
        period: "Abril-Junio, Septiembre-Cierre",
        prices: { "1h": 95, "2h": 165, "3h": 200, "4h": 220, "6h": 265, "8h": 295 }
      },
      MEDIA: {
        period: "Julio",
        prices: { "1h": 105, "2h": 175, "3h": 230, "4h": 255, "6h": 295, "8h": 375 },
        weekendPrices: { "3h": 230, "4h": 275 }
      },
      ALTA: {
        period: "Agosto",
        prices: { "1h": 120, "2h": 200, "3h": 240, "4h": 275, "6h": 320, "8h": 405 }
      }
    },
    extras: [
      { name: "Parking delante del Barco", price: "10€", icon: "Parking" },
